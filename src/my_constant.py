...
analyze repos / cluster repos title and index
"""
ANALYZE_REPOS_JOERN_TITLE = ANALYZE_REPOS_GUMTREE_TITLE + ['ddg_feature', 'cdg_feature', 'cdg_z3_feature']
...
ANALYZE_REPOS_CDG_Z3_FEATURE = ANALYZE_REPOS_JOERN_TITLE.index('cdg_z3_feature')
...
analyze clone title
"""
ANALYZE_CLONE_TITLE = ANALYZE_OLD_NEW_JOERN_TITLE + ANALYZE_REPOS_JOERN_TITLE
