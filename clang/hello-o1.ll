...
for.body:                                         ; preds = %for.body.preheader, %for.body
  ...
  %sum.04 = phi i32 [ %add.sum.0, %for.body ], [ 0, %for.body.preheader ]
  ...
  %add = select i1 %cmp2, i32 %1, i32 0
  %add.sum.0 = add nsw i32 %add, %sum.04
...
for.end.loopexit:                                 ; preds = %for.body
  %add.sum.0.lcssa = phi i32 [ %add.sum.0, %for.body ]
  br label %for.end

for.end:                                          ; preds = %for.end.loopexit, %entry
  %sum.0.lcssa = phi i32 [ 0, %entry ], [ %add.sum.0.lcssa, %for.end.loopexit ]
  %call3 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* nonnull @_ZSt4cout, i32 %sum.0.lcssa)
