...
@@ -105,38 +116,77 @@ static int redisSetBlocking(redisContext *c, int fd, int blocking) {
     else
         flags |= O_NONBLOCK;
...
-        c->fd = s;
         ...
         rv = REDIS_OK;
         goto end;
@@ -260,32 +415,62 @@ int redisContextConnectTcp(redisContext *c, const char *addr, int port, struct t
