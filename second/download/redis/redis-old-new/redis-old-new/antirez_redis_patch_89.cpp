...
@@ -945,15 +957,15 @@ int rdbSaveRio(rio *rdb, int *error, int flags) {
...
@@ -964,7 +976,7 @@ int rdbSaveRioWithEOFMark(rio *rdb, int *error) {
 }
...
@@ -1023,7 +1035,7 @@ int rdbSave(char *filename) {
     return C_ERR;
 }
...
+                if (rsi) rsi->repl_offset = strtoll(auxval->ptr,NULL,10);
                  ...
                  * contract. */
@@ -1559,16 +1580,19 @@ int rdbLoadRio(rio *rdb) {
