...
@@ -174,115 +124,67 @@ int listTypeNext(listTypeIterator *li, listTypeEntry *entry) {
...
@@ -641,21 +480,16 @@ void ltrimCommand(redisClient *c) {
...
-
     ...
     if (toremove < 0) {
         toremove = -toremove;
@@ -664,21 +498,21 @@ void lremCommand(redisClient *c) {
         li = listTypeInitIterator(subject,0,REDIS_TAIL);
     }
