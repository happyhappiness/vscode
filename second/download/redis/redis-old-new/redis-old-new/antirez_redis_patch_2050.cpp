...
@@ -250,30 +251,41 @@ static void _redisPanic(char *msg, char *file, int line);
...
@@ -283,7 +295,7 @@ typedef struct redisObject {
...
@@ -372,6 +384,7 @@ struct redisServer {
     int daemonize;
     int appendonly;
     int appendfsync;
+    int no_appendfsync_on_rewrite;
     ...
     time_t lastfsync;
     int appendfd;
@@ -452,6 +465,8 @@ struct redisServer {
...
@@ -544,6 +559,9 @@ typedef struct iojob {
...
@@ -577,8 +595,7 @@ static robj *getDecodedObject(robj *o);
...
@@ -600,8 +617,8 @@ static void unblockClientWaitingData(redisClient *c);
...
@@ -637,7 +654,7 @@ static int compareStringObjects(robj *a, robj *b);
...
@@ -1110,7 +1127,7 @@ static void dictListDestructor(void *privdata, void *val)
...
+static int dictSdsKeyCompare(void *privdata, const void *key1,
 ...
 {
     int l1,l2;
@@ -1130,18 +1147,29 @@ static void dictRedisObjectDestructor(void *privdata, void *val)
     decrRefCount(val);
 }
...
+
 static int dictEncObjKeyCompare(void *privdata, const void *key1,
         const void *key2)
 {
@@ -1154,7 +1182,7 @@ static int dictEncObjKeyCompare(void *privdata, const void *key1,
...
+    cmp = dictSdsKeyCompare(privdata,o1->ptr,o2->ptr);
     ...
     decrRefCount(o2);
     return cmp;
@@ -1183,7 +1211,7 @@ static unsigned int dictEncObjHash(const void *key) {
     }
 }
...
+/* Sets type */
 static dictType setDictType = {
     ...
     NULL,                      /* key dup */
@@ -1203,23 +1231,23 @@ static dictType zsetDictType = {
...
@@ -1388,7 +1416,7 @@ void backgroundRewriteDoneHandler(int statloc) {
...
@@ -1434,6 +1462,19 @@ static int serverCron(struct aeEventLoop *eventLoop, long long id, void *clientD
...
@@ -1532,7 +1573,11 @@ static int serverCron(struct aeEventLoop *eventLoop, long long id, void *clientD
...
@@ -1688,6 +1733,7 @@ static void initServerConfig() {
     server.daemonize = 0;
     server.appendonly = 0;
...
@@ -1944,6 +1990,11 @@ static void loadServerConfig(char *filename) {
...
@@ -2875,6 +2926,12 @@ static void addReplyBulk(redisClient *c, robj *obj) {
...
+
 ...
 static void addReplyBulkCString(redisClient *c, char *s) {
     if (s == NULL) {
@@ -2934,23 +2991,20 @@ static robj *createObject(int type, void *ptr) {
...
+        o->lru = server.lruclock;
     ...
     return o;
@@ -3072,28 +3126,31 @@ static void incrRefCount(robj *o) {
...
@@ -3110,64 +3167,6 @@ static void decrRefCount(void *obj) {
     }
 }
...
@@ -3176,21 +3175,6 @@ static int checkType(redisClient *c, robj *o, int type) {
     return 0;
 }
...
@@ -3410,6 +3394,134 @@ static int getLongFromObjectOrReply(redisClient *c, robj *o, long *target, const
     return REDIS_OK;
 }
...
@@ -3779,9 +3891,12 @@ static int rdbSave(char *filename) {
...
+            expiretime = getExpire(db,&key);
             ...
             if (expiretime != -1) {
@@ -3792,20 +3907,20 @@ static int rdbSave(char *filename) {
             }
...
+                if (rdbSaveStringObject(fp,&key) == -1) goto werr;
                 ...
                 decrRefCount(po);
@@ -4139,11 +4254,9 @@ static int rdbLoad(char *filename) {
     uint32_t dbid;
...
@@ -4162,6 +4275,7 @@ static int rdbLoad(char *filename) {
     }
     while(1) {
         robj *key, *val;
+        int force_swapout;
         ...
         expiretime = -1;
         /* Read type. */
@@ -4181,7 +4295,6 @@ static int rdbLoad(char *filename) {
                 exit(1);
             }
             db = server.db+dbid;
-            d = db->dict;
         ...
         /* Read key */
@@ -4195,12 +4308,11 @@ static int rdbLoad(char *filename) {
             continue;
         }
...
@@ -4212,23 +4324,30 @@ static int rdbLoad(char *filename) {
...
@@ -4258,7 +4377,7 @@ static int prepareForShutdown() {
     }
...
@@ -4317,23 +4436,16 @@ static void setGenericCommand(redisClient *c, int nx, robj *key, robj *val, robj
...
-        incrRefCount(key);
     ...
     server.dirty++;
@@ -4375,11 +4487,7 @@ static void getCommand(redisClient *c) {
...
@@ -4425,17 +4533,9 @@ static void msetGenericCommand(redisClient *c, int nx) {
     }
...
@@ -4452,7 +4552,6 @@ static void msetnxCommand(redisClient *c) {
...
@@ -4461,13 +4560,7 @@ static void incrDecrCommand(redisClient *c, long long incr) {
...
+    dbReplace(c->db,c->argv[1],o);
     ...
     addReply(c,o);
@@ -4504,17 +4597,10 @@ static void appendCommand(redisClient *c) {
     o = lookupKeyWrite(c->db,c->argv[1]);
     if (o == NULL) {
         /* Create the key */
...
-        o = dictGetEntryVal(de);
         if (o->type != REDIS_STRING) {
             addReply(c,shared.wrongtypeerr);
             return;
@@ -4526,7 +4612,7 @@ static void appendCommand(redisClient *c) {
...
@@ -4585,7 +4671,7 @@ static void delCommand(redisClient *c) {
     int deleted = 0, j;
...
+        if (dbDelete(c->db,c->argv[j])) {
             ...
             server.dirty++;
             deleted++;
@@ -4596,7 +4682,7 @@ static void delCommand(redisClient *c) {
...
+    if (dbExists(c->db,c->argv[1])) {
         ...
         addReply(c, shared.czero);
@@ -4614,27 +4700,15 @@ static void selectCommand(redisClient *c) {
 }
...
@@ -4649,15 +4723,17 @@ static void keysCommand(redisClient *c) {
     addReply(c,lenobj);
     decrRefCount(lenobj);
     while((de = dictNext(di)) != NULL) {
...
@@ -4740,17 +4816,15 @@ static void renameGenericCommand(redisClient *c, int nx) {
...
@@ -4795,15 +4869,14 @@ static void moveCommand(redisClient *c) {
...
@@ -5012,8 +5085,7 @@ static void pushGenericCommand(redisClient *c, int where) {
             return;
         }
...
+        dbAdd(c->db,c->argv[1],lobj);
         ...
         if (lobj->type != REDIS_LIST) {
             addReply(c,shared.wrongtypeerr);
@@ -5124,7 +5196,7 @@ static void popGenericCommand(redisClient *c, int where) {
     } else {
...
@@ -5223,7 +5295,7 @@ static void ltrimCommand(redisClient *c) {
     } else {
...
@@ -5263,7 +5335,7 @@ static void lremCommand(redisClient *c) {
...
@@ -5300,8 +5372,7 @@ static void rpoplpushcommand(redisClient *c) {
...
@@ -5313,7 +5384,7 @@ static void rpoplpushcommand(redisClient *c) {
         decrRefCount(value);
...
@@ -5326,8 +5397,7 @@ static void saddCommand(redisClient *c) {
...
+        dbAdd(c->db,c->argv[1],set);
         ...
         if (set->type != REDIS_SET) {
             addReply(c,shared.wrongtypeerr);
@@ -5352,7 +5422,7 @@ static void sremCommand(redisClient *c) {
...
+        if (dictSize((dict*)set->ptr) == 0) dbDelete(c->db,c->argv[1]);
         ...
         addReply(c,shared.czero);
@@ -5383,13 +5453,12 @@ static void smoveCommand(redisClient *c) {
         return;
     }
...
@@ -5435,7 +5504,7 @@ static void spopCommand(redisClient *c) {
         addReplyBulk(c,ele);
...
@@ -5479,7 +5548,7 @@ static void sinterGenericCommand(redisClient *c, robj **setskeys, unsigned long
         if (!setobj) {
             zfree(dv);
             if (dstkey) {
...
@@ -5539,10 +5608,9 @@ static void sinterGenericCommand(redisClient *c, robj **setskeys, unsigned long
     if (dstkey) {
...
+            dbAdd(c->db,dstkey,dstset);
             ...
             decrRefCount(dstset);
@@ -5642,10 +5710,9 @@ static void sunionDiffGenericCommand(redisClient *c, robj **setskeys, int setsnu
     } else {
...
+            dbAdd(c->db,dstkey,dstset);
             ...
             decrRefCount(dstset);
@@ -6001,8 +6068,7 @@ static void zaddGenericCommand(redisClient *c, robj *key, robj *ele, double scor
...
+        dbAdd(c->db,key,zsetobj);
         ...
         if (zsetobj->type != REDIS_ZSET) {
             addReply(c,shared.wrongtypeerr);
@@ -6118,7 +6184,7 @@ static void zremCommand(redisClient *c) {
...
@@ -6139,7 +6205,7 @@ static void zremrangebyscoreCommand(redisClient *c) {
     zs = zsetobj->ptr;
...
@@ -6177,7 +6243,7 @@ static void zremrangebyrankCommand(redisClient *c) {
      * use 1-based rank */
...
@@ -6365,10 +6431,9 @@ static void zunionInterGenericCommand(redisClient *c, robj *dstkey, int op) {
...
@@ -6844,8 +6909,7 @@ static robj *hashLookupWriteOrCreate(redisClient *c, robj *key) {
     robj *o = lookupKeyWrite(c->db,key);
     if (o == NULL) {
         o = createHashObject();
...
+        dbAdd(c->db,key,o);
         ...
         if (o->type != REDIS_HASH) {
             addReply(c,shared.wrongtypeerr);
@@ -6969,7 +7033,7 @@ static void hdelCommand(redisClient *c) {
...
@@ -7438,9 +7502,7 @@ static void sortCommand(redisClient *c) {
                 }
             }
         }
...
+        dbReplace(c->db,storekey,sobj);
          ...
          * replaced. */
@@ -7622,18 +7684,19 @@ static void monitorCommand(redisClient *c) {
...
@@ -7645,7 +7708,7 @@ static time_t getExpire(redisDb *db, robj *key) {
...
@@ -7656,30 +7719,30 @@ static int expireIfNeeded(redisDb *db, robj *key) {
...
@@ -7690,13 +7753,13 @@ static void expireGenericCommand(redisClient *c, robj *key, robj *param, long of
...
@@ -8465,7 +8528,7 @@ static void freeMemoryIfNeeded(void) {
                         minttl = t;
                     }
                 }
...
@@ -8474,6 +8537,48 @@ static void freeMemoryIfNeeded(void) {
...
@@ -8507,6 +8612,11 @@ static void flushAppendOnlyFile(void) {
...
@@ -8633,7 +8743,6 @@ int loadAppendOnlyFile(char *filename) {
...
@@ -8656,6 +8765,7 @@ int loadAppendOnlyFile(char *filename) {
         char buf[128];
         sds argsds;
...
+        int force_swapout;
         ...
         if (fgets(buf,sizeof(buf),fp) == NULL) {
             if (feof(fp))
@@ -8696,8 +8806,11 @@ int loadAppendOnlyFile(char *filename) {
...
@@ -8809,32 +8922,34 @@ static int rewriteAppendOnlyFile(char *filename) {
...
@@ -8848,7 +8963,7 @@ static int rewriteAppendOnlyFile(char *filename) {
...
+                        if (fwriteBulkObject(fp,&key) == 0) goto werr;
                         if (vstr) {
                             if (fwriteBulkString(fp,(char*)vstr,vlen) == 0)
                                 goto werr;
@@ -8868,7 +8983,7 @@ static int rewriteAppendOnlyFile(char *filename) {
...
@@ -8885,7 +9000,7 @@ static int rewriteAppendOnlyFile(char *filename) {
...
+                    if (fwriteBulkObject(fp,&key) == 0) goto werr;
                 ...
                 dictReleaseIterator(di);
@@ -8901,7 +9016,7 @@ static int rewriteAppendOnlyFile(char *filename) {
...
@@ -8917,7 +9032,7 @@ static int rewriteAppendOnlyFile(char *filename) {
...
@@ -8932,7 +9047,7 @@ static int rewriteAppendOnlyFile(char *filename) {
                         robj *val = dictGetEntryVal(de);
...
@@ -8947,7 +9062,7 @@ static int rewriteAppendOnlyFile(char *filename) {
...
@@ -8957,7 +9072,7 @@ static int rewriteAppendOnlyFile(char *filename) {
...
@@ -9070,50 +9185,19 @@ static void aofRemoveTempFile(pid_t childpid) {
...
-
 static void vmInit(void) {
     off_t totsize;
     int pipefds[2];
@@ -9328,30 +9412,33 @@ static int vmWriteObjectOnSwap(robj *o, off_t page) {
     return REDIS_OK;
 }
...
@@ -9373,46 +9460,47 @@ static robj *vmReadObjectFromSwap(off_t page, int type) {
     return o;
 }
...
@@ -9427,14 +9515,16 @@ static robj *vmPreviewObject(robj *key) {
...
@@ -9453,8 +9543,7 @@ static double computeObjectSwappability(robj *o) {
             long elesize;
...
+                            (sizeof(*o)+sdslen(ele->ptr)) : sizeof(*o);
         ...
         break;
@@ -9472,8 +9561,7 @@ static double computeObjectSwappability(robj *o) {
...
@@ -9500,18 +9588,16 @@ static double computeObjectSwappability(robj *o) {
                 de = dictGetRandomKey(d);
                 ele = dictGetEntryKey(de);
                 elesize = (ele->encoding == REDIS_ENCODING_RAW) ?
-                                (sizeof(*o)+sdslen(ele->ptr)) :
...
@@ -9525,7 +9611,8 @@ static int vmSwapOneObject(int usethreads) {
...
@@ -9541,16 +9628,14 @@ static int vmSwapOneObject(int usethreads) {
...
@@ -9567,21 +9652,19 @@ static int vmSwapOneObject(int usethreads) {
...
+            dictGetEntryVal(best) = vp;
             ...
             return REDIS_ERR;
@@ -9604,30 +9687,20 @@ static int vmCanSwapOut(void) {
...
@@ -9648,7 +9721,6 @@ static void vmThreadedIOCompletedJob(aeEventLoop *el, int fd, void *privdata,
...
@@ -9671,27 +9743,26 @@ static void vmThreadedIOCompletedJob(aeEventLoop *el, int fd, void *privdata,
         }
...
@@ -9701,8 +9772,8 @@ static void vmThreadedIOCompletedJob(aeEventLoop *el, int fd, void *privdata,
             {
...
@@ -9714,28 +9785,29 @@ static void vmThreadedIOCompletedJob(aeEventLoop *el, int fd, void *privdata,
                 unlockThreadedIO();
             }
...
+                (unsigned char*) j->key->ptr,
             ...
             server.vm_stats_swapped_objects++;
             server.vm_stats_swapouts++;
@@ -9790,7 +9862,7 @@ static void vmCancelThreadedIOJob(robj *o) {
...
+    /* Search for a matching object in one of the queues */
     for (i = 0; i < 3; i++) {
         listNode *ln;
         listIter li;
@@ -9800,9 +9872,9 @@ static void vmCancelThreadedIOJob(robj *o) {
             iojob *job = ln->value;
...
@@ -9850,12 +9922,14 @@ static void vmCancelThreadedIOJob(robj *o) {
...
@@ -9888,7 +9962,8 @@ static void *IOThreadEntryPoint(void *arg) {
...
@@ -9984,18 +10059,16 @@ static void queueIOJob(iojob *j) {
...
+    val->storage = REDIS_VM_SWAPPING;
     ...
     lockThreadedIO();
     queueIOJob(j);
@@ -10017,9 +10090,9 @@ static int waitForSwappedKey(redisClient *c, robj *key) {
...
@@ -10053,14 +10126,16 @@ static int waitForSwappedKey(redisClient *c, robj *key) {
...
+        j->page = vp->page;
         ...
         j->canceled = 0;
         j->thread = (pthread_t) -1;
@@ -10185,6 +10260,8 @@ static int dontWaitForSwappedKey(redisClient *c, robj *key) {
...
+ * waiting for this key if any. */
 static void handleClientsBlockedOnSwappedKey(redisDb *db, robj *key) {
     struct dictEntry *de;
     list *l;
@@ -10243,6 +10320,11 @@ static void configSetCommand(redisClient *c) {
         } else {
             goto badfmt;
         }
...
@@ -10358,6 +10440,11 @@ static void configGetCommand(redisClient *c) {
...
@@ -10793,7 +10880,7 @@ static void touchWatchedKeysOnFlush(int dbid) {
...
@@ -10904,27 +10991,22 @@ static void computeDatasetDigest(unsigned char *final) {
...
+            expiretime = getExpire(db,keyobj);
             ...
             /* Save the key and associated value */
             if (o->type == REDIS_STRING) {
@@ -10991,6 +11073,7 @@ static void computeDatasetDigest(unsigned char *final) {
...
@@ -11020,17 +11103,16 @@ static void debugCommand(redisClient *c) {
...
@@ -11041,23 +11123,25 @@ static void debugCommand(redisClient *c) {
                 strenc = buf;
             }
...
@@ -11067,19 +11151,14 @@ static void debugCommand(redisClient *c) {
             addReply(c,shared.nokeyerr);
             return;
         }
-        key = dictGetEntryKey(de);
...
@@ -11100,7 +11179,8 @@ static void debugCommand(redisClient *c) {
             }
