...
@@ -1460,32 +364,30 @@ CURLcode Curl_sasl_start(struct SASL *sasl, struct connectdata *conn,
...
@@ -1503,14 +405,19 @@ CURLcode Curl_sasl_continue(struct SASL *sasl, struct connectdata *conn,
...
@@ -1534,67 +442,70 @@ CURLcode Curl_sasl_continue(struct SASL *sasl, struct connectdata *conn,
     *progress = SASL_DONE;
     return result;
   case SASL_PLAIN:
...
+                                                  data->easy_conn->host.name,
                                                   ...
                                                   &conn->krb5,
                                                   &resp, &len);
@@ -1605,32 +516,69 @@ CURLcode Curl_sasl_continue(struct SASL *sasl, struct connectdata *conn,
     if(sasl->mutual_auth) {
