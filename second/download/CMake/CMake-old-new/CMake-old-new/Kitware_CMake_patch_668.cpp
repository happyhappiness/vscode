...
@@ -3081,7 +3077,7 @@ int cmCTest::ProcessTests()
...
@@ -3092,23 +3088,23 @@ int cmCTest::ProcessTests()
     {
...
@@ -3121,7 +3117,7 @@ int cmCTest::ProcessTests()
     this->UpdateCTestConfiguration();
...
+      res |= cmCTest::MEMORY_ERRORS;
   ...
   if ( !notest )
@@ -3602,480 +3598,6 @@ const char* cmCTest::GetTestStatus(int status)
