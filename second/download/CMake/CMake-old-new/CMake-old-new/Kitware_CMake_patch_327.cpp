...
+                                             const std::string& dependee_name,
 ...
 {
   // Get the depender.
@@ -407,8 +407,8 @@ void cmComputeTargetDepends::AddTargetDepend(int depender_index,
...
@@ -435,22 +435,23 @@ void cmComputeTargetDepends::AddTargetDepend(int depender_index,
...
+              dependee->GetName().c_str(), ni->IsStrong()? "strong" : "weak");
   ...
   fprintf(stderr, "\n");
@@ -472,7 +473,7 @@ ::DisplayComponents(cmComputeComponentGraph const& ccg)
       {
       int i = *ni;
