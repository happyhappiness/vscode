...
@@ -331,38 +335,37 @@ typedef int yy_state_type;
...
+
 ...
 #endif
@@ -589,49 +592,54 @@ static int input (yyscan_t yyscanner );
...
+	return b;
 ...
 /** Destroy the buffer.
@@ -1341,36 +1414,32 @@ static void cmExpr_yy_load_buffer_state  (yyscan_t yyscanner)
 {
     struct yyguts_t * yyg = (struct yyguts_t*)yyscanner;
...
@@ -1454,61 +1523,65 @@ void cmExpr_yypush_buffer_state (YY_BUFFER_STATE new_buffer , yyscan_t yyscanner
