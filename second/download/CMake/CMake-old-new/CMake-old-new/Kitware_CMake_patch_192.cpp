...
@@ -560,18 +692,58 @@ archive_write_zip_header(struct archive_write *a, struct archive_entry *entry)
...
@@ -582,15 +754,33 @@ archive_write_zip_header(struct archive_write *a, struct archive_entry *entry)
 		} else {
 			version_needed = 20;
 		}
+
