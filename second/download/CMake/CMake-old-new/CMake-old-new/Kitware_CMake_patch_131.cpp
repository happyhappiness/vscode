...
@@ -4093,8 +4090,7 @@ static CURLcode ftp_do(struct connectdata *conn, bool *done)
 }
...
@@ -4106,10 +4102,9 @@ CURLcode Curl_ftpsendf(struct connectdata *conn,
...
+    return CURLE_BAD_FUNCTION_ARGUMENT;
   ...
   write_len +=2;
@@ -4291,6 +4286,7 @@ CURLcode ftp_parse_url_path(struct connectdata *conn)
...
+      CURLcode result;
       ...
       if(!ftpc->dirs)
@@ -4299,12 +4295,13 @@ CURLcode ftp_parse_url_path(struct connectdata *conn)
       if(!dirlen)
         dirlen++;
...
@@ -4322,7 +4319,7 @@ CURLcode ftp_parse_url_path(struct connectdata *conn)
       return CURLE_OUT_OF_MEMORY;
...
+    if(!strcmp(path_to_use, "/")) {
       ...
       ftpc->dirs[0] = strdup("/");
       ftpc->dirdepth++;
@@ -4339,18 +4336,15 @@ CURLcode ftp_parse_url_path(struct connectdata *conn)
...
@@ -4386,15 +4380,12 @@ CURLcode ftp_parse_url_path(struct connectdata *conn)
   } /* switch */
...
@@ -4412,16 +4403,18 @@ CURLcode ftp_parse_url_path(struct connectdata *conn)
   if(ftpc->prevpath) {
