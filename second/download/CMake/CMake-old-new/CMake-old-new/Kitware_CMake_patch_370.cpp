...
@@ -354,7 +389,7 @@ setup_mac_metadata(struct archive_read_disk *a,
  */
 static int
 setup_mac_metadata(struct archive_read_disk *a,
-    struct archive_entry *entry, int fd)
+    struct archive_entry *entry, int *fd)
 {
 	(void)a; /* UNUSED */
 	(void)entry; /* UNUSED */
@@ -364,26 +399,58 @@ setup_mac_metadata(struct archive_read_disk *a,
 #endif
...
+    struct archive_entry *entry, int *fd)
 {
 	(void)a;     /* UNUSED */
 	(void)entry; /* UNUSED */
@@ -816,35 +1024,41 @@ setup_xattrs(struct archive_read_disk *a,
...
@@ -912,10 +1117,9 @@ setup_sparse(struct archive_read_disk *a,
...
@@ -994,7 +1212,7 @@ setup_sparse(struct archive_read_disk *a,
  */
 static int
 setup_sparse(struct archive_read_disk *a,
-    struct archive_entry *entry, int fd)
