...
if(CPACK_GENERATOR MATCHES "NSIS")
  ...
  set(CPACK_NSIS_MUI_ICON "/data/download/cmake/cmake-master/Utilities/Release\\CMakeLogo.ico")
  set(CPACK_NSIS_MUI_UNIICON "/data/download/cmake/cmake-master/Utilities/Release\\CMakeLogo.ico")
  # set the package header icon for MUI
  set(CPACK_PACKAGE_ICON "/data/download/cmake/cmake-master/Utilities/Release\\CMakeInstall.bmp")
  ...
  set(CPACK_NSIS_PACKAGE_NAME "CMake 3.8.20170520")
  set(CPACK_NSIS_DISPLAY_NAME "CMake 3.8.20170520, a cross-platform, open-source build system")
...
include("/data/download/cmake/cmake-master/Source/QtDialog/QtDialogCPack.cmake" OPTIONAL)
...
if(CPACK_GENERATOR MATCHES "IFW")
  ...
  set(CPACK_IFW_PACKAGE_WINDOW_ICON
    "/data/download/cmake/cmake-master/Source/QtDialog/CMakeSetup128.png")
  set(CPACK_IFW_PACKAGE_CONTROL_SCRIPT
    "/data/download/cmake/cmake-master/Source/QtIFW/controlscript.qs")
  ...
  set(CPACK_IFW_COMPONENT_GROUP_CMAKE_SCRIPT_TEMPLATE
    "/data/download/cmake/cmake-master/Source/QtIFW/installscript.qs.in")
  set(CPACK_IFW_COMPONENT_GROUP_CMAKE_SCRIPT_GENERATED
    "/data/download/cmake/cmake-master/CMake.qs")
  set(CPACK_IFW_COMPONENT_GROUP_CMAKE_LICENSES
    "CMake Copyright;/data/download/cmake/cmake-master/Copyright.txt")
  ...
  set(CPACK_IFW_COMPONENT_CMAKE-GUI_SCRIPT
    "/data/download/cmake/cmake-master/CMake.Dialogs.QtGUI.qs")
  ...
  set(CPACK_IFW_COMPONENT_SPHINX-HTML_SCRIPT
    "/data/download/cmake/cmake-master/CMake.Documentation.SphinxHTML.qs")
  ...
  set(CPACK_IFW_COMPONENT_CMAKE-DEVELOPER-REFERENCE-HTML_SCRIPT
    "/data/download/cmake/cmake-master/CMake.DeveloperReference.HTML.qs")
...
if("${CPACK_GENERATOR}" STREQUAL "DragNDrop")
  set(CPACK_DMG_BACKGROUND_IMAGE
      "/data/download/cmake/cmake-master/Packaging/CMakeDMGBackground.tif")
  set(CPACK_DMG_DS_STORE_SETUP_SCRIPT
      "/data/download/cmake/cmake-master/Packaging/CMakeDMGSetup.scpt")
endif()
...
if("${CPACK_GENERATOR}" STREQUAL "WIX")
  ...
  set(CPACK_PACKAGE_FILE_NAME
    "cmake-3.8.20170520-${CPACK_SYSTEM_NAME}")
  ...
  set(CPACK_WIX_PRODUCT_ICON
    "/data/download/cmake/cmake-master/Utilities/Release/CMakeLogo.ico"
  )
  ...
  set(CPACK_WIX_UI_BANNER
    "/data/download/cmake/cmake-master/Utilities/Release/WiX/ui_banner.jpg"
  )

  set(CPACK_WIX_UI_DIALOG
    "/data/download/cmake/cmake-master/Utilities/Release/WiX/ui_dialog.jpg"
  )

  set(CPACK_WIX_EXTRA_SOURCES
    "/data/download/cmake/cmake-master/Utilities/Release/WiX/install_dir.wxs"
    "/data/download/cmake/cmake-master/Utilities/Release/WiX/cmake_extra_dialog.wxs"
  )

  set(_WIX_CUSTOM_ACTION_ENABLED "FALSE")
  if(_WIX_CUSTOM_ACTION_ENABLED)
    list(APPEND CPACK_WIX_EXTRA_SOURCES
      "/data/download/cmake/cmake-master/Utilities/Release/WiX/cmake_nsis_overwrite_dialog.wxs"
      )
    ...
    if(_WIX_CUSTOM_ACTION_MULTI_CONFIG)
      ...
      list(APPEND CPACK_WIX_EXTRA_SOURCES
        "/data/download/cmake/cmake-master/Utilities/Release/WiX/custom_action_dll-${_WIX_CUSTOM_ACTION_CONFIG}.wxs")
    else()
      list(APPEND CPACK_WIX_EXTRA_SOURCES
        "/data/download/cmake/cmake-master/Utilities/Release/WiX/custom_action_dll.wxs")
    endif()
  endif()
  ...
  set(CPACK_WIX_PATCH_FILE
    "/data/download/cmake/cmake-master/Utilities/Release/WiX/patch_path_env.xml"
  )

  set(CPACK_WIX_TEMPLATE
    "/data/download/cmake/cmake-master/Utilities/Release/WiX/WIX.template.in"
  )
  ...
  if(BUILD_QtDialog)
    list(APPEND CPACK_WIX_PATCH_FILE
      "/data/download/cmake/cmake-master/Utilities/Release/WiX/patch_desktop_shortcut.xml"
      )
