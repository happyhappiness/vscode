; ModuleID = '/data/download/cmake/cmake-master/Utilities/cmcurl/lib/base64.c'
...
define i32 @Curl_base64_decode(i8* %src, i8** %outptr, i64* %outlen) #0 !dbg !1680 {
entry:
  ...
  call void @llvm.dbg.declare(metadata i8** %src.addr, metadata !1706, metadata !1707), !dbg !1708
  store i8** %outptr, i8*** %outptr.addr, align 8
  call void @llvm.dbg.declare(metadata i8*** %outptr.addr, metadata !1709, metadata !1707), !dbg !1710
  store i64* %outlen, i64** %outlen.addr, align 8
  call void @llvm.dbg.declare(metadata i64** %outlen.addr, metadata !1711, metadata !1707), !dbg !1712
  call void @llvm.dbg.declare(metadata i64* %srclen, metadata !1713, metadata !1707), !dbg !1714
  store i64 0, i64* %srclen, align 8, !dbg !1714
  call void @llvm.dbg.declare(metadata i64* %length, metadata !1715, metadata !1707), !dbg !1716
  store i64 0, i64* %length, align 8, !dbg !1716
  call void @llvm.dbg.declare(metadata i64* %padding, metadata !1717, metadata !1707), !dbg !1718
  store i64 0, i64* %padding, align 8, !dbg !1718
  call void @llvm.dbg.declare(metadata i64* %i, metadata !1719, metadata !1707), !dbg !1720
  call void @llvm.dbg.declare(metadata i64* %numQuantums, metadata !1721, metadata !1707), !dbg !1722
  call void @llvm.dbg.declare(metadata i64* %rawlen, metadata !1723, metadata !1707), !dbg !1724
  store i64 0, i64* %rawlen, align 8, !dbg !1724
  call void @llvm.dbg.declare(metadata i8** %pos, metadata !1725, metadata !1707), !dbg !1726
  call void @llvm.dbg.declare(metadata i8** %newstr, metadata !1727, metadata !1707), !dbg !1728
  %0 = load i8**, i8*** %outptr.addr, align 8, !dbg !1729
  store i8* null, i8** %0, align 8, !dbg !1730
  %1 = load i64*, i64** %outlen.addr, align 8, !dbg !1731
  store i64 0, i64* %1, align 8, !dbg !1732
  %2 = load i8*, i8** %src.addr, align 8, !dbg !1733
  %call = call i64 @strlen(i8* %2) #4, !dbg !1734
  store i64 %call, i64* %srclen, align 8, !dbg !1735
  %3 = load i64, i64* %srclen, align 8, !dbg !1736
  %tobool = icmp ne i64 %3, 0, !dbg !1736
  br i1 %tobool, label %lor.lhs.false, label %if.then, !dbg !1738

lor.lhs.false:                                    ; preds = %entry
  %4 = load i64, i64* %srclen, align 8, !dbg !1739
  %rem = urem i64 %4, 4, !dbg !1741
  %tobool1 = icmp ne i64 %rem, 0, !dbg !1741
  br i1 %tobool1, label %if.then, label %if.end, !dbg !1742

if.then:                                          ; preds = %lor.lhs.false, %entry
  store i32 61, i32* %retval, align 4, !dbg !1743
...
while.cond:                                       ; preds = %while.body, %if.end
  %5 = load i64, i64* %length, align 8, !dbg !1745
  %6 = load i8*, i8** %src.addr, align 8, !dbg !1747
  %arrayidx = getelementptr inbounds i8, i8* %6, i64 %5, !dbg !1747
  %7 = load i8, i8* %arrayidx, align 1, !dbg !1747
  %conv = sext i8 %7 to i32, !dbg !1747
  %cmp = icmp ne i32 %conv, 61, !dbg !1748
  br i1 %cmp, label %land.rhs, label %land.end, !dbg !1749

land.rhs:                                         ; preds = %while.cond
  %8 = load i64, i64* %length, align 8, !dbg !1750
  %9 = load i8*, i8** %src.addr, align 8, !dbg !1752
  %arrayidx3 = getelementptr inbounds i8, i8* %9, i64 %8, !dbg !1752
  %10 = load i8, i8* %arrayidx3, align 1, !dbg !1752
  %conv4 = sext i8 %10 to i32, !dbg !1752
  %tobool5 = icmp ne i32 %conv4, 0, !dbg !1753
  br label %land.end

land.end:                                         ; preds = %land.rhs, %while.cond
  %11 = phi i1 [ false, %while.cond ], [ %tobool5, %land.rhs ]
  br i1 %11, label %while.body, label %while.end, !dbg !1754

while.body:                                       ; preds = %land.end
  %12 = load i64, i64* %length, align 8, !dbg !1756
  %inc = add i64 %12, 1, !dbg !1756
  store i64 %inc, i64* %length, align 8, !dbg !1756
  br label %while.cond, !dbg !1757

while.end:                                        ; preds = %land.end
  %13 = load i64, i64* %length, align 8, !dbg !1759
  %14 = load i8*, i8** %src.addr, align 8, !dbg !1761
  %arrayidx6 = getelementptr inbounds i8, i8* %14, i64 %13, !dbg !1761
  %15 = load i8, i8* %arrayidx6, align 1, !dbg !1761
  %conv7 = sext i8 %15 to i32, !dbg !1761
  %cmp8 = icmp eq i32 %conv7, 61, !dbg !1762
  br i1 %cmp8, label %if.then10, label %if.end19, !dbg !1763

if.then10:                                        ; preds = %while.end
  %16 = load i64, i64* %padding, align 8, !dbg !1764
  %inc11 = add i64 %16, 1, !dbg !1764
  store i64 %inc11, i64* %padding, align 8, !dbg !1764
  %17 = load i64, i64* %length, align 8, !dbg !1766
  %add = add i64 %17, 1, !dbg !1768
  %18 = load i8*, i8** %src.addr, align 8, !dbg !1769
  %arrayidx12 = getelementptr inbounds i8, i8* %18, i64 %add, !dbg !1769
  %19 = load i8, i8* %arrayidx12, align 1, !dbg !1769
  %conv13 = sext i8 %19 to i32, !dbg !1769
  %cmp14 = icmp eq i32 %conv13, 61, !dbg !1770
  br i1 %cmp14, label %if.then16, label %if.end18, !dbg !1771

if.then16:                                        ; preds = %if.then10
  %20 = load i64, i64* %padding, align 8, !dbg !1772
  %inc17 = add i64 %20, 1, !dbg !1772
  store i64 %inc17, i64* %padding, align 8, !dbg !1772
  br label %if.end18, !dbg !1773

if.end18:                                         ; preds = %if.then16, %if.then10
  br label %if.end19, !dbg !1774

if.end19:                                         ; preds = %if.end18, %while.end
  %21 = load i64, i64* %length, align 8, !dbg !1775
  %22 = load i64, i64* %padding, align 8, !dbg !1777
  %add20 = add i64 %21, %22, !dbg !1778
  %23 = load i64, i64* %srclen, align 8, !dbg !1779
  %cmp21 = icmp ne i64 %add20, %23, !dbg !1780
  br i1 %cmp21, label %if.then23, label %if.end24, !dbg !1781

if.then23:                                        ; preds = %if.end19
  store i32 61, i32* %retval, align 4, !dbg !1782
  br label %return, !dbg !1782

if.end24:                                         ; preds = %if.end19
  %24 = load i64, i64* %srclen, align 8, !dbg !1783
  %div = udiv i64 %24, 4, !dbg !1784
  store i64 %div, i64* %numQuantums, align 8, !dbg !1785
  %25 = load i64, i64* %numQuantums, align 8, !dbg !1786
  %mul = mul i64 %25, 3, !dbg !1787
  %26 = load i64, i64* %padding, align 8, !dbg !1788
  %sub = sub i64 %mul, %26, !dbg !1789
  store i64 %sub, i64* %rawlen, align 8, !dbg !1790
  %27 = load i8* (i64)*, i8* (i64)** @Curl_cmalloc, align 8, !dbg !1791
  %28 = load i64, i64* %rawlen, align 8, !dbg !1791
  %add25 = add i64 %28, 1, !dbg !1791
  %call26 = call i8* %27(i64 %add25), !dbg !1791
  store i8* %call26, i8** %newstr, align 8, !dbg !1792
  %29 = load i8*, i8** %newstr, align 8, !dbg !1793
  %tobool27 = icmp ne i8* %29, null, !dbg !1793
  br i1 %tobool27, label %if.end29, label %if.then28, !dbg !1795

if.then28:                                        ; preds = %if.end24
  store i32 27, i32* %retval, align 4, !dbg !1796
  br label %return, !dbg !1796

if.end29:                                         ; preds = %if.end24
  %30 = load i8*, i8** %newstr, align 8, !dbg !1797
  store i8* %30, i8** %pos, align 8, !dbg !1798
  store i64 0, i64* %i, align 8, !dbg !1799
  br label %for.cond, !dbg !1801

for.cond:                                         ; preds = %for.inc, %if.end29
  %31 = load i64, i64* %i, align 8, !dbg !1802
  %32 = load i64, i64* %numQuantums, align 8, !dbg !1805
  %cmp30 = icmp ult i64 %31, %32, !dbg !1806
  br i1 %cmp30, label %for.body, label %for.end, !dbg !1807

for.body:                                         ; preds = %for.cond
  call void @llvm.dbg.declare(metadata i64* %result, metadata !1808, metadata !1707), !dbg !1810
  %33 = load i8*, i8** %pos, align 8, !dbg !1811
  %34 = load i8*, i8** %src.addr, align 8, !dbg !1812
  %call32 = call i64 @decodeQuantum(i8* %33, i8* %34), !dbg !1813
  store i64 %call32, i64* %result, align 8, !dbg !1810
  %35 = load i64, i64* %result, align 8, !dbg !1814
  %tobool33 = icmp ne i64 %35, 0, !dbg !1814
  br i1 %tobool33, label %if.end35, label %if.then34, !dbg !1816

if.then34:                                        ; preds = %for.body
  %36 = load void (i8*)*, void (i8*)** @Curl_cfree, align 8, !dbg !1817
  %37 = load i8*, i8** %newstr, align 8, !dbg !1817
  call void %36(i8* %37), !dbg !1817
  store i32 61, i32* %retval, align 4, !dbg !1819
  br label %return, !dbg !1819

if.end35:                                         ; preds = %for.body
  %38 = load i64, i64* %result, align 8, !dbg !1820
  %39 = load i8*, i8** %pos, align 8, !dbg !1821
  %add.ptr = getelementptr inbounds i8, i8* %39, i64 %38, !dbg !1821
  store i8* %add.ptr, i8** %pos, align 8, !dbg !1821
  %40 = load i8*, i8** %src.addr, align 8, !dbg !1822
  %add.ptr36 = getelementptr inbounds i8, i8* %40, i64 4, !dbg !1822
  store i8* %add.ptr36, i8** %src.addr, align 8, !dbg !1822
  br label %for.inc, !dbg !1823

for.inc:                                          ; preds = %if.end35
  %41 = load i64, i64* %i, align 8, !dbg !1824
  %inc37 = add i64 %41, 1, !dbg !1824
  store i64 %inc37, i64* %i, align 8, !dbg !1824
  br label %for.cond, !dbg !1826

for.end:                                          ; preds = %for.cond
  %42 = load i8*, i8** %pos, align 8, !dbg !1827
  store i8 0, i8* %42, align 1, !dbg !1828
  %43 = load i8*, i8** %newstr, align 8, !dbg !1829
  %44 = load i8**, i8*** %outptr.addr, align 8, !dbg !1830
  store i8* %43, i8** %44, align 8, !dbg !1831
  %45 = load i64, i64* %rawlen, align 8, !dbg !1832
  %46 = load i64*, i64** %outlen.addr, align 8, !dbg !1833
  store i64 %45, i64* %46, align 8, !dbg !1834
  store i32 0, i32* %retval, align 4, !dbg !1835
  br label %return, !dbg !1835

return:                                           ; preds = %for.end, %if.then34, %if.then28, %if.then23, %if.then
  %47 = load i32, i32* %retval, align 4, !dbg !1836
  ret i32 %47, !dbg !1836
}
...
; Function Attrs: nounwind uwtable
define internal i64 @decodeQuantum(i8* %dest, i8* %src) #0 !dbg !1691 {
entry:
  ...
  call void @llvm.dbg.declare(metadata i8** %dest.addr, metadata !1837, metadata !1707), !dbg !1838
  store i8* %src, i8** %src.addr, align 8
  call void @llvm.dbg.declare(metadata i8** %src.addr, metadata !1839, metadata !1707), !dbg !1840
  call void @llvm.dbg.declare(metadata i64* %padding, metadata !1841, metadata !1707), !dbg !1842
  store i64 0, i64* %padding, align 8, !dbg !1842
  call void @llvm.dbg.declare(metadata i8** %s, metadata !1843, metadata !1707), !dbg !1844
  call void @llvm.dbg.declare(metadata i8** %p, metadata !1845, metadata !1707), !dbg !1846
  call void @llvm.dbg.declare(metadata i64* %i, metadata !1847, metadata !1707), !dbg !1848
  call void @llvm.dbg.declare(metadata i64* %x, metadata !1849, metadata !1707), !dbg !1850
  store i64 0, i64* %x, align 8, !dbg !1850
  store i64 0, i64* %i, align 8, !dbg !1851
  %0 = load i8*, i8** %src.addr, align 8, !dbg !1853
  store i8* %0, i8** %s, align 8, !dbg !1854
  br label %for.cond, !dbg !1855

for.cond:                                         ; preds = %for.inc, %entry
  %1 = load i64, i64* %i, align 8, !dbg !1856
  %cmp = icmp ult i64 %1, 4, !dbg !1859
  br i1 %cmp, label %for.body, label %for.end, !dbg !1860

for.body:                                         ; preds = %for.cond
  call void @llvm.dbg.declare(metadata i64* %v, metadata !1861, metadata !1707), !dbg !1863
  store i64 0, i64* %v, align 8, !dbg !1863
  %2 = load i8*, i8** %s, align 8, !dbg !1864
  %3 = load i8, i8* %2, align 1, !dbg !1866
  %conv = sext i8 %3 to i32, !dbg !1866
  %cmp1 = icmp eq i32 %conv, 61, !dbg !1867
  br i1 %cmp1, label %if.then, label %if.else, !dbg !1868

if.then:                                          ; preds = %for.body
  %4 = load i64, i64* %x, align 8, !dbg !1869
  %shl = shl i64 %4, 6, !dbg !1871
  store i64 %shl, i64* %x, align 8, !dbg !1872
  %5 = load i64, i64* %padding, align 8, !dbg !1873
  %inc = add i64 %5, 1, !dbg !1873
  store i64 %inc, i64* %padding, align 8, !dbg !1873
  br label %if.end16, !dbg !1874

if.else:                                          ; preds = %for.body
  store i8* getelementptr inbounds ([65 x i8], [65 x i8]* @base64, i32 0, i32 0), i8** %p, align 8, !dbg !1875
  br label %while.cond, !dbg !1877

while.cond:                                       ; preds = %while.body, %if.else
  %6 = load i8*, i8** %p, align 8, !dbg !1878
  %7 = load i8, i8* %6, align 1, !dbg !1880
  %conv3 = sext i8 %7 to i32, !dbg !1880
  %tobool = icmp ne i32 %conv3, 0, !dbg !1880
  br i1 %tobool, label %land.rhs, label %land.end, !dbg !1881

land.rhs:                                         ; preds = %while.cond
  %8 = load i8*, i8** %p, align 8, !dbg !1882
  %9 = load i8, i8* %8, align 1, !dbg !1884
  %conv4 = sext i8 %9 to i32, !dbg !1884
  %10 = load i8*, i8** %s, align 8, !dbg !1885
  %11 = load i8, i8* %10, align 1, !dbg !1886
  %conv5 = sext i8 %11 to i32, !dbg !1886
  %cmp6 = icmp ne i32 %conv4, %conv5, !dbg !1887
  br label %land.end

land.end:                                         ; preds = %land.rhs, %while.cond
  %12 = phi i1 [ false, %while.cond ], [ %cmp6, %land.rhs ]
  br i1 %12, label %while.body, label %while.end, !dbg !1888

while.body:                                       ; preds = %land.end
  %13 = load i64, i64* %v, align 8, !dbg !1890
  %inc8 = add i64 %13, 1, !dbg !1890
  store i64 %inc8, i64* %v, align 8, !dbg !1890
  %14 = load i8*, i8** %p, align 8, !dbg !1892
  %incdec.ptr = getelementptr inbounds i8, i8* %14, i32 1, !dbg !1892
  store i8* %incdec.ptr, i8** %p, align 8, !dbg !1892
  br label %while.cond, !dbg !1893

while.end:                                        ; preds = %land.end
  %15 = load i8*, i8** %p, align 8, !dbg !1895
  %16 = load i8, i8* %15, align 1, !dbg !1897
  %conv9 = sext i8 %16 to i32, !dbg !1897
  %17 = load i8*, i8** %s, align 8, !dbg !1898
  %18 = load i8, i8* %17, align 1, !dbg !1899
  %conv10 = sext i8 %18 to i32, !dbg !1899
  %cmp11 = icmp eq i32 %conv9, %conv10, !dbg !1900
  br i1 %cmp11, label %if.then13, label %if.else15, !dbg !1901

if.then13:                                        ; preds = %while.end
  %19 = load i64, i64* %x, align 8, !dbg !1902
  %shl14 = shl i64 %19, 6, !dbg !1903
  %20 = load i64, i64* %v, align 8, !dbg !1904
  %add = add i64 %shl14, %20, !dbg !1905
  store i64 %add, i64* %x, align 8, !dbg !1906
  br label %if.end, !dbg !1907

if.else15:                                        ; preds = %while.end
  store i64 0, i64* %retval, align 8, !dbg !1908
...
for.inc:                                          ; preds = %if.end16
  %21 = load i64, i64* %i, align 8, !dbg !1910
  %inc17 = add i64 %21, 1, !dbg !1910
  store i64 %inc17, i64* %i, align 8, !dbg !1910
  %22 = load i8*, i8** %s, align 8, !dbg !1912
  %incdec.ptr18 = getelementptr inbounds i8, i8* %22, i32 1, !dbg !1912
  store i8* %incdec.ptr18, i8** %s, align 8, !dbg !1912
  br label %for.cond, !dbg !1913

for.end:                                          ; preds = %for.cond
  %23 = load i64, i64* %padding, align 8, !dbg !1914
  %cmp19 = icmp ult i64 %23, 1, !dbg !1916
  br i1 %cmp19, label %if.then21, label %if.end22, !dbg !1917

if.then21:                                        ; preds = %for.end
  %24 = load i64, i64* %x, align 8, !dbg !1918
  %and = and i64 %24, 255, !dbg !1919
  %call = call zeroext i8 @curlx_ultouc(i64 %and), !dbg !1920
  %25 = load i8*, i8** %dest.addr, align 8, !dbg !1921
  %arrayidx = getelementptr inbounds i8, i8* %25, i64 2, !dbg !1921
  store i8 %call, i8* %arrayidx, align 1, !dbg !1922
  br label %if.end22, !dbg !1921

if.end22:                                         ; preds = %if.then21, %for.end
  %26 = load i64, i64* %x, align 8, !dbg !1923
  %shr = lshr i64 %26, 8, !dbg !1923
  store i64 %shr, i64* %x, align 8, !dbg !1923
  %27 = load i64, i64* %padding, align 8, !dbg !1924
  %cmp23 = icmp ult i64 %27, 2, !dbg !1926
  br i1 %cmp23, label %if.then25, label %if.end29, !dbg !1927

if.then25:                                        ; preds = %if.end22
  %28 = load i64, i64* %x, align 8, !dbg !1928
  %and26 = and i64 %28, 255, !dbg !1929
  %call27 = call zeroext i8 @curlx_ultouc(i64 %and26), !dbg !1930
  %29 = load i8*, i8** %dest.addr, align 8, !dbg !1931
  %arrayidx28 = getelementptr inbounds i8, i8* %29, i64 1, !dbg !1931
  store i8 %call27, i8* %arrayidx28, align 1, !dbg !1932
  br label %if.end29, !dbg !1931

if.end29:                                         ; preds = %if.then25, %if.end22
  %30 = load i64, i64* %x, align 8, !dbg !1933
  %shr30 = lshr i64 %30, 8, !dbg !1933
  store i64 %shr30, i64* %x, align 8, !dbg !1933
  %31 = load i64, i64* %x, align 8, !dbg !1934
  %and31 = and i64 %31, 255, !dbg !1935
  %call32 = call zeroext i8 @curlx_ultouc(i64 %and31), !dbg !1936
  %32 = load i8*, i8** %dest.addr, align 8, !dbg !1937
  %arrayidx33 = getelementptr inbounds i8, i8* %32, i64 0, !dbg !1937
  store i8 %call32, i8* %arrayidx33, align 1, !dbg !1938
  %33 = load i64, i64* %padding, align 8, !dbg !1939
  %sub = sub i64 3, %33, !dbg !1940
  store i64 %sub, i64* %retval, align 8, !dbg !1941
  br label %return, !dbg !1941

return:                                           ; preds = %if.end29, %if.else15
  %34 = load i64, i64* %retval, align 8, !dbg !1942
  ret i64 %34, !dbg !1942
}

; Function Attrs: nounwind uwtable
define i32 @Curl_base64_encode(%struct.Curl_easy* %data, i8* %inputbuff, i64 %insize, i8** %outptr, i64* %outlen) #0 !dbg !1687 {
entry:
  %data.addr = alloca %struct.Curl_easy*, align 8
  %inputbuff.addr = alloca i8*, align 8
  %insize.addr = alloca i64, align 8
  %outptr.addr = alloca i8**, align 8
  %outlen.addr = alloca i64*, align 8
  store %struct.Curl_easy* %data, %struct.Curl_easy** %data.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.Curl_easy** %data.addr, metadata !1943, metadata !1707), !dbg !1944
  store i8* %inputbuff, i8** %inputbuff.addr, align 8
  call void @llvm.dbg.declare(metadata i8** %inputbuff.addr, metadata !1945, metadata !1707), !dbg !1946
  store i64 %insize, i64* %insize.addr, align 8
  call void @llvm.dbg.declare(metadata i64* %insize.addr, metadata !1947, metadata !1707), !dbg !1948
  store i8** %outptr, i8*** %outptr.addr, align 8
  call void @llvm.dbg.declare(metadata i8*** %outptr.addr, metadata !1949, metadata !1707), !dbg !1950
  store i64* %outlen, i64** %outlen.addr, align 8
  call void @llvm.dbg.declare(metadata i64** %outlen.addr, metadata !1951, metadata !1707), !dbg !1952
  %0 = load %struct.Curl_easy*, %struct.Curl_easy** %data.addr, align 8, !dbg !1953
  %1 = load i8*, i8** %inputbuff.addr, align 8, !dbg !1954
  %2 = load i64, i64* %insize.addr, align 8, !dbg !1955
  %3 = load i8**, i8*** %outptr.addr, align 8, !dbg !1956
  %4 = load i64*, i64** %outlen.addr, align 8, !dbg !1957
  %call = call i32 @base64_encode(i8* getelementptr inbounds ([65 x i8], [65 x i8]* @base64, i32 0, i32 0), %struct.Curl_easy* %0, i8* %1, i64 %2, i8** %3, i64* %4), !dbg !1958
  ret i32 %call, !dbg !1959
}

; Function Attrs: nounwind uwtable
define internal i32 @base64_encode(i8* %table64, %struct.Curl_easy* %data, i8* %inputbuff, i64 %insize, i8** %outptr, i64* %outlen) #0 !dbg !1694 {
entry:
  %retval = alloca i32, align 4
  %table64.addr = alloca i8*, align 8
  %data.addr = alloca %struct.Curl_easy*, align 8
  %inputbuff.addr = alloca i8*, align 8
  %insize.addr = alloca i64, align 8
  %outptr.addr = alloca i8**, align 8
  ...
  %ibuf = alloca [3 x i8], align 1
  %obuf = alloca [4 x i8], align 1
  %i = alloca i32, align 4
  %inputparts = alloca i32, align 4
  %output = alloca i8*, align 8
  %base64data = alloca i8*, align 8
  %convbuf = alloca i8*, align 8
  %indata = alloca i8*, align 8
  store i8* %table64, i8** %table64.addr, align 8
  call void @llvm.dbg.declare(metadata i8** %table64.addr, metadata !1960, metadata !1707), !dbg !1961
  store %struct.Curl_easy* %data, %struct.Curl_easy** %data.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.Curl_easy** %data.addr, metadata !1962, metadata !1707), !dbg !1963
  store i8* %inputbuff, i8** %inputbuff.addr, align 8
  call void @llvm.dbg.declare(metadata i8** %inputbuff.addr, metadata !1964, metadata !1707), !dbg !1965
  store i64 %insize, i64* %insize.addr, align 8
  call void @llvm.dbg.declare(metadata i64* %insize.addr, metadata !1966, metadata !1707), !dbg !1967
  store i8** %outptr, i8*** %outptr.addr, align 8
  call void @llvm.dbg.declare(metadata i8*** %outptr.addr, metadata !1968, metadata !1707), !dbg !1969
  store i64* %outlen, i64** %outlen.addr, align 8
  call void @llvm.dbg.declare(metadata i64** %outlen.addr, metadata !1970, metadata !1707), !dbg !1971
  call void @llvm.dbg.declare(metadata i32* %result, metadata !1972, metadata !1707), !dbg !1973
  call void @llvm.dbg.declare(metadata [3 x i8]* %ibuf, metadata !1974, metadata !1707), !dbg !1976
  call void @llvm.dbg.declare(metadata [4 x i8]* %obuf, metadata !1977, metadata !1707), !dbg !1981
  call void @llvm.dbg.declare(metadata i32* %i, metadata !1982, metadata !1707), !dbg !1983
  call void @llvm.dbg.declare(metadata i32* %inputparts, metadata !1984, metadata !1707), !dbg !1985
  call void @llvm.dbg.declare(metadata i8** %output, metadata !1986, metadata !1707), !dbg !1987
  call void @llvm.dbg.declare(metadata i8** %base64data, metadata !1988, metadata !1707), !dbg !1989
  call void @llvm.dbg.declare(metadata i8** %convbuf, metadata !1990, metadata !1707), !dbg !1991
  store i8* null, i8** %convbuf, align 8, !dbg !1991
  call void @llvm.dbg.declare(metadata i8** %indata, metadata !1992, metadata !1707), !dbg !1993
  %0 = load i8*, i8** %inputbuff.addr, align 8, !dbg !1994
  store i8* %0, i8** %indata, align 8, !dbg !1993
  %1 = load i8**, i8*** %outptr.addr, align 8, !dbg !1995
  store i8* null, i8** %1, align 8, !dbg !1996
  %2 = load i64*, i64** %outlen.addr, align 8, !dbg !1997
  store i64 0, i64* %2, align 8, !dbg !1998
  %3 = load i64, i64* %insize.addr, align 8, !dbg !1999
  %tobool = icmp ne i64 %3, 0, !dbg !1999
  br i1 %tobool, label %if.end, label %if.then, !dbg !2001

if.then:                                          ; preds = %entry
  %4 = load i8*, i8** %indata, align 8, !dbg !2002
  %call = call i64 @strlen(i8* %4) #4, !dbg !2003
  store i64 %call, i64* %insize.addr, align 8, !dbg !2004
  br label %if.end, !dbg !2005

if.end:                                           ; preds = %if.then, %entry
  %5 = load i8* (i64)*, i8* (i64)** @Curl_cmalloc, align 8, !dbg !2006
  %6 = load i64, i64* %insize.addr, align 8, !dbg !2006
  %mul = mul i64 %6, 4, !dbg !2006
  %div = udiv i64 %mul, 3, !dbg !2006
  %add = add i64 %div, 4, !dbg !2006
  %call1 = call i8* %5(i64 %add), !dbg !2006
  store i8* %call1, i8** %output, align 8, !dbg !2007
  store i8* %call1, i8** %base64data, align 8, !dbg !2008
  %7 = load i8*, i8** %output, align 8, !dbg !2009
  %tobool2 = icmp ne i8* %7, null, !dbg !2009
  br i1 %tobool2, label %if.end4, label %if.then3, !dbg !2011
...
if.end4:                                          ; preds = %if.end
  %8 = load %struct.Curl_easy*, %struct.Curl_easy** %data.addr, align 8, !dbg !2013
  store i32 0, i32* %result, align 4, !dbg !2014
  %9 = load i32, i32* %result, align 4, !dbg !2015
  %tobool5 = icmp ne i32 %9, 0, !dbg !2015
  br i1 %tobool5, label %if.then6, label %if.end7, !dbg !2017

if.then6:                                         ; preds = %if.end4
  %10 = load void (i8*)*, void (i8*)** @Curl_cfree, align 8, !dbg !2018
  %11 = load i8*, i8** %output, align 8, !dbg !2018
  call void %10(i8* %11), !dbg !2018
  %12 = load i32, i32* %result, align 4, !dbg !2020
  store i32 %12, i32* %retval, align 4, !dbg !2021
  br label %return, !dbg !2021

if.end7:                                          ; preds = %if.end4
  %13 = load i8*, i8** %convbuf, align 8, !dbg !2022
  %tobool8 = icmp ne i8* %13, null, !dbg !2022
  br i1 %tobool8, label %if.then9, label %if.end10, !dbg !2024

if.then9:                                         ; preds = %if.end7
  %14 = load i8*, i8** %convbuf, align 8, !dbg !2025
  store i8* %14, i8** %indata, align 8, !dbg !2026
  br label %if.end10, !dbg !2027

if.end10:                                         ; preds = %if.then9, %if.end7
  br label %while.cond, !dbg !2028

while.cond:                                       ; preds = %sw.epilog, %if.end10
  %15 = load i64, i64* %insize.addr, align 8, !dbg !2029
  %cmp = icmp ugt i64 %15, 0, !dbg !2031
  br i1 %cmp, label %while.body, label %while.end, !dbg !2032

while.body:                                       ; preds = %while.cond
  store i32 0, i32* %inputparts, align 4, !dbg !2033
  store i32 0, i32* %i, align 4, !dbg !2036
  br label %for.cond, !dbg !2037

for.cond:                                         ; preds = %for.inc, %while.body
  %16 = load i32, i32* %i, align 4, !dbg !2038
  %cmp11 = icmp slt i32 %16, 3, !dbg !2041
  br i1 %cmp11, label %for.body, label %for.end, !dbg !2042

for.body:                                         ; preds = %for.cond
  %17 = load i64, i64* %insize.addr, align 8, !dbg !2043
  %cmp12 = icmp ugt i64 %17, 0, !dbg !2046
  br i1 %cmp12, label %if.then13, label %if.else, !dbg !2047

if.then13:                                        ; preds = %for.body
  %18 = load i32, i32* %inputparts, align 4, !dbg !2048
  %inc = add nsw i32 %18, 1, !dbg !2048
  store i32 %inc, i32* %inputparts, align 4, !dbg !2048
  %19 = load i8*, i8** %indata, align 8, !dbg !2050
  %20 = load i8, i8* %19, align 1, !dbg !2051
  %21 = load i32, i32* %i, align 4, !dbg !2052
  %idxprom = sext i32 %21 to i64, !dbg !2053
  %arrayidx = getelementptr inbounds [3 x i8], [3 x i8]* %ibuf, i64 0, i64 %idxprom, !dbg !2053
  store i8 %20, i8* %arrayidx, align 1, !dbg !2054
  %22 = load i8*, i8** %indata, align 8, !dbg !2055
  %incdec.ptr = getelementptr inbounds i8, i8* %22, i32 1, !dbg !2055
  store i8* %incdec.ptr, i8** %indata, align 8, !dbg !2055
  %23 = load i64, i64* %insize.addr, align 8, !dbg !2056
  %dec = add i64 %23, -1, !dbg !2056
  store i64 %dec, i64* %insize.addr, align 8, !dbg !2056
  br label %if.end16, !dbg !2057

if.else:                                          ; preds = %for.body
  %24 = load i32, i32* %i, align 4, !dbg !2058
  %idxprom14 = sext i32 %24 to i64, !dbg !2059
  %arrayidx15 = getelementptr inbounds [3 x i8], [3 x i8]* %ibuf, i64 0, i64 %idxprom14, !dbg !2059
  store i8 0, i8* %arrayidx15, align 1, !dbg !2060
  br label %if.end16
...
for.inc:                                          ; preds = %if.end16
  %25 = load i32, i32* %i, align 4, !dbg !2062
  %inc17 = add nsw i32 %25, 1, !dbg !2062
  store i32 %inc17, i32* %i, align 4, !dbg !2062
  br label %for.cond, !dbg !2064

for.end:                                          ; preds = %for.cond
  %arrayidx18 = getelementptr inbounds [3 x i8], [3 x i8]* %ibuf, i64 0, i64 0, !dbg !2065
  %26 = load i8, i8* %arrayidx18, align 1, !dbg !2065
  %conv = zext i8 %26 to i32, !dbg !2065
  %and = and i32 %conv, 252, !dbg !2066
  %shr = ashr i32 %and, 2, !dbg !2067
  %conv19 = trunc i32 %shr to i8, !dbg !2068
  %arrayidx20 = getelementptr inbounds [4 x i8], [4 x i8]* %obuf, i64 0, i64 0, !dbg !2069
  store i8 %conv19, i8* %arrayidx20, align 1, !dbg !2070
  %arrayidx21 = getelementptr inbounds [3 x i8], [3 x i8]* %ibuf, i64 0, i64 0, !dbg !2071
  %27 = load i8, i8* %arrayidx21, align 1, !dbg !2071
  %conv22 = zext i8 %27 to i32, !dbg !2071
  %and23 = and i32 %conv22, 3, !dbg !2072
  %shl = shl i32 %and23, 4, !dbg !2073
  %arrayidx24 = getelementptr inbounds [3 x i8], [3 x i8]* %ibuf, i64 0, i64 1, !dbg !2074
  %28 = load i8, i8* %arrayidx24, align 1, !dbg !2074
  %conv25 = zext i8 %28 to i32, !dbg !2074
  %and26 = and i32 %conv25, 240, !dbg !2075
  %shr27 = ashr i32 %and26, 4, !dbg !2076
  %or = or i32 %shl, %shr27, !dbg !2077
  %conv28 = trunc i32 %or to i8, !dbg !2078
  %arrayidx29 = getelementptr inbounds [4 x i8], [4 x i8]* %obuf, i64 0, i64 1, !dbg !2079
  store i8 %conv28, i8* %arrayidx29, align 1, !dbg !2080
  %arrayidx30 = getelementptr inbounds [3 x i8], [3 x i8]* %ibuf, i64 0, i64 1, !dbg !2081
  %29 = load i8, i8* %arrayidx30, align 1, !dbg !2081
  %conv31 = zext i8 %29 to i32, !dbg !2081
  %and32 = and i32 %conv31, 15, !dbg !2082
  %shl33 = shl i32 %and32, 2, !dbg !2083
  %arrayidx34 = getelementptr inbounds [3 x i8], [3 x i8]* %ibuf, i64 0, i64 2, !dbg !2084
  %30 = load i8, i8* %arrayidx34, align 1, !dbg !2084
  %conv35 = zext i8 %30 to i32, !dbg !2084
  %and36 = and i32 %conv35, 192, !dbg !2085
  %shr37 = ashr i32 %and36, 6, !dbg !2086
  %or38 = or i32 %shl33, %shr37, !dbg !2087
  %conv39 = trunc i32 %or38 to i8, !dbg !2088
  %arrayidx40 = getelementptr inbounds [4 x i8], [4 x i8]* %obuf, i64 0, i64 2, !dbg !2089
  store i8 %conv39, i8* %arrayidx40, align 1, !dbg !2090
  %arrayidx41 = getelementptr inbounds [3 x i8], [3 x i8]* %ibuf, i64 0, i64 2, !dbg !2091
  %31 = load i8, i8* %arrayidx41, align 1, !dbg !2091
  %conv42 = zext i8 %31 to i32, !dbg !2091
  %and43 = and i32 %conv42, 63, !dbg !2092
  %conv44 = trunc i32 %and43 to i8, !dbg !2093
  %arrayidx45 = getelementptr inbounds [4 x i8], [4 x i8]* %obuf, i64 0, i64 3, !dbg !2094
  store i8 %conv44, i8* %arrayidx45, align 1, !dbg !2095
  %32 = load i32, i32* %inputparts, align 4, !dbg !2096
...
sw.bb:                                            ; preds = %for.end
  %33 = load i8*, i8** %output, align 8, !dbg !2098
  %arrayidx46 = getelementptr inbounds [4 x i8], [4 x i8]* %obuf, i64 0, i64 0, !dbg !2100
  %34 = load i8, i8* %arrayidx46, align 1, !dbg !2100
  %idxprom47 = zext i8 %34 to i64, !dbg !2101
  %35 = load i8*, i8** %table64.addr, align 8, !dbg !2101
  %arrayidx48 = getelementptr inbounds i8, i8* %35, i64 %idxprom47, !dbg !2101
  %36 = load i8, i8* %arrayidx48, align 1, !dbg !2101
  %conv49 = sext i8 %36 to i32, !dbg !2101
  %arrayidx50 = getelementptr inbounds [4 x i8], [4 x i8]* %obuf, i64 0, i64 1, !dbg !2102
  %37 = load i8, i8* %arrayidx50, align 1, !dbg !2102
  %idxprom51 = zext i8 %37 to i64, !dbg !2103
  %38 = load i8*, i8** %table64.addr, align 8, !dbg !2103
  %arrayidx52 = getelementptr inbounds i8, i8* %38, i64 %idxprom51, !dbg !2103
  %39 = load i8, i8* %arrayidx52, align 1, !dbg !2103
  %conv53 = sext i8 %39 to i32, !dbg !2103
  %call54 = call i32 (i8*, i64, i8*, ...) @curl_msnprintf(i8* %33, i64 5, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i32 0, i32 0), i32 %conv49, i32 %conv53), !dbg !2104
  br label %sw.epilog, !dbg !2105

sw.bb55:                                          ; preds = %for.end
  %40 = load i8*, i8** %output, align 8, !dbg !2106
  %arrayidx56 = getelementptr inbounds [4 x i8], [4 x i8]* %obuf, i64 0, i64 0, !dbg !2107
  %41 = load i8, i8* %arrayidx56, align 1, !dbg !2107
  %idxprom57 = zext i8 %41 to i64, !dbg !2108
  %42 = load i8*, i8** %table64.addr, align 8, !dbg !2108
  %arrayidx58 = getelementptr inbounds i8, i8* %42, i64 %idxprom57, !dbg !2108
  %43 = load i8, i8* %arrayidx58, align 1, !dbg !2108
  %conv59 = sext i8 %43 to i32, !dbg !2108
  %arrayidx60 = getelementptr inbounds [4 x i8], [4 x i8]* %obuf, i64 0, i64 1, !dbg !2109
  %44 = load i8, i8* %arrayidx60, align 1, !dbg !2109
  %idxprom61 = zext i8 %44 to i64, !dbg !2110
  %45 = load i8*, i8** %table64.addr, align 8, !dbg !2110
  %arrayidx62 = getelementptr inbounds i8, i8* %45, i64 %idxprom61, !dbg !2110
  %46 = load i8, i8* %arrayidx62, align 1, !dbg !2110
  %conv63 = sext i8 %46 to i32, !dbg !2110
  %arrayidx64 = getelementptr inbounds [4 x i8], [4 x i8]* %obuf, i64 0, i64 2, !dbg !2111
  %47 = load i8, i8* %arrayidx64, align 1, !dbg !2111
  %idxprom65 = zext i8 %47 to i64, !dbg !2112
  %48 = load i8*, i8** %table64.addr, align 8, !dbg !2112
  %arrayidx66 = getelementptr inbounds i8, i8* %48, i64 %idxprom65, !dbg !2112
  %49 = load i8, i8* %arrayidx66, align 1, !dbg !2112
  %conv67 = sext i8 %49 to i32, !dbg !2112
  %call68 = call i32 (i8*, i64, i8*, ...) @curl_msnprintf(i8* %40, i64 5, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1, i32 0, i32 0), i32 %conv59, i32 %conv63, i32 %conv67), !dbg !2113
  br label %sw.epilog, !dbg !2114

sw.default:                                       ; preds = %for.end
  %50 = load i8*, i8** %output, align 8, !dbg !2115
  %arrayidx69 = getelementptr inbounds [4 x i8], [4 x i8]* %obuf, i64 0, i64 0, !dbg !2116
  %51 = load i8, i8* %arrayidx69, align 1, !dbg !2116
  %idxprom70 = zext i8 %51 to i64, !dbg !2117
  %52 = load i8*, i8** %table64.addr, align 8, !dbg !2117
  %arrayidx71 = getelementptr inbounds i8, i8* %52, i64 %idxprom70, !dbg !2117
  %53 = load i8, i8* %arrayidx71, align 1, !dbg !2117
  %conv72 = sext i8 %53 to i32, !dbg !2117
  %arrayidx73 = getelementptr inbounds [4 x i8], [4 x i8]* %obuf, i64 0, i64 1, !dbg !2118
  %54 = load i8, i8* %arrayidx73, align 1, !dbg !2118
  %idxprom74 = zext i8 %54 to i64, !dbg !2119
  %55 = load i8*, i8** %table64.addr, align 8, !dbg !2119
  %arrayidx75 = getelementptr inbounds i8, i8* %55, i64 %idxprom74, !dbg !2119
  %56 = load i8, i8* %arrayidx75, align 1, !dbg !2119
  %conv76 = sext i8 %56 to i32, !dbg !2119
  %arrayidx77 = getelementptr inbounds [4 x i8], [4 x i8]* %obuf, i64 0, i64 2, !dbg !2120
  %57 = load i8, i8* %arrayidx77, align 1, !dbg !2120
  %idxprom78 = zext i8 %57 to i64, !dbg !2121
  %58 = load i8*, i8** %table64.addr, align 8, !dbg !2121
  %arrayidx79 = getelementptr inbounds i8, i8* %58, i64 %idxprom78, !dbg !2121
  %59 = load i8, i8* %arrayidx79, align 1, !dbg !2121
  %conv80 = sext i8 %59 to i32, !dbg !2121
  %arrayidx81 = getelementptr inbounds [4 x i8], [4 x i8]* %obuf, i64 0, i64 3, !dbg !2122
  %60 = load i8, i8* %arrayidx81, align 1, !dbg !2122
  %idxprom82 = zext i8 %60 to i64, !dbg !2123
  %61 = load i8*, i8** %table64.addr, align 8, !dbg !2123
  %arrayidx83 = getelementptr inbounds i8, i8* %61, i64 %idxprom82, !dbg !2123
  %62 = load i8, i8* %arrayidx83, align 1, !dbg !2123
  %conv84 = sext i8 %62 to i32, !dbg !2123
  %call85 = call i32 (i8*, i64, i8*, ...) @curl_msnprintf(i8* %50, i64 5, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.2, i32 0, i32 0), i32 %conv72, i32 %conv76, i32 %conv80, i32 %conv84), !dbg !2124
  br label %sw.epilog, !dbg !2125

sw.epilog:                                        ; preds = %sw.default, %sw.bb55, %sw.bb
  %63 = load i8*, i8** %output, align 8, !dbg !2126
  %add.ptr = getelementptr inbounds i8, i8* %63, i64 4, !dbg !2126
  store i8* %add.ptr, i8** %output, align 8, !dbg !2126
  br label %while.cond, !dbg !2127

while.end:                                        ; preds = %while.cond
  %64 = load i8*, i8** %output, align 8, !dbg !2129
  store i8 0, i8* %64, align 1, !dbg !2130
  %65 = load i8*, i8** %base64data, align 8, !dbg !2131
  %66 = load i8**, i8*** %outptr.addr, align 8, !dbg !2132
  store i8* %65, i8** %66, align 8, !dbg !2133
  %67 = load void (i8*)*, void (i8*)** @Curl_cfree, align 8, !dbg !2134
  %68 = load i8*, i8** %convbuf, align 8, !dbg !2134
  call void %67(i8* %68), !dbg !2134
  %69 = load i8*, i8** %base64data, align 8, !dbg !2135
  %call86 = call i64 @strlen(i8* %69) #4, !dbg !2136
  %70 = load i64*, i64** %outlen.addr, align 8, !dbg !2137
  store i64 %call86, i64* %70, align 8, !dbg !2138
  store i32 0, i32* %retval, align 4, !dbg !2139
  br label %return, !dbg !2139

return:                                           ; preds = %while.end, %if.then6, %if.then3
  %71 = load i32, i32* %retval, align 4, !dbg !2140
  ret i32 %71, !dbg !2140
}

; Function Attrs: nounwind uwtable
define i32 @Curl_base64url_encode(%struct.Curl_easy* %data, i8* %inputbuff, i64 %insize, i8** %outptr, i64* %outlen) #0 !dbg !1690 {
entry:
  %data.addr = alloca %struct.Curl_easy*, align 8
  %inputbuff.addr = alloca i8*, align 8
  %insize.addr = alloca i64, align 8
  ...
  %outlen.addr = alloca i64*, align 8
  store %struct.Curl_easy* %data, %struct.Curl_easy** %data.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.Curl_easy** %data.addr, metadata !2141, metadata !1707), !dbg !2142
  store i8* %inputbuff, i8** %inputbuff.addr, align 8
  call void @llvm.dbg.declare(metadata i8** %inputbuff.addr, metadata !2143, metadata !1707), !dbg !2144
  store i64 %insize, i64* %insize.addr, align 8
  call void @llvm.dbg.declare(metadata i64* %insize.addr, metadata !2145, metadata !1707), !dbg !2146
  store i8** %outptr, i8*** %outptr.addr, align 8
  call void @llvm.dbg.declare(metadata i8*** %outptr.addr, metadata !2147, metadata !1707), !dbg !2148
  store i64* %outlen, i64** %outlen.addr, align 8
  call void @llvm.dbg.declare(metadata i64** %outlen.addr, metadata !2149, metadata !1707), !dbg !2150
  %0 = load %struct.Curl_easy*, %struct.Curl_easy** %data.addr, align 8, !dbg !2151
  %1 = load i8*, i8** %inputbuff.addr, align 8, !dbg !2152
  %2 = load i64, i64* %insize.addr, align 8, !dbg !2153
  %3 = load i8**, i8*** %outptr.addr, align 8, !dbg !2154
  %4 = load i64*, i64** %outlen.addr, align 8, !dbg !2155
  %call = call i32 @base64_encode(i8* getelementptr inbounds ([65 x i8], [65 x i8]* @base64url, i32 0, i32 0), %struct.Curl_easy* %0, i8* %1, i64 %2, i8** %3, i64* %4), !dbg !2156
  ret i32 %call, !dbg !2157
}
...
!0 = distinct !DICompileUnit(language: DW_LANG_C99, file: !1, producer: "clang version 3.8.0 (tags/RELEASE_380/final)", isOptimized: false, runtimeVersion: 0, emissionKind: 1, enums: !2, retainedTypes: !1678, subprograms: !1679, globals: !1697)
!1 = !DIFile(filename: "/data/download/cmake/cmake-master/Utilities/cmcurl/lib/base64.c", directory: "/data/download/cmake/cmake-master/Utilities/cmcurl/lib")
...
!1678 = !{!479, !1648}
!1679 = !{!1680, !1687, !1690, !1691, !1694}
!1680 = distinct !DISubprogram(name: "Curl_base64_decode", scope: !1, file: !1, line: 100, type: !1681, isLocal: false, isDefinition: true, scopeLine: 102, flags: DIFlagPrototyped, isOptimized: false, variables: !1686)
!1681 = !DISubroutineType(types: !1682)
!1682 = !{!289, !851, !1683, !1685}
!1683 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1684, size: 64, align: 64)
!1684 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1648, size: 64, align: 64)
!1685 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !347, size: 64, align: 64)
!1686 = !{}
!1687 = distinct !DISubprogram(name: "Curl_base64_encode", scope: !1, file: !1, line: 291, type: !1688, isLocal: false, isDefinition: true, scopeLine: 294, flags: DIFlagPrototyped, isOptimized: false, variables: !1686)
!1688 = !DISubroutineType(types: !1689)
!1689 = !{!289, !256, !851, !347, !1524, !1685}
!1690 = distinct !DISubprogram(name: "Curl_base64url_encode", scope: !1, file: !1, line: 315, type: !1688, isLocal: false, isDefinition: true, scopeLine: 318, flags: DIFlagPrototyped, isOptimized: false, variables: !1686)
!1691 = distinct !DISubprogram(name: "decodeQuantum", scope: !1, file: !1, line: 45, type: !1692, isLocal: true, isDefinition: true, scopeLine: 46, flags: DIFlagPrototyped, isOptimized: false, variables: !1686)
!1692 = !DISubroutineType(types: !1693)
!1693 = !{!347, !1684, !851}
!1694 = distinct !DISubprogram(name: "base64_encode", scope: !1, file: !1, line: 171, type: !1695, isLocal: true, isDefinition: true, scopeLine: 175, flags: DIFlagPrototyped, isOptimized: false, variables: !1686)
!1695 = !DISubroutineType(types: !1696)
!1696 = !{!289, !851, !256, !851, !347, !1524, !1685}
!1697 = !{!1698, !1702}
!1698 = !DIGlobalVariable(name: "base64", scope: !0, file: !1, line: 37, type: !1699, isLocal: true, isDefinition: true, variable: [65 x i8]* @base64)
!1699 = !DICompositeType(tag: DW_TAG_array_type, baseType: !852, size: 520, align: 8, elements: !1700)
!1700 = !{!1701}
!1701 = !DISubrange(count: 65)
!1702 = !DIGlobalVariable(name: "base64url", scope: !0, file: !1, line: 42, type: !1699, isLocal: true, isDefinition: true, variable: [65 x i8]* @base64url)
!1703 = !{i32 2, !"Dwarf Version", i32 4}
!1704 = !{i32 2, !"Debug Info Version", i32 3}
!1705 = !{!"clang version 3.8.0 (tags/RELEASE_380/final)"}
!1706 = !DILocalVariable(name: "src", arg: 1, scope: !1680, file: !1, line: 100, type: !851)
!1707 = !DIExpression()
!1708 = !DILocation(line: 100, column: 41, scope: !1680)
!1709 = !DILocalVariable(name: "outptr", arg: 2, scope: !1680, file: !1, line: 101, type: !1683)
!1710 = !DILocation(line: 101, column: 45, scope: !1680)
!1711 = !DILocalVariable(name: "outlen", arg: 3, scope: !1680, file: !1, line: 101, type: !1685)
!1712 = !DILocation(line: 101, column: 61, scope: !1680)
!1713 = !DILocalVariable(name: "srclen", scope: !1680, file: !1, line: 103, type: !347)
!1714 = !DILocation(line: 103, column: 10, scope: !1680)
!1715 = !DILocalVariable(name: "length", scope: !1680, file: !1, line: 104, type: !347)
!1716 = !DILocation(line: 104, column: 10, scope: !1680)
!1717 = !DILocalVariable(name: "padding", scope: !1680, file: !1, line: 105, type: !347)
!1718 = !DILocation(line: 105, column: 10, scope: !1680)
!1719 = !DILocalVariable(name: "i", scope: !1680, file: !1, line: 106, type: !347)
!1720 = !DILocation(line: 106, column: 10, scope: !1680)
!1721 = !DILocalVariable(name: "numQuantums", scope: !1680, file: !1, line: 107, type: !347)
!1722 = !DILocation(line: 107, column: 10, scope: !1680)
!1723 = !DILocalVariable(name: "rawlen", scope: !1680, file: !1, line: 108, type: !347)
!1724 = !DILocation(line: 108, column: 10, scope: !1680)
!1725 = !DILocalVariable(name: "pos", scope: !1680, file: !1, line: 109, type: !1684)
!1726 = !DILocation(line: 109, column: 18, scope: !1680)
!1727 = !DILocalVariable(name: "newstr", scope: !1680, file: !1, line: 110, type: !1684)
!1728 = !DILocation(line: 110, column: 18, scope: !1680)
!1729 = !DILocation(line: 112, column: 4, scope: !1680)
!1730 = !DILocation(line: 112, column: 11, scope: !1680)
!1731 = !DILocation(line: 113, column: 4, scope: !1680)
!1732 = !DILocation(line: 113, column: 11, scope: !1680)
!1733 = !DILocation(line: 114, column: 19, scope: !1680)
!1734 = !DILocation(line: 114, column: 12, scope: !1680)
!1735 = !DILocation(line: 114, column: 10, scope: !1680)
!1736 = !DILocation(line: 117, column: 7, scope: !1737)
!1737 = distinct !DILexicalBlock(scope: !1680, file: !1, line: 117, column: 6)
!1738 = !DILocation(line: 117, column: 14, scope: !1737)
!1739 = !DILocation(line: 117, column: 17, scope: !1740)
!1740 = !DILexicalBlockFile(scope: !1737, file: !1, discriminator: 1)
!1741 = !DILocation(line: 117, column: 24, scope: !1740)
!1742 = !DILocation(line: 117, column: 6, scope: !1740)
!1743 = !DILocation(line: 118, column: 5, scope: !1737)
!1744 = !DILocation(line: 121, column: 3, scope: !1680)
!1745 = !DILocation(line: 121, column: 14, scope: !1746)
!1746 = !DILexicalBlockFile(scope: !1680, file: !1, discriminator: 1)
!1747 = !DILocation(line: 121, column: 10, scope: !1746)
!1748 = !DILocation(line: 121, column: 22, scope: !1746)
!1749 = !DILocation(line: 121, column: 30, scope: !1746)
!1750 = !DILocation(line: 121, column: 37, scope: !1751)
!1751 = !DILexicalBlockFile(scope: !1680, file: !1, discriminator: 2)
!1752 = !DILocation(line: 121, column: 33, scope: !1751)
!1753 = !DILocation(line: 121, column: 30, scope: !1751)
!1754 = !DILocation(line: 121, column: 3, scope: !1755)
!1755 = !DILexicalBlockFile(scope: !1680, file: !1, discriminator: 3)
!1756 = !DILocation(line: 122, column: 11, scope: !1680)
!1757 = !DILocation(line: 121, column: 3, scope: !1758)
!1758 = !DILexicalBlockFile(scope: !1680, file: !1, discriminator: 4)
!1759 = !DILocation(line: 125, column: 10, scope: !1760)
!1760 = distinct !DILexicalBlock(scope: !1680, file: !1, line: 125, column: 6)
!1761 = !DILocation(line: 125, column: 6, scope: !1760)
!1762 = !DILocation(line: 125, column: 18, scope: !1760)
!1763 = !DILocation(line: 125, column: 6, scope: !1680)
!1764 = !DILocation(line: 126, column: 12, scope: !1765)
!1765 = distinct !DILexicalBlock(scope: !1760, file: !1, line: 125, column: 26)
!1766 = !DILocation(line: 127, column: 12, scope: !1767)
!1767 = distinct !DILexicalBlock(scope: !1765, file: !1, line: 127, column: 8)
!1768 = !DILocation(line: 127, column: 19, scope: !1767)
!1769 = !DILocation(line: 127, column: 8, scope: !1767)
!1770 = !DILocation(line: 127, column: 24, scope: !1767)
!1771 = !DILocation(line: 127, column: 8, scope: !1765)
!1772 = !DILocation(line: 128, column: 14, scope: !1767)
!1773 = !DILocation(line: 128, column: 7, scope: !1767)
!1774 = !DILocation(line: 129, column: 3, scope: !1765)
!1775 = !DILocation(line: 132, column: 6, scope: !1776)
!1776 = distinct !DILexicalBlock(scope: !1680, file: !1, line: 132, column: 6)
!1777 = !DILocation(line: 132, column: 15, scope: !1776)
!1778 = !DILocation(line: 132, column: 13, scope: !1776)
!1779 = !DILocation(line: 132, column: 26, scope: !1776)
!1780 = !DILocation(line: 132, column: 23, scope: !1776)
!1781 = !DILocation(line: 132, column: 6, scope: !1680)
!1782 = !DILocation(line: 133, column: 5, scope: !1776)
!1783 = !DILocation(line: 136, column: 17, scope: !1680)
!1784 = !DILocation(line: 136, column: 24, scope: !1680)
!1785 = !DILocation(line: 136, column: 15, scope: !1680)
!1786 = !DILocation(line: 139, column: 13, scope: !1680)
!1787 = !DILocation(line: 139, column: 25, scope: !1680)
!1788 = !DILocation(line: 139, column: 32, scope: !1680)
!1789 = !DILocation(line: 139, column: 30, scope: !1680)
!1790 = !DILocation(line: 139, column: 10, scope: !1680)
!1791 = !DILocation(line: 142, column: 12, scope: !1680)
!1792 = !DILocation(line: 142, column: 10, scope: !1680)
!1793 = !DILocation(line: 143, column: 7, scope: !1794)
!1794 = distinct !DILexicalBlock(scope: !1680, file: !1, line: 143, column: 6)
!1795 = !DILocation(line: 143, column: 6, scope: !1680)
!1796 = !DILocation(line: 144, column: 5, scope: !1794)
!1797 = !DILocation(line: 146, column: 9, scope: !1680)
!1798 = !DILocation(line: 146, column: 7, scope: !1680)
!1799 = !DILocation(line: 149, column: 9, scope: !1800)
!1800 = distinct !DILexicalBlock(scope: !1680, file: !1, line: 149, column: 3)
!1801 = !DILocation(line: 149, column: 7, scope: !1800)
!1802 = !DILocation(line: 149, column: 14, scope: !1803)
!1803 = !DILexicalBlockFile(scope: !1804, file: !1, discriminator: 1)
!1804 = distinct !DILexicalBlock(scope: !1800, file: !1, line: 149, column: 3)
!1805 = !DILocation(line: 149, column: 18, scope: !1803)
!1806 = !DILocation(line: 149, column: 16, scope: !1803)
!1807 = !DILocation(line: 149, column: 3, scope: !1803)
!1808 = !DILocalVariable(name: "result", scope: !1809, file: !1, line: 150, type: !347)
!1809 = distinct !DILexicalBlock(scope: !1804, file: !1, line: 149, column: 36)
!1810 = !DILocation(line: 150, column: 12, scope: !1809)
!1811 = !DILocation(line: 150, column: 35, scope: !1809)
!1812 = !DILocation(line: 150, column: 40, scope: !1809)
!1813 = !DILocation(line: 150, column: 21, scope: !1809)
!1814 = !DILocation(line: 151, column: 9, scope: !1815)
!1815 = distinct !DILexicalBlock(scope: !1809, file: !1, line: 151, column: 8)
!1816 = !DILocation(line: 151, column: 8, scope: !1809)
!1817 = !DILocation(line: 152, column: 7, scope: !1818)
!1818 = distinct !DILexicalBlock(scope: !1815, file: !1, line: 151, column: 17)
!1819 = !DILocation(line: 154, column: 7, scope: !1818)
!1820 = !DILocation(line: 157, column: 12, scope: !1809)
!1821 = !DILocation(line: 157, column: 9, scope: !1809)
!1822 = !DILocation(line: 158, column: 9, scope: !1809)
!1823 = !DILocation(line: 159, column: 3, scope: !1809)
!1824 = !DILocation(line: 149, column: 32, scope: !1825)
!1825 = !DILexicalBlockFile(scope: !1804, file: !1, discriminator: 2)
!1826 = !DILocation(line: 149, column: 3, scope: !1825)
!1827 = !DILocation(line: 162, column: 4, scope: !1680)
!1828 = !DILocation(line: 162, column: 8, scope: !1680)
!1829 = !DILocation(line: 165, column: 13, scope: !1680)
!1830 = !DILocation(line: 165, column: 4, scope: !1680)
!1831 = !DILocation(line: 165, column: 11, scope: !1680)
!1832 = !DILocation(line: 166, column: 13, scope: !1680)
!1833 = !DILocation(line: 166, column: 4, scope: !1680)
!1834 = !DILocation(line: 166, column: 11, scope: !1680)
!1835 = !DILocation(line: 168, column: 3, scope: !1680)
!1836 = !DILocation(line: 169, column: 1, scope: !1680)
!1837 = !DILocalVariable(name: "dest", arg: 1, scope: !1691, file: !1, line: 45, type: !1684)
!1838 = !DILocation(line: 45, column: 44, scope: !1691)
!1839 = !DILocalVariable(name: "src", arg: 2, scope: !1691, file: !1, line: 45, type: !851)
!1840 = !DILocation(line: 45, column: 62, scope: !1691)
!1841 = !DILocalVariable(name: "padding", scope: !1691, file: !1, line: 47, type: !347)
!1842 = !DILocation(line: 47, column: 10, scope: !1691)
!1843 = !DILocalVariable(name: "s", scope: !1691, file: !1, line: 48, type: !851)
!1844 = !DILocation(line: 48, column: 15, scope: !1691)
!1845 = !DILocalVariable(name: "p", scope: !1691, file: !1, line: 48, type: !851)
!1846 = !DILocation(line: 48, column: 19, scope: !1691)
!1847 = !DILocalVariable(name: "i", scope: !1691, file: !1, line: 49, type: !349)
!1848 = !DILocation(line: 49, column: 17, scope: !1691)
!1849 = !DILocalVariable(name: "x", scope: !1691, file: !1, line: 49, type: !349)
!1850 = !DILocation(line: 49, column: 20, scope: !1691)
!1851 = !DILocation(line: 51, column: 9, scope: !1852)
!1852 = distinct !DILexicalBlock(scope: !1691, file: !1, line: 51, column: 3)
!1853 = !DILocation(line: 51, column: 18, scope: !1852)
!1854 = !DILocation(line: 51, column: 16, scope: !1852)
!1855 = !DILocation(line: 51, column: 7, scope: !1852)
!1856 = !DILocation(line: 51, column: 23, scope: !1857)
!1857 = !DILexicalBlockFile(scope: !1858, file: !1, discriminator: 1)
!1858 = distinct !DILexicalBlock(scope: !1852, file: !1, line: 51, column: 3)
!1859 = !DILocation(line: 51, column: 25, scope: !1857)
!1860 = !DILocation(line: 51, column: 3, scope: !1857)
!1861 = !DILocalVariable(name: "v", scope: !1862, file: !1, line: 52, type: !349)
!1862 = distinct !DILexicalBlock(scope: !1858, file: !1, line: 51, column: 40)
!1863 = !DILocation(line: 52, column: 19, scope: !1862)
!1864 = !DILocation(line: 54, column: 9, scope: !1865)
!1865 = distinct !DILexicalBlock(scope: !1862, file: !1, line: 54, column: 8)
!1866 = !DILocation(line: 54, column: 8, scope: !1865)
!1867 = !DILocation(line: 54, column: 11, scope: !1865)
!1868 = !DILocation(line: 54, column: 8, scope: !1862)
!1869 = !DILocation(line: 55, column: 12, scope: !1870)
!1870 = distinct !DILexicalBlock(scope: !1865, file: !1, line: 54, column: 19)
!1871 = !DILocation(line: 55, column: 14, scope: !1870)
!1872 = !DILocation(line: 55, column: 9, scope: !1870)
!1873 = !DILocation(line: 56, column: 14, scope: !1870)
!1874 = !DILocation(line: 57, column: 5, scope: !1870)
!1875 = !DILocation(line: 59, column: 9, scope: !1876)
!1876 = distinct !DILexicalBlock(scope: !1865, file: !1, line: 58, column: 10)
!1877 = !DILocation(line: 61, column: 7, scope: !1876)
!1878 = !DILocation(line: 61, column: 14, scope: !1879)
!1879 = !DILexicalBlockFile(scope: !1876, file: !1, discriminator: 1)
!1880 = !DILocation(line: 61, column: 13, scope: !1879)
!1881 = !DILocation(line: 61, column: 16, scope: !1879)
!1882 = !DILocation(line: 61, column: 21, scope: !1883)
!1883 = !DILexicalBlockFile(scope: !1876, file: !1, discriminator: 2)
!1884 = !DILocation(line: 61, column: 20, scope: !1883)
!1885 = !DILocation(line: 61, column: 27, scope: !1883)
!1886 = !DILocation(line: 61, column: 26, scope: !1883)
!1887 = !DILocation(line: 61, column: 23, scope: !1883)
!1888 = !DILocation(line: 61, column: 7, scope: !1889)
!1889 = !DILexicalBlockFile(scope: !1876, file: !1, discriminator: 3)
!1890 = !DILocation(line: 62, column: 10, scope: !1891)
!1891 = distinct !DILexicalBlock(scope: !1876, file: !1, line: 61, column: 31)
!1892 = !DILocation(line: 63, column: 10, scope: !1891)
!1893 = !DILocation(line: 61, column: 7, scope: !1894)
!1894 = !DILexicalBlockFile(scope: !1876, file: !1, discriminator: 4)
!1895 = !DILocation(line: 66, column: 11, scope: !1896)
!1896 = distinct !DILexicalBlock(scope: !1876, file: !1, line: 66, column: 10)
!1897 = !DILocation(line: 66, column: 10, scope: !1896)
!1898 = !DILocation(line: 66, column: 17, scope: !1896)
!1899 = !DILocation(line: 66, column: 16, scope: !1896)
!1900 = !DILocation(line: 66, column: 13, scope: !1896)
!1901 = !DILocation(line: 66, column: 10, scope: !1876)
!1902 = !DILocation(line: 67, column: 14, scope: !1896)
!1903 = !DILocation(line: 67, column: 16, scope: !1896)
!1904 = !DILocation(line: 67, column: 24, scope: !1896)
!1905 = !DILocation(line: 67, column: 22, scope: !1896)
!1906 = !DILocation(line: 67, column: 11, scope: !1896)
!1907 = !DILocation(line: 67, column: 9, scope: !1896)
!1908 = !DILocation(line: 69, column: 9, scope: !1896)
!1909 = !DILocation(line: 71, column: 3, scope: !1862)
!1910 = !DILocation(line: 51, column: 31, scope: !1911)
!1911 = !DILexicalBlockFile(scope: !1858, file: !1, discriminator: 2)
!1912 = !DILocation(line: 51, column: 36, scope: !1911)
!1913 = !DILocation(line: 51, column: 3, scope: !1911)
!1914 = !DILocation(line: 73, column: 6, scope: !1915)
!1915 = distinct !DILexicalBlock(scope: !1691, file: !1, line: 73, column: 6)
!1916 = !DILocation(line: 73, column: 14, scope: !1915)
!1917 = !DILocation(line: 73, column: 6, scope: !1691)
!1918 = !DILocation(line: 74, column: 28, scope: !1915)
!1919 = !DILocation(line: 74, column: 30, scope: !1915)
!1920 = !DILocation(line: 74, column: 15, scope: !1915)
!1921 = !DILocation(line: 74, column: 5, scope: !1915)
!1922 = !DILocation(line: 74, column: 13, scope: !1915)
!1923 = !DILocation(line: 76, column: 5, scope: !1691)
!1924 = !DILocation(line: 77, column: 6, scope: !1925)
!1925 = distinct !DILexicalBlock(scope: !1691, file: !1, line: 77, column: 6)
!1926 = !DILocation(line: 77, column: 14, scope: !1925)
!1927 = !DILocation(line: 77, column: 6, scope: !1691)
!1928 = !DILocation(line: 78, column: 28, scope: !1925)
!1929 = !DILocation(line: 78, column: 30, scope: !1925)
!1930 = !DILocation(line: 78, column: 15, scope: !1925)
!1931 = !DILocation(line: 78, column: 5, scope: !1925)
!1932 = !DILocation(line: 78, column: 13, scope: !1925)
!1933 = !DILocation(line: 80, column: 5, scope: !1691)
!1934 = !DILocation(line: 81, column: 26, scope: !1691)
!1935 = !DILocation(line: 81, column: 28, scope: !1691)
!1936 = !DILocation(line: 81, column: 13, scope: !1691)
!1937 = !DILocation(line: 81, column: 3, scope: !1691)
!1938 = !DILocation(line: 81, column: 11, scope: !1691)
!1939 = !DILocation(line: 83, column: 14, scope: !1691)
!1940 = !DILocation(line: 83, column: 12, scope: !1691)
!1941 = !DILocation(line: 83, column: 3, scope: !1691)
!1942 = !DILocation(line: 84, column: 1, scope: !1691)
!1943 = !DILocalVariable(name: "data", arg: 1, scope: !1687, file: !1, line: 291, type: !256)
!1944 = !DILocation(line: 291, column: 47, scope: !1687)
!1945 = !DILocalVariable(name: "inputbuff", arg: 2, scope: !1687, file: !1, line: 292, type: !851)
!1946 = !DILocation(line: 292, column: 41, scope: !1687)
!1947 = !DILocalVariable(name: "insize", arg: 3, scope: !1687, file: !1, line: 292, type: !347)
!1948 = !DILocation(line: 292, column: 59, scope: !1687)
!1949 = !DILocalVariable(name: "outptr", arg: 4, scope: !1687, file: !1, line: 293, type: !1524)
!1950 = !DILocation(line: 293, column: 36, scope: !1687)
!1951 = !DILocalVariable(name: "outlen", arg: 5, scope: !1687, file: !1, line: 293, type: !1685)
!1952 = !DILocation(line: 293, column: 52, scope: !1687)
!1953 = !DILocation(line: 295, column: 32, scope: !1687)
!1954 = !DILocation(line: 295, column: 38, scope: !1687)
!1955 = !DILocation(line: 295, column: 49, scope: !1687)
!1956 = !DILocation(line: 295, column: 57, scope: !1687)
!1957 = !DILocation(line: 295, column: 65, scope: !1687)
!1958 = !DILocation(line: 295, column: 10, scope: !1687)
!1959 = !DILocation(line: 295, column: 3, scope: !1687)
!1960 = !DILocalVariable(name: "table64", arg: 1, scope: !1694, file: !1, line: 171, type: !851)
!1961 = !DILocation(line: 171, column: 43, scope: !1694)
!1962 = !DILocalVariable(name: "data", arg: 2, scope: !1694, file: !1, line: 172, type: !256)
!1963 = !DILocation(line: 172, column: 49, scope: !1694)
!1964 = !DILocalVariable(name: "inputbuff", arg: 3, scope: !1694, file: !1, line: 173, type: !851)
!1965 = !DILocation(line: 173, column: 43, scope: !1694)
!1966 = !DILocalVariable(name: "insize", arg: 4, scope: !1694, file: !1, line: 173, type: !347)
!1967 = !DILocation(line: 173, column: 61, scope: !1694)
!1968 = !DILocalVariable(name: "outptr", arg: 5, scope: !1694, file: !1, line: 174, type: !1524)
!1969 = !DILocation(line: 174, column: 38, scope: !1694)
!1970 = !DILocalVariable(name: "outlen", arg: 6, scope: !1694, file: !1, line: 174, type: !1685)
!1971 = !DILocation(line: 174, column: 54, scope: !1694)
!1972 = !DILocalVariable(name: "result", scope: !1694, file: !1, line: 176, type: !289)
!1973 = !DILocation(line: 176, column: 12, scope: !1694)
!1974 = !DILocalVariable(name: "ibuf", scope: !1694, file: !1, line: 177, type: !1975)
!1975 = !DICompositeType(tag: DW_TAG_array_type, baseType: !1648, size: 24, align: 8, elements: !1118)
!1976 = !DILocation(line: 177, column: 17, scope: !1694)
!1977 = !DILocalVariable(name: "obuf", scope: !1694, file: !1, line: 178, type: !1978)
!1978 = !DICompositeType(tag: DW_TAG_array_type, baseType: !1648, size: 32, align: 8, elements: !1979)
!1979 = !{!1980}
!1980 = !DISubrange(count: 4)
!1981 = !DILocation(line: 178, column: 17, scope: !1694)
!1982 = !DILocalVariable(name: "i", scope: !1694, file: !1, line: 179, type: !316)
!1983 = !DILocation(line: 179, column: 7, scope: !1694)
!1984 = !DILocalVariable(name: "inputparts", scope: !1694, file: !1, line: 180, type: !316)
!1985 = !DILocation(line: 180, column: 7, scope: !1694)
!1986 = !DILocalVariable(name: "output", scope: !1694, file: !1, line: 181, type: !479)
!1987 = !DILocation(line: 181, column: 9, scope: !1694)
!1988 = !DILocalVariable(name: "base64data", scope: !1694, file: !1, line: 182, type: !479)
!1989 = !DILocation(line: 182, column: 9, scope: !1694)
!1990 = !DILocalVariable(name: "convbuf", scope: !1694, file: !1, line: 183, type: !479)
!1991 = !DILocation(line: 183, column: 9, scope: !1694)
!1992 = !DILocalVariable(name: "indata", scope: !1694, file: !1, line: 185, type: !851)
!1993 = !DILocation(line: 185, column: 15, scope: !1694)
!1994 = !DILocation(line: 185, column: 24, scope: !1694)
!1995 = !DILocation(line: 187, column: 4, scope: !1694)
!1996 = !DILocation(line: 187, column: 11, scope: !1694)
!1997 = !DILocation(line: 188, column: 4, scope: !1694)
!1998 = !DILocation(line: 188, column: 11, scope: !1694)
!1999 = !DILocation(line: 190, column: 7, scope: !2000)
!2000 = distinct !DILexicalBlock(scope: !1694, file: !1, line: 190, column: 6)
!2001 = !DILocation(line: 190, column: 6, scope: !1694)
!2002 = !DILocation(line: 191, column: 21, scope: !2000)
!2003 = !DILocation(line: 191, column: 14, scope: !2000)
!2004 = !DILocation(line: 191, column: 12, scope: !2000)
!2005 = !DILocation(line: 191, column: 5, scope: !2000)
!2006 = !DILocation(line: 198, column: 25, scope: !1694)
!2007 = !DILocation(line: 198, column: 23, scope: !1694)
!2008 = !DILocation(line: 198, column: 14, scope: !1694)
!2009 = !DILocation(line: 199, column: 7, scope: !2010)
!2010 = distinct !DILexicalBlock(scope: !1694, file: !1, line: 199, column: 6)
!2011 = !DILocation(line: 199, column: 6, scope: !1694)
!2012 = !DILocation(line: 200, column: 5, scope: !2010)
!2013 = !DILocation(line: 207, column: 12, scope: !1694)
!2014 = !DILocation(line: 207, column: 10, scope: !1694)
!2015 = !DILocation(line: 208, column: 6, scope: !2016)
!2016 = distinct !DILexicalBlock(scope: !1694, file: !1, line: 208, column: 6)
!2017 = !DILocation(line: 208, column: 6, scope: !1694)
!2018 = !DILocation(line: 209, column: 5, scope: !2019)
!2019 = distinct !DILexicalBlock(scope: !2016, file: !1, line: 208, column: 14)
!2020 = !DILocation(line: 210, column: 12, scope: !2019)
!2021 = !DILocation(line: 210, column: 5, scope: !2019)
!2022 = !DILocation(line: 213, column: 6, scope: !2023)
!2023 = distinct !DILexicalBlock(scope: !1694, file: !1, line: 213, column: 6)
!2024 = !DILocation(line: 213, column: 6, scope: !1694)
!2025 = !DILocation(line: 214, column: 22, scope: !2023)
!2026 = !DILocation(line: 214, column: 12, scope: !2023)
!2027 = !DILocation(line: 214, column: 5, scope: !2023)
!2028 = !DILocation(line: 216, column: 3, scope: !1694)
!2029 = !DILocation(line: 216, column: 9, scope: !2030)
!2030 = !DILexicalBlockFile(scope: !1694, file: !1, discriminator: 1)
!2031 = !DILocation(line: 216, column: 16, scope: !2030)
!2032 = !DILocation(line: 216, column: 3, scope: !2030)
!2033 = !DILocation(line: 217, column: 24, scope: !2034)
!2034 = distinct !DILexicalBlock(scope: !2035, file: !1, line: 217, column: 5)
!2035 = distinct !DILexicalBlock(scope: !1694, file: !1, line: 216, column: 21)
!2036 = !DILocation(line: 217, column: 11, scope: !2034)
!2037 = !DILocation(line: 217, column: 9, scope: !2034)
!2038 = !DILocation(line: 217, column: 29, scope: !2039)
!2039 = !DILexicalBlockFile(scope: !2040, file: !1, discriminator: 1)
!2040 = distinct !DILexicalBlock(scope: !2034, file: !1, line: 217, column: 5)
!2041 = !DILocation(line: 217, column: 31, scope: !2039)
!2042 = !DILocation(line: 217, column: 5, scope: !2039)
!2043 = !DILocation(line: 218, column: 10, scope: !2044)
!2044 = distinct !DILexicalBlock(scope: !2045, file: !1, line: 218, column: 10)
!2045 = distinct !DILexicalBlock(scope: !2040, file: !1, line: 217, column: 41)
!2046 = !DILocation(line: 218, column: 17, scope: !2044)
!2047 = !DILocation(line: 218, column: 10, scope: !2045)
!2048 = !DILocation(line: 219, column: 19, scope: !2049)
!2049 = distinct !DILexicalBlock(scope: !2044, file: !1, line: 218, column: 22)
!2050 = !DILocation(line: 220, column: 36, scope: !2049)
!2051 = !DILocation(line: 220, column: 35, scope: !2049)
!2052 = !DILocation(line: 220, column: 14, scope: !2049)
!2053 = !DILocation(line: 220, column: 9, scope: !2049)
!2054 = !DILocation(line: 220, column: 17, scope: !2049)
!2055 = !DILocation(line: 221, column: 15, scope: !2049)
!2056 = !DILocation(line: 222, column: 15, scope: !2049)
!2057 = !DILocation(line: 223, column: 7, scope: !2049)
!2058 = !DILocation(line: 225, column: 14, scope: !2044)
!2059 = !DILocation(line: 225, column: 9, scope: !2044)
!2060 = !DILocation(line: 225, column: 17, scope: !2044)
!2061 = !DILocation(line: 226, column: 5, scope: !2045)
!2062 = !DILocation(line: 217, column: 37, scope: !2063)
!2063 = !DILexicalBlockFile(scope: !2040, file: !1, discriminator: 2)
!2064 = !DILocation(line: 217, column: 5, scope: !2063)
!2065 = !DILocation(line: 228, column: 34, scope: !2035)
!2066 = !DILocation(line: 228, column: 42, scope: !2035)
!2067 = !DILocation(line: 228, column: 50, scope: !2035)
!2068 = !DILocation(line: 228, column: 15, scope: !2035)
!2069 = !DILocation(line: 228, column: 5, scope: !2035)
!2070 = !DILocation(line: 228, column: 13, scope: !2035)
!2071 = !DILocation(line: 229, column: 34, scope: !2035)
!2072 = !DILocation(line: 229, column: 42, scope: !2035)
!2073 = !DILocation(line: 229, column: 50, scope: !2035)
!2074 = !DILocation(line: 230, column: 34, scope: !2035)
!2075 = !DILocation(line: 230, column: 42, scope: !2035)
!2076 = !DILocation(line: 230, column: 50, scope: !2035)
!2077 = !DILocation(line: 229, column: 56, scope: !2035)
!2078 = !DILocation(line: 229, column: 15, scope: !2035)
!2079 = !DILocation(line: 229, column: 5, scope: !2035)
!2080 = !DILocation(line: 229, column: 13, scope: !2035)
!2081 = !DILocation(line: 231, column: 34, scope: !2035)
!2082 = !DILocation(line: 231, column: 42, scope: !2035)
!2083 = !DILocation(line: 231, column: 50, scope: !2035)
!2084 = !DILocation(line: 232, column: 34, scope: !2035)
!2085 = !DILocation(line: 232, column: 42, scope: !2035)
!2086 = !DILocation(line: 232, column: 50, scope: !2035)
!2087 = !DILocation(line: 231, column: 56, scope: !2035)
!2088 = !DILocation(line: 231, column: 15, scope: !2035)
!2089 = !DILocation(line: 231, column: 5, scope: !2035)
!2090 = !DILocation(line: 231, column: 13, scope: !2035)
!2091 = !DILocation(line: 233, column: 34, scope: !2035)
!2092 = !DILocation(line: 233, column: 42, scope: !2035)
!2093 = !DILocation(line: 233, column: 15, scope: !2035)
!2094 = !DILocation(line: 233, column: 5, scope: !2035)
!2095 = !DILocation(line: 233, column: 13, scope: !2035)
!2096 = !DILocation(line: 235, column: 12, scope: !2035)
!2097 = !DILocation(line: 235, column: 5, scope: !2035)
!2098 = !DILocation(line: 237, column: 16, scope: !2099)
!2099 = distinct !DILexicalBlock(scope: !2035, file: !1, line: 235, column: 24)
!2100 = !DILocation(line: 238, column: 24, scope: !2099)
!2101 = !DILocation(line: 238, column: 16, scope: !2099)
!2102 = !DILocation(line: 239, column: 24, scope: !2099)
!2103 = !DILocation(line: 239, column: 16, scope: !2099)
!2104 = !DILocation(line: 237, column: 7, scope: !2099)
!2105 = !DILocation(line: 240, column: 7, scope: !2099)
!2106 = !DILocation(line: 243, column: 16, scope: !2099)
!2107 = !DILocation(line: 244, column: 24, scope: !2099)
!2108 = !DILocation(line: 244, column: 16, scope: !2099)
!2109 = !DILocation(line: 245, column: 24, scope: !2099)
!2110 = !DILocation(line: 245, column: 16, scope: !2099)
!2111 = !DILocation(line: 246, column: 24, scope: !2099)
!2112 = !DILocation(line: 246, column: 16, scope: !2099)
!2113 = !DILocation(line: 243, column: 7, scope: !2099)
!2114 = !DILocation(line: 247, column: 7, scope: !2099)
!2115 = !DILocation(line: 250, column: 16, scope: !2099)
!2116 = !DILocation(line: 251, column: 24, scope: !2099)
!2117 = !DILocation(line: 251, column: 16, scope: !2099)
!2118 = !DILocation(line: 252, column: 24, scope: !2099)
!2119 = !DILocation(line: 252, column: 16, scope: !2099)
!2120 = !DILocation(line: 253, column: 24, scope: !2099)
!2121 = !DILocation(line: 253, column: 16, scope: !2099)
!2122 = !DILocation(line: 254, column: 24, scope: !2099)
!2123 = !DILocation(line: 254, column: 16, scope: !2099)
!2124 = !DILocation(line: 250, column: 7, scope: !2099)
!2125 = !DILocation(line: 255, column: 7, scope: !2099)
!2126 = !DILocation(line: 257, column: 12, scope: !2035)
!2127 = !DILocation(line: 216, column: 3, scope: !2128)
!2128 = !DILexicalBlockFile(scope: !1694, file: !1, discriminator: 2)
!2129 = !DILocation(line: 261, column: 4, scope: !1694)
!2130 = !DILocation(line: 261, column: 11, scope: !1694)
!2131 = !DILocation(line: 264, column: 13, scope: !1694)
!2132 = !DILocation(line: 264, column: 4, scope: !1694)
!2133 = !DILocation(line: 264, column: 11, scope: !1694)
!2134 = !DILocation(line: 266, column: 3, scope: !1694)
!2135 = !DILocation(line: 269, column: 20, scope: !1694)
!2136 = !DILocation(line: 269, column: 13, scope: !1694)
!2137 = !DILocation(line: 269, column: 4, scope: !1694)
!2138 = !DILocation(line: 269, column: 11, scope: !1694)
!2139 = !DILocation(line: 271, column: 3, scope: !1694)
!2140 = !DILocation(line: 272, column: 1, scope: !1694)
!2141 = !DILocalVariable(name: "data", arg: 1, scope: !1690, file: !1, line: 315, type: !256)
!2142 = !DILocation(line: 315, column: 50, scope: !1690)
!2143 = !DILocalVariable(name: "inputbuff", arg: 2, scope: !1690, file: !1, line: 316, type: !851)
!2144 = !DILocation(line: 316, column: 44, scope: !1690)
!2145 = !DILocalVariable(name: "insize", arg: 3, scope: !1690, file: !1, line: 316, type: !347)
!2146 = !DILocation(line: 316, column: 62, scope: !1690)
!2147 = !DILocalVariable(name: "outptr", arg: 4, scope: !1690, file: !1, line: 317, type: !1524)
!2148 = !DILocation(line: 317, column: 39, scope: !1690)
!2149 = !DILocalVariable(name: "outlen", arg: 5, scope: !1690, file: !1, line: 317, type: !1685)
!2150 = !DILocation(line: 317, column: 55, scope: !1690)
!2151 = !DILocation(line: 319, column: 35, scope: !1690)
!2152 = !DILocation(line: 319, column: 41, scope: !1690)
!2153 = !DILocation(line: 319, column: 52, scope: !1690)
!2154 = !DILocation(line: 319, column: 60, scope: !1690)
!2155 = !DILocation(line: 319, column: 68, scope: !1690)
!2156 = !DILocation(line: 319, column: 10, scope: !1690)
!2157 = !DILocation(line: 319, column: 3, scope: !1690)
