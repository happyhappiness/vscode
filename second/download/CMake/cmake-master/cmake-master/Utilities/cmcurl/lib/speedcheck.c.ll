; ModuleID = '/data/download/cmake/cmake-master/Utilities/cmcurl/lib/speedcheck.c'
...
define void @Curl_speedinit(%struct.Curl_easy* %data) #0 !dbg !1679 {
entry:
  %data.addr = alloca %struct.Curl_easy*, align 8
  store %struct.Curl_easy* %data, %struct.Curl_easy** %data.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.Curl_easy** %data.addr, metadata !1689, metadata !1690), !dbg !1691
  %0 = load %struct.Curl_easy*, %struct.Curl_easy** %data.addr, align 8, !dbg !1692
  %state = getelementptr inbounds %struct.Curl_easy, %struct.Curl_easy* %0, i32 0, i32 17, !dbg !1693
  %keeps_speed = getelementptr inbounds %struct.UrlState, %struct.UrlState* %state, i32 0, i32 2, !dbg !1694
  %1 = bitcast %struct.timeval* %keeps_speed to i8*, !dbg !1695
  call void @llvm.memset.p0i8.i64(i8* %1, i8 0, i64 16, i32 8, i1 false), !dbg !1695
  ret void, !dbg !1696
}
...
; Function Attrs: nounwind uwtable
define i32 @Curl_speedcheck(%struct.Curl_easy* %data, i64 %now.coerce0, i64 %now.coerce1) #0 !dbg !1683 {
entry:
  ...
  store %struct.Curl_easy* %data, %struct.Curl_easy** %data.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.Curl_easy** %data.addr, metadata !1697, metadata !1690), !dbg !1698
  call void @llvm.dbg.declare(metadata %struct.timeval* %now, metadata !1699, metadata !1690), !dbg !1700
  %3 = load %struct.Curl_easy*, %struct.Curl_easy** %data.addr, align 8, !dbg !1701
  %progress = getelementptr inbounds %struct.Curl_easy, %struct.Curl_easy* %3, i32 0, i32 16, !dbg !1703
  %current_speed = getelementptr inbounds %struct.Progress, %struct.Progress* %progress, i32 0, i32 5, !dbg !1704
  %4 = load i64, i64* %current_speed, align 8, !dbg !1704
  %cmp = icmp sge i64 %4, 0, !dbg !1705
  br i1 %cmp, label %land.lhs.true, label %if.end26, !dbg !1706

land.lhs.true:                                    ; preds = %entry
  %5 = load %struct.Curl_easy*, %struct.Curl_easy** %data.addr, align 8, !dbg !1707
  %set = getelementptr inbounds %struct.Curl_easy, %struct.Curl_easy* %5, i32 0, i32 13, !dbg !1709
  %low_speed_time = getelementptr inbounds %struct.UserDefined, %struct.UserDefined* %set, i32 0, i32 50, !dbg !1710
  %6 = load i64, i64* %low_speed_time, align 8, !dbg !1710
  %tobool = icmp ne i64 %6, 0, !dbg !1707
  br i1 %tobool, label %if.then, label %if.end26, !dbg !1711

if.then:                                          ; preds = %land.lhs.true
  %7 = load %struct.Curl_easy*, %struct.Curl_easy** %data.addr, align 8, !dbg !1712
  %progress1 = getelementptr inbounds %struct.Curl_easy, %struct.Curl_easy* %7, i32 0, i32 16, !dbg !1715
  %current_speed2 = getelementptr inbounds %struct.Progress, %struct.Progress* %progress1, i32 0, i32 5, !dbg !1716
  %8 = load i64, i64* %current_speed2, align 8, !dbg !1716
  %9 = load %struct.Curl_easy*, %struct.Curl_easy** %data.addr, align 8, !dbg !1717
  %set3 = getelementptr inbounds %struct.Curl_easy, %struct.Curl_easy* %9, i32 0, i32 13, !dbg !1718
  %low_speed_limit = getelementptr inbounds %struct.UserDefined, %struct.UserDefined* %set3, i32 0, i32 49, !dbg !1719
  %10 = load i64, i64* %low_speed_limit, align 8, !dbg !1719
  %cmp4 = icmp slt i64 %8, %10, !dbg !1720
  br i1 %cmp4, label %if.then5, label %if.else21, !dbg !1721

if.then5:                                         ; preds = %if.then
  %11 = load %struct.Curl_easy*, %struct.Curl_easy** %data.addr, align 8, !dbg !1722
  %state = getelementptr inbounds %struct.Curl_easy, %struct.Curl_easy* %11, i32 0, i32 17, !dbg !1725
  %keeps_speed = getelementptr inbounds %struct.UrlState, %struct.UrlState* %state, i32 0, i32 2, !dbg !1726
  %tv_sec = getelementptr inbounds %struct.timeval, %struct.timeval* %keeps_speed, i32 0, i32 0, !dbg !1727
  %12 = load i64, i64* %tv_sec, align 8, !dbg !1727
  %tobool6 = icmp ne i64 %12, 0, !dbg !1722
  br i1 %tobool6, label %if.else, label %if.then7, !dbg !1728

if.then7:                                         ; preds = %if.then5
  %13 = load %struct.Curl_easy*, %struct.Curl_easy** %data.addr, align 8, !dbg !1729
  %state8 = getelementptr inbounds %struct.Curl_easy, %struct.Curl_easy* %13, i32 0, i32 17, !dbg !1730
  %keeps_speed9 = getelementptr inbounds %struct.UrlState, %struct.UrlState* %state8, i32 0, i32 2, !dbg !1731
  %14 = bitcast %struct.timeval* %keeps_speed9 to i8*, !dbg !1732
  %15 = bitcast %struct.timeval* %now to i8*, !dbg !1732
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %14, i8* %15, i64 16, i32 8, i1 false), !dbg !1732
  br label %if.end20, !dbg !1729

if.else:                                          ; preds = %if.then5
  call void @llvm.dbg.declare(metadata i64* %howlong, metadata !1733, metadata !1690), !dbg !1735
  %16 = load %struct.Curl_easy*, %struct.Curl_easy** %data.addr, align 8, !dbg !1736
  %state10 = getelementptr inbounds %struct.Curl_easy, %struct.Curl_easy* %16, i32 0, i32 17, !dbg !1736
  %keeps_speed11 = getelementptr inbounds %struct.UrlState, %struct.UrlState* %state10, i32 0, i32 2, !dbg !1736
  %17 = bitcast %struct.timeval* %now to { i64, i64 }*, !dbg !1736
  %18 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %17, i32 0, i32 0, !dbg !1736
  %19 = load i64, i64* %18, align 8, !dbg !1736
  %20 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %17, i32 0, i32 1, !dbg !1736
  %21 = load i64, i64* %20, align 8, !dbg !1736
  %22 = bitcast %struct.timeval* %keeps_speed11 to { i64, i64 }*, !dbg !1736
  %23 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %22, i32 0, i32 0, !dbg !1736
  %24 = load i64, i64* %23, align 8, !dbg !1736
  %25 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %22, i32 0, i32 1, !dbg !1736
  %26 = load i64, i64* %25, align 8, !dbg !1736
  %call = call i64 @curlx_tvdiff(i64 %19, i64 %21, i64 %24, i64 %26), !dbg !1736
  store i64 %call, i64* %howlong, align 8, !dbg !1735
  %27 = load i64, i64* %howlong, align 8, !dbg !1737
  %28 = load %struct.Curl_easy*, %struct.Curl_easy** %data.addr, align 8, !dbg !1739
  %set12 = getelementptr inbounds %struct.Curl_easy, %struct.Curl_easy* %28, i32 0, i32 13, !dbg !1740
  %low_speed_time13 = getelementptr inbounds %struct.UserDefined, %struct.UserDefined* %set12, i32 0, i32 50, !dbg !1741
  %29 = load i64, i64* %low_speed_time13, align 8, !dbg !1741
  %mul = mul nsw i64 %29, 1000, !dbg !1742
  %cmp14 = icmp sge i64 %27, %mul, !dbg !1743
  br i1 %cmp14, label %if.then15, label %if.end, !dbg !1744

if.then15:                                        ; preds = %if.else
  %30 = load %struct.Curl_easy*, %struct.Curl_easy** %data.addr, align 8, !dbg !1745
  %31 = load %struct.Curl_easy*, %struct.Curl_easy** %data.addr, align 8, !dbg !1747
  %set16 = getelementptr inbounds %struct.Curl_easy, %struct.Curl_easy* %31, i32 0, i32 13, !dbg !1748
  %low_speed_limit17 = getelementptr inbounds %struct.UserDefined, %struct.UserDefined* %set16, i32 0, i32 49, !dbg !1749
  %32 = load i64, i64* %low_speed_limit17, align 8, !dbg !1749
  %33 = load %struct.Curl_easy*, %struct.Curl_easy** %data.addr, align 8, !dbg !1750
  %set18 = getelementptr inbounds %struct.Curl_easy, %struct.Curl_easy* %33, i32 0, i32 13, !dbg !1751
  %low_speed_time19 = getelementptr inbounds %struct.UserDefined, %struct.UserDefined* %set18, i32 0, i32 50, !dbg !1752
  %34 = load i64, i64* %low_speed_time19, align 8, !dbg !1752
  call void (%struct.Curl_easy*, i8*, ...) @Curl_failf(%struct.Curl_easy* %30, i8* getelementptr inbounds ([77 x i8], [77 x i8]* @.str, i32 0, i32 0), i64 %32, i64 %34), !dbg !1753
  store i32 28, i32* %retval, align 4, !dbg !1754
...
if.end20:                                         ; preds = %if.end, %if.then7
  br label %if.end25, !dbg !1755

if.else21:                                        ; preds = %if.then
  %35 = load %struct.Curl_easy*, %struct.Curl_easy** %data.addr, align 8, !dbg !1756
  %state22 = getelementptr inbounds %struct.Curl_easy, %struct.Curl_easy* %35, i32 0, i32 17, !dbg !1757
  %keeps_speed23 = getelementptr inbounds %struct.UrlState, %struct.UrlState* %state22, i32 0, i32 2, !dbg !1758
  %tv_sec24 = getelementptr inbounds %struct.timeval, %struct.timeval* %keeps_speed23, i32 0, i32 0, !dbg !1759
  store i64 0, i64* %tv_sec24, align 8, !dbg !1760
  br label %if.end25

if.end25:                                         ; preds = %if.else21, %if.end20
  br label %if.end26, !dbg !1761

if.end26:                                         ; preds = %if.end25, %land.lhs.true, %entry
  %36 = load %struct.Curl_easy*, %struct.Curl_easy** %data.addr, align 8, !dbg !1762
  %set27 = getelementptr inbounds %struct.Curl_easy, %struct.Curl_easy* %36, i32 0, i32 13, !dbg !1764
  %low_speed_limit28 = getelementptr inbounds %struct.UserDefined, %struct.UserDefined* %set27, i32 0, i32 49, !dbg !1765
  %37 = load i64, i64* %low_speed_limit28, align 8, !dbg !1765
  %tobool29 = icmp ne i64 %37, 0, !dbg !1762
  br i1 %tobool29, label %if.then30, label %if.end31, !dbg !1766

if.then30:                                        ; preds = %if.end26
  %38 = load %struct.Curl_easy*, %struct.Curl_easy** %data.addr, align 8, !dbg !1767
  call void @Curl_expire_latest(%struct.Curl_easy* %38, i64 1000), !dbg !1768
  br label %if.end31, !dbg !1768

if.end31:                                         ; preds = %if.then30, %if.end26
  store i32 0, i32* %retval, align 4, !dbg !1769
  br label %return, !dbg !1769

return:                                           ; preds = %if.end31, %if.then15
  %39 = load i32, i32* %retval, align 4, !dbg !1770
  ret i32 %39, !dbg !1770
}
...
declare void @Curl_expire_latest(%struct.Curl_easy*, i64) #3
...
!0 = distinct !DICompileUnit(language: DW_LANG_C99, file: !1, producer: "clang version 3.8.0 (tags/RELEASE_380/final)", isOptimized: false, runtimeVersion: 0, emissionKind: 1, enums: !2, subprograms: !1678)
!1 = !DIFile(filename: "/data/download/cmake/cmake-master/Utilities/cmcurl/lib/speedcheck.c", directory: "/data/download/cmake/cmake-master/Utilities/cmcurl/lib")
!2 = !{!3, !14, !24, !120, !126, !134, !173, !192, !212, !227, !244, !252, !266, !299, !368, !472, !491, !498, !637, !653, !665, !763, !773, !835, !855, !861, !887, !902, !911, !919, !948, !1187, !1239}
...
!1678 = !{!1679, !1683}
!1679 = distinct !DISubprogram(name: "Curl_speedinit", scope: !1, file: !1, line: 31, type: !1680, isLocal: false, isDefinition: true, scopeLine: 32, flags: DIFlagPrototyped, isOptimized: false, variables: !1682)
!1680 = !DISubroutineType(types: !1681)
!1681 = !{null, !256}
!1682 = !{}
!1683 = distinct !DISubprogram(name: "Curl_speedcheck", scope: !1, file: !1, line: 39, type: !1684, isLocal: false, isDefinition: true, scopeLine: 41, flags: DIFlagPrototyped, isOptimized: false, variables: !1682)
!1684 = !DISubroutineType(types: !1685)
!1685 = !{!289, !256, !411}
!1686 = !{i32 2, !"Dwarf Version", i32 4}
!1687 = !{i32 2, !"Debug Info Version", i32 3}
!1688 = !{!"clang version 3.8.0 (tags/RELEASE_380/final)"}
!1689 = !DILocalVariable(name: "data", arg: 1, scope: !1679, file: !1, line: 31, type: !256)
!1690 = !DIExpression()
!1691 = !DILocation(line: 31, column: 39, scope: !1679)
!1692 = !DILocation(line: 33, column: 11, scope: !1679)
!1693 = !DILocation(line: 33, column: 17, scope: !1679)
!1694 = !DILocation(line: 33, column: 23, scope: !1679)
!1695 = !DILocation(line: 33, column: 3, scope: !1679)
!1696 = !DILocation(line: 34, column: 1, scope: !1679)
!1697 = !DILocalVariable(name: "data", arg: 1, scope: !1683, file: !1, line: 39, type: !256)
!1698 = !DILocation(line: 39, column: 44, scope: !1683)
!1699 = !DILocalVariable(name: "now", arg: 2, scope: !1683, file: !1, line: 40, type: !411)
!1700 = !DILocation(line: 40, column: 41, scope: !1683)
!1701 = !DILocation(line: 42, column: 7, scope: !1702)
!1702 = distinct !DILexicalBlock(scope: !1683, file: !1, line: 42, column: 6)
!1703 = !DILocation(line: 42, column: 13, scope: !1702)
!1704 = !DILocation(line: 42, column: 22, scope: !1702)
!1705 = !DILocation(line: 42, column: 36, scope: !1702)
!1706 = !DILocation(line: 42, column: 42, scope: !1702)
!1707 = !DILocation(line: 42, column: 45, scope: !1708)
!1708 = !DILexicalBlockFile(scope: !1702, file: !1, discriminator: 1)
!1709 = !DILocation(line: 42, column: 51, scope: !1708)
!1710 = !DILocation(line: 42, column: 55, scope: !1708)
!1711 = !DILocation(line: 42, column: 6, scope: !1708)
!1712 = !DILocation(line: 43, column: 8, scope: !1713)
!1713 = distinct !DILexicalBlock(scope: !1714, file: !1, line: 43, column: 8)
!1714 = distinct !DILexicalBlock(scope: !1702, file: !1, line: 42, column: 71)
!1715 = !DILocation(line: 43, column: 14, scope: !1713)
!1716 = !DILocation(line: 43, column: 23, scope: !1713)
!1717 = !DILocation(line: 43, column: 39, scope: !1713)
!1718 = !DILocation(line: 43, column: 45, scope: !1713)
!1719 = !DILocation(line: 43, column: 49, scope: !1713)
!1720 = !DILocation(line: 43, column: 37, scope: !1713)
!1721 = !DILocation(line: 43, column: 8, scope: !1714)
!1722 = !DILocation(line: 44, column: 11, scope: !1723)
!1723 = distinct !DILexicalBlock(scope: !1724, file: !1, line: 44, column: 10)
!1724 = distinct !DILexicalBlock(scope: !1713, file: !1, line: 43, column: 66)
!1725 = !DILocation(line: 44, column: 17, scope: !1723)
!1726 = !DILocation(line: 44, column: 23, scope: !1723)
!1727 = !DILocation(line: 44, column: 35, scope: !1723)
!1728 = !DILocation(line: 44, column: 10, scope: !1724)
!1729 = !DILocation(line: 46, column: 9, scope: !1723)
!1730 = !DILocation(line: 46, column: 15, scope: !1723)
!1731 = !DILocation(line: 46, column: 21, scope: !1723)
!1732 = !DILocation(line: 46, column: 35, scope: !1723)
!1733 = !DILocalVariable(name: "howlong", scope: !1734, file: !1, line: 49, type: !506)
!1734 = distinct !DILexicalBlock(scope: !1723, file: !1, line: 47, column: 12)
!1735 = !DILocation(line: 49, column: 16, scope: !1734)
!1736 = !DILocation(line: 49, column: 26, scope: !1734)
!1737 = !DILocation(line: 51, column: 12, scope: !1738)
!1738 = distinct !DILexicalBlock(scope: !1734, file: !1, line: 51, column: 12)
!1739 = !DILocation(line: 51, column: 23, scope: !1738)
!1740 = !DILocation(line: 51, column: 29, scope: !1738)
!1741 = !DILocation(line: 51, column: 33, scope: !1738)
!1742 = !DILocation(line: 51, column: 48, scope: !1738)
!1743 = !DILocation(line: 51, column: 20, scope: !1738)
!1744 = !DILocation(line: 51, column: 12, scope: !1734)
!1745 = !DILocation(line: 53, column: 17, scope: !1746)
!1746 = distinct !DILexicalBlock(scope: !1738, file: !1, line: 51, column: 56)
!1747 = !DILocation(line: 56, column: 17, scope: !1746)
!1748 = !DILocation(line: 56, column: 23, scope: !1746)
!1749 = !DILocation(line: 56, column: 27, scope: !1746)
!1750 = !DILocation(line: 57, column: 17, scope: !1746)
!1751 = !DILocation(line: 57, column: 23, scope: !1746)
!1752 = !DILocation(line: 57, column: 27, scope: !1746)
!1753 = !DILocation(line: 53, column: 11, scope: !1746)
!1754 = !DILocation(line: 58, column: 11, scope: !1746)
!1755 = !DILocation(line: 61, column: 5, scope: !1724)
!1756 = !DILocation(line: 64, column: 7, scope: !1713)
!1757 = !DILocation(line: 64, column: 13, scope: !1713)
!1758 = !DILocation(line: 64, column: 19, scope: !1713)
!1759 = !DILocation(line: 64, column: 31, scope: !1713)
!1760 = !DILocation(line: 64, column: 38, scope: !1713)
!1761 = !DILocation(line: 65, column: 3, scope: !1714)
!1762 = !DILocation(line: 67, column: 6, scope: !1763)
!1763 = distinct !DILexicalBlock(scope: !1683, file: !1, line: 67, column: 6)
!1764 = !DILocation(line: 67, column: 12, scope: !1763)
!1765 = !DILocation(line: 67, column: 16, scope: !1763)
!1766 = !DILocation(line: 67, column: 6, scope: !1683)
!1767 = !DILocation(line: 70, column: 24, scope: !1763)
!1768 = !DILocation(line: 70, column: 5, scope: !1763)
!1769 = !DILocation(line: 72, column: 3, scope: !1683)
!1770 = !DILocation(line: 73, column: 1, scope: !1683)
