; ModuleID = '/data/download/cmake/cmake-master/Utilities/cmcurl/lib/vauth/oauth2.c'
...
@.str.1 = private unnamed_addr constant [33 x i8] c"user=%s\01host=%s\01auth=Bearer %s\01\01\00", align 1
@.str.2 = private unnamed_addr constant [42 x i8] c"user=%s\01host=%s\01port=%ld\01auth=Bearer %s\01\01\00", align 1
@Curl_cfree = external global void (i8*)*, align 8

; Function Attrs: nounwind uwtable
define i32 @Curl_auth_create_oauth_bearer_message(%struct.Curl_easy* %data, i8* %user, i8* %host, i64 %port, i8* %bearer, i8** %outptr, i64* %outlen) #0 !dbg !1680 {
entry:
  ...
  %bearer.addr = alloca i8*, align 8
  %outptr.addr = alloca i8**, align 8
  %outlen.addr = alloca i64*, align 8
  %result = alloca i32, align 4
  %oauth = alloca i8*, align 8
  ...
  call void @llvm.dbg.declare(metadata i8** %user.addr, metadata !1692, metadata !1690), !dbg !1693
  store i8* %host, i8** %host.addr, align 8
  call void @llvm.dbg.declare(metadata i8** %host.addr, metadata !1694, metadata !1690), !dbg !1695
  store i64 %port, i64* %port.addr, align 8
  call void @llvm.dbg.declare(metadata i64* %port.addr, metadata !1696, metadata !1690), !dbg !1697
  store i8* %bearer, i8** %bearer.addr, align 8
  call void @llvm.dbg.declare(metadata i8** %bearer.addr, metadata !1698, metadata !1690), !dbg !1699
  store i8** %outptr, i8*** %outptr.addr, align 8
  call void @llvm.dbg.declare(metadata i8*** %outptr.addr, metadata !1700, metadata !1690), !dbg !1701
  store i64* %outlen, i64** %outlen.addr, align 8
  call void @llvm.dbg.declare(metadata i64** %outlen.addr, metadata !1702, metadata !1690), !dbg !1703
  call void @llvm.dbg.declare(metadata i32* %result, metadata !1704, metadata !1690), !dbg !1705
  store i32 0, i32* %result, align 4, !dbg !1705
  call void @llvm.dbg.declare(metadata i8** %oauth, metadata !1706, metadata !1690), !dbg !1707
  store i8* null, i8** %oauth, align 8, !dbg !1707
  %0 = load i8*, i8** %host.addr, align 8, !dbg !1708
  %cmp = icmp eq i8* %0, null, !dbg !1710
  br i1 %cmp, label %land.lhs.true, label %if.else, !dbg !1711

land.lhs.true:                                    ; preds = %entry
  %1 = load i64, i64* %port.addr, align 8, !dbg !1712
  %cmp1 = icmp eq i64 %1, 0, !dbg !1714
  br i1 %cmp1, label %if.then, label %lor.lhs.false, !dbg !1715

lor.lhs.false:                                    ; preds = %land.lhs.true
  %2 = load i64, i64* %port.addr, align 8, !dbg !1716
  %cmp2 = icmp eq i64 %2, 80, !dbg !1718
  br i1 %cmp2, label %if.then, label %if.else, !dbg !1719

if.then:                                          ; preds = %lor.lhs.false, %land.lhs.true
  %3 = load i8*, i8** %user.addr, align 8, !dbg !1720
  %4 = load i8*, i8** %bearer.addr, align 8, !dbg !1721
  %call = call i8* (i8*, ...) @curl_maprintf(i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str, i32 0, i32 0), i8* %3, i8* %4), !dbg !1722
  store i8* %call, i8** %oauth, align 8, !dbg !1723
  br label %if.end10, !dbg !1724

if.else:                                          ; preds = %lor.lhs.false, %entry
  %5 = load i64, i64* %port.addr, align 8, !dbg !1725
  %cmp3 = icmp eq i64 %5, 0, !dbg !1727
  br i1 %cmp3, label %if.then6, label %lor.lhs.false4, !dbg !1728

lor.lhs.false4:                                   ; preds = %if.else
  %6 = load i64, i64* %port.addr, align 8, !dbg !1729
  %cmp5 = icmp eq i64 %6, 80, !dbg !1731
  br i1 %cmp5, label %if.then6, label %if.else8, !dbg !1732

if.then6:                                         ; preds = %lor.lhs.false4, %if.else
  %7 = load i8*, i8** %user.addr, align 8, !dbg !1733
  %8 = load i8*, i8** %host.addr, align 8, !dbg !1734
  %9 = load i8*, i8** %bearer.addr, align 8, !dbg !1735
  %call7 = call i8* (i8*, ...) @curl_maprintf(i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.1, i32 0, i32 0), i8* %7, i8* %8, i8* %9), !dbg !1736
  store i8* %call7, i8** %oauth, align 8, !dbg !1737
  br label %if.end, !dbg !1738

if.else8:                                         ; preds = %lor.lhs.false4
  %10 = load i8*, i8** %user.addr, align 8, !dbg !1739
  %11 = load i8*, i8** %host.addr, align 8, !dbg !1740
  %12 = load i64, i64* %port.addr, align 8, !dbg !1741
  %13 = load i8*, i8** %bearer.addr, align 8, !dbg !1742
  %call9 = call i8* (i8*, ...) @curl_maprintf(i8* getelementptr inbounds ([42 x i8], [42 x i8]* @.str.2, i32 0, i32 0), i8* %10, i8* %11, i64 %12, i8* %13), !dbg !1743
  store i8* %call9, i8** %oauth, align 8, !dbg !1744
  br label %if.end
...
if.end10:                                         ; preds = %if.end, %if.then
  %14 = load i8*, i8** %oauth, align 8, !dbg !1745
  %tobool = icmp ne i8* %14, null, !dbg !1745
  br i1 %tobool, label %if.end12, label %if.then11, !dbg !1747

if.then11:                                        ; preds = %if.end10
  store i32 27, i32* %retval, align 4, !dbg !1748
  br label %return, !dbg !1748

if.end12:                                         ; preds = %if.end10
  %15 = load %struct.Curl_easy*, %struct.Curl_easy** %data.addr, align 8, !dbg !1749
  %16 = load i8*, i8** %oauth, align 8, !dbg !1750
  %17 = load i8*, i8** %oauth, align 8, !dbg !1751
  %call13 = call i64 @strlen(i8* %17) #4, !dbg !1752
  %18 = load i8**, i8*** %outptr.addr, align 8, !dbg !1753
  %19 = load i64*, i64** %outlen.addr, align 8, !dbg !1754
  %call14 = call i32 @Curl_base64_encode(%struct.Curl_easy* %15, i8* %16, i64 %call13, i8** %18, i64* %19), !dbg !1755
  store i32 %call14, i32* %result, align 4, !dbg !1757
  %20 = load void (i8*)*, void (i8*)** @Curl_cfree, align 8, !dbg !1758
  %21 = load i8*, i8** %oauth, align 8, !dbg !1758
  call void %20(i8* %21), !dbg !1758
  %22 = load i32, i32* %result, align 4, !dbg !1759
  store i32 %22, i32* %retval, align 4, !dbg !1760
  br label %return, !dbg !1760

return:                                           ; preds = %if.end12, %if.then11
  %23 = load i32, i32* %retval, align 4, !dbg !1761
  ret i32 %23, !dbg !1761
}
...
declare i32 @Curl_base64_encode(%struct.Curl_easy*, i8*, i64, i8**, i64*) #2
...
!1 = !DIFile(filename: "/data/download/cmake/cmake-master/Utilities/cmcurl/lib/vauth/oauth2.c", directory: "/data/download/cmake/cmake-master/Utilities/cmcurl/lib")
...
!1678 = !{!311}
!1679 = !{!1680}
!1680 = distinct !DISubprogram(name: "Curl_auth_create_oauth_bearer_message", scope: !1, file: !1, line: 58, type: !1681, isLocal: false, isDefinition: true, scopeLine: 64, flags: DIFlagPrototyped, isOptimized: false, variables: !1685)
!1681 = !DISubroutineType(types: !1682)
!1682 = !{!289, !256, !851, !851, !1683, !851, !1524, !1684}
!1683 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !379)
!1684 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !347, size: 64, align: 64)
!1685 = !{}
!1686 = !{i32 2, !"Dwarf Version", i32 4}
!1687 = !{i32 2, !"Debug Info Version", i32 3}
!1688 = !{!"clang version 3.8.0 (tags/RELEASE_380/final)"}
!1689 = !DILocalVariable(name: "data", arg: 1, scope: !1680, file: !1, line: 58, type: !256)
!1690 = !DIExpression()
!1691 = !DILocation(line: 58, column: 66, scope: !1680)
!1692 = !DILocalVariable(name: "user", arg: 2, scope: !1680, file: !1, line: 59, type: !851)
!1693 = !DILocation(line: 59, column: 60, scope: !1680)
!1694 = !DILocalVariable(name: "host", arg: 3, scope: !1680, file: !1, line: 60, type: !851)
!1695 = !DILocation(line: 60, column: 60, scope: !1680)
!1696 = !DILocalVariable(name: "port", arg: 4, scope: !1680, file: !1, line: 61, type: !1683)
!1697 = !DILocation(line: 61, column: 59, scope: !1680)
!1698 = !DILocalVariable(name: "bearer", arg: 5, scope: !1680, file: !1, line: 62, type: !851)
!1699 = !DILocation(line: 62, column: 60, scope: !1680)
!1700 = !DILocalVariable(name: "outptr", arg: 6, scope: !1680, file: !1, line: 63, type: !1524)
!1701 = !DILocation(line: 63, column: 55, scope: !1680)
!1702 = !DILocalVariable(name: "outlen", arg: 7, scope: !1680, file: !1, line: 63, type: !1684)
!1703 = !DILocation(line: 63, column: 71, scope: !1680)
!1704 = !DILocalVariable(name: "result", scope: !1680, file: !1, line: 65, type: !289)
!1705 = !DILocation(line: 65, column: 12, scope: !1680)
!1706 = !DILocalVariable(name: "oauth", scope: !1680, file: !1, line: 66, type: !479)
!1707 = !DILocation(line: 66, column: 9, scope: !1680)
!1708 = !DILocation(line: 69, column: 6, scope: !1709)
!1709 = distinct !DILexicalBlock(scope: !1680, file: !1, line: 69, column: 6)
!1710 = !DILocation(line: 69, column: 11, scope: !1709)
!1711 = !DILocation(line: 69, column: 19, scope: !1709)
!1712 = !DILocation(line: 69, column: 23, scope: !1713)
!1713 = !DILexicalBlockFile(scope: !1709, file: !1, discriminator: 1)
!1714 = !DILocation(line: 69, column: 28, scope: !1713)
!1715 = !DILocation(line: 69, column: 33, scope: !1713)
