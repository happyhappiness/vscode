; ModuleID = '/data/download/cmake/cmake-master/Utilities/cmcurl/lib/vauth/cleartext.c'
...
define i32 @Curl_auth_create_plain_message(%struct.Curl_easy* %data, i8* %userp, i8* %passwdp, i8** %outptr, i64* %outlen) #0 !dbg !1680 {
entry:
  ...
  %plainauth = alloca i8*, align 8
  %ulen = alloca i64, align 8
  %plen = alloca i64, align 8
  %plainlen = alloca i64, align 8
  store %struct.Curl_easy* %data, %struct.Curl_easy** %data.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.Curl_easy** %data.addr, metadata !1692, metadata !1693), !dbg !1694
  store i8* %userp, i8** %userp.addr, align 8
  call void @llvm.dbg.declare(metadata i8** %userp.addr, metadata !1695, metadata !1693), !dbg !1696
  store i8* %passwdp, i8** %passwdp.addr, align 8
  call void @llvm.dbg.declare(metadata i8** %passwdp.addr, metadata !1697, metadata !1693), !dbg !1698
  store i8** %outptr, i8*** %outptr.addr, align 8
  call void @llvm.dbg.declare(metadata i8*** %outptr.addr, metadata !1699, metadata !1693), !dbg !1700
  store i64* %outlen, i64** %outlen.addr, align 8
  call void @llvm.dbg.declare(metadata i64** %outlen.addr, metadata !1701, metadata !1693), !dbg !1702
  call void @llvm.dbg.declare(metadata i32* %result, metadata !1703, metadata !1693), !dbg !1704
  call void @llvm.dbg.declare(metadata i8** %plainauth, metadata !1705, metadata !1693), !dbg !1706
  call void @llvm.dbg.declare(metadata i64* %ulen, metadata !1707, metadata !1693), !dbg !1708
  call void @llvm.dbg.declare(metadata i64* %plen, metadata !1709, metadata !1693), !dbg !1710
  call void @llvm.dbg.declare(metadata i64* %plainlen, metadata !1711, metadata !1693), !dbg !1712
  %0 = load i64*, i64** %outlen.addr, align 8, !dbg !1713
  store i64 0, i64* %0, align 8, !dbg !1714
  %1 = load i8**, i8*** %outptr.addr, align 8, !dbg !1715
  store i8* null, i8** %1, align 8, !dbg !1716
  %2 = load i8*, i8** %userp.addr, align 8, !dbg !1717
  %call = call i64 @strlen(i8* %2) #5, !dbg !1718
  store i64 %call, i64* %ulen, align 8, !dbg !1719
  %3 = load i8*, i8** %passwdp.addr, align 8, !dbg !1720
  %call1 = call i64 @strlen(i8* %3) #5, !dbg !1721
  store i64 %call1, i64* %plen, align 8, !dbg !1722
  %4 = load i64, i64* %ulen, align 8, !dbg !1723
  %mul = mul i64 2, %4, !dbg !1724
  store i64 %mul, i64* %plainlen, align 8, !dbg !1725
  %5 = load i64, i64* %plainlen, align 8, !dbg !1726
  %6 = load i64, i64* %ulen, align 8, !dbg !1728
  %cmp = icmp ult i64 %5, %6, !dbg !1729
  br i1 %cmp, label %if.then, label %if.end, !dbg !1730

if.then:                                          ; preds = %entry
  store i32 27, i32* %retval, align 4, !dbg !1731
  br label %return, !dbg !1731

if.end:                                           ; preds = %entry
  %7 = load i64, i64* %plen, align 8, !dbg !1732
  %8 = load i64, i64* %plainlen, align 8, !dbg !1733
  %add = add i64 %8, %7, !dbg !1733
  store i64 %add, i64* %plainlen, align 8, !dbg !1733
  %9 = load i64, i64* %plainlen, align 8, !dbg !1734
  %10 = load i64, i64* %plen, align 8, !dbg !1736
  %cmp2 = icmp ult i64 %9, %10, !dbg !1737
  br i1 %cmp2, label %if.then3, label %if.end4, !dbg !1738

if.then3:                                         ; preds = %if.end
  store i32 27, i32* %retval, align 4, !dbg !1739
  br label %return, !dbg !1739

if.end4:                                          ; preds = %if.end
  %11 = load i64, i64* %plainlen, align 8, !dbg !1740
  %add5 = add i64 %11, 2, !dbg !1740
  store i64 %add5, i64* %plainlen, align 8, !dbg !1740
  %12 = load i64, i64* %plainlen, align 8, !dbg !1741
  %cmp6 = icmp ult i64 %12, 2, !dbg !1743
  br i1 %cmp6, label %if.then7, label %if.end8, !dbg !1744

if.then7:                                         ; preds = %if.end4
  store i32 27, i32* %retval, align 4, !dbg !1745
  br label %return, !dbg !1745

if.end8:                                          ; preds = %if.end4
  %13 = load i8* (i64)*, i8* (i64)** @Curl_cmalloc, align 8, !dbg !1746
  %14 = load i64, i64* %plainlen, align 8, !dbg !1746
  %call9 = call i8* %13(i64 %14), !dbg !1746
  store i8* %call9, i8** %plainauth, align 8, !dbg !1747
  %15 = load i8*, i8** %plainauth, align 8, !dbg !1748
  %tobool = icmp ne i8* %15, null, !dbg !1748
  br i1 %tobool, label %if.end11, label %if.then10, !dbg !1750

if.then10:                                        ; preds = %if.end8
  store i32 27, i32* %retval, align 4, !dbg !1751
  br label %return, !dbg !1751

if.end11:                                         ; preds = %if.end8
  %16 = load i8*, i8** %plainauth, align 8, !dbg !1752
  %17 = load i8*, i8** %userp.addr, align 8, !dbg !1753
  %18 = load i64, i64* %ulen, align 8, !dbg !1754
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %16, i8* %17, i64 %18, i32 1, i1 false), !dbg !1755
  %19 = load i64, i64* %ulen, align 8, !dbg !1756
  %20 = load i8*, i8** %plainauth, align 8, !dbg !1757
  %arrayidx = getelementptr inbounds i8, i8* %20, i64 %19, !dbg !1757
  store i8 0, i8* %arrayidx, align 1, !dbg !1758
  %21 = load i8*, i8** %plainauth, align 8, !dbg !1759
  %22 = load i64, i64* %ulen, align 8, !dbg !1760
  %add.ptr = getelementptr inbounds i8, i8* %21, i64 %22, !dbg !1761
  %add.ptr12 = getelementptr inbounds i8, i8* %add.ptr, i64 1, !dbg !1762
  %23 = load i8*, i8** %userp.addr, align 8, !dbg !1763
  %24 = load i64, i64* %ulen, align 8, !dbg !1764
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %add.ptr12, i8* %23, i64 %24, i32 1, i1 false), !dbg !1765
  %25 = load i64, i64* %ulen, align 8, !dbg !1766
  %mul13 = mul i64 2, %25, !dbg !1767
  %add14 = add i64 %mul13, 1, !dbg !1768
  %26 = load i8*, i8** %plainauth, align 8, !dbg !1769
  %arrayidx15 = getelementptr inbounds i8, i8* %26, i64 %add14, !dbg !1769
  store i8 0, i8* %arrayidx15, align 1, !dbg !1770
  %27 = load i8*, i8** %plainauth, align 8, !dbg !1771
  %28 = load i64, i64* %ulen, align 8, !dbg !1772
  %mul16 = mul i64 2, %28, !dbg !1773
  %add.ptr17 = getelementptr inbounds i8, i8* %27, i64 %mul16, !dbg !1774
  %add.ptr18 = getelementptr inbounds i8, i8* %add.ptr17, i64 2, !dbg !1775
  %29 = load i8*, i8** %passwdp.addr, align 8, !dbg !1776
  %30 = load i64, i64* %plen, align 8, !dbg !1777
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %add.ptr18, i8* %29, i64 %30, i32 1, i1 false), !dbg !1778
  %31 = load %struct.Curl_easy*, %struct.Curl_easy** %data.addr, align 8, !dbg !1779
  %32 = load i8*, i8** %plainauth, align 8, !dbg !1780
  %33 = load i64, i64* %plainlen, align 8, !dbg !1781
  %34 = load i8**, i8*** %outptr.addr, align 8, !dbg !1782
  %35 = load i64*, i64** %outlen.addr, align 8, !dbg !1783
  %call19 = call i32 @Curl_base64_encode(%struct.Curl_easy* %31, i8* %32, i64 %33, i8** %34, i64* %35), !dbg !1784
  store i32 %call19, i32* %result, align 4, !dbg !1785
  %36 = load void (i8*)*, void (i8*)** @Curl_cfree, align 8, !dbg !1786
  %37 = load i8*, i8** %plainauth, align 8, !dbg !1786
  call void %36(i8* %37), !dbg !1786
  %38 = load i32, i32* %result, align 4, !dbg !1787
  store i32 %38, i32* %retval, align 4, !dbg !1788
  br label %return, !dbg !1788

return:                                           ; preds = %if.end11, %if.then10, %if.then7, %if.then3, %if.then
  %39 = load i32, i32* %retval, align 4, !dbg !1789
  ret i32 %39, !dbg !1789
}
...
; Function Attrs: nounwind uwtable
define i32 @Curl_auth_create_login_message(%struct.Curl_easy* %data, i8* %valuep, i8** %outptr, i64* %outlen) #0 !dbg !1685 {
entry:
  %retval = alloca i32, align 4
  %data.addr = alloca %struct.Curl_easy*, align 8
  ...
  store %struct.Curl_easy* %data, %struct.Curl_easy** %data.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.Curl_easy** %data.addr, metadata !1790, metadata !1693), !dbg !1791
  store i8* %valuep, i8** %valuep.addr, align 8
  call void @llvm.dbg.declare(metadata i8** %valuep.addr, metadata !1792, metadata !1693), !dbg !1793
  store i8** %outptr, i8*** %outptr.addr, align 8
  call void @llvm.dbg.declare(metadata i8*** %outptr.addr, metadata !1794, metadata !1693), !dbg !1795
  store i64* %outlen, i64** %outlen.addr, align 8
  call void @llvm.dbg.declare(metadata i64** %outlen.addr, metadata !1796, metadata !1693), !dbg !1797
  call void @llvm.dbg.declare(metadata i64* %vlen, metadata !1798, metadata !1693), !dbg !1799
  %0 = load i8*, i8** %valuep.addr, align 8, !dbg !1800
  %call = call i64 @strlen(i8* %0) #5, !dbg !1801
  store i64 %call, i64* %vlen, align 8, !dbg !1799
  %1 = load i64, i64* %vlen, align 8, !dbg !1802
  %tobool = icmp ne i64 %1, 0, !dbg !1802
  br i1 %tobool, label %if.end4, label %if.then, !dbg !1804

if.then:                                          ; preds = %entry
  %2 = load i8* (i8*)*, i8* (i8*)** @Curl_cstrdup, align 8, !dbg !1805
  %call1 = call i8* %2(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i32 0, i32 0)), !dbg !1805
  %3 = load i8**, i8*** %outptr.addr, align 8, !dbg !1807
  store i8* %call1, i8** %3, align 8, !dbg !1808
  %4 = load i8**, i8*** %outptr.addr, align 8, !dbg !1809
  %5 = load i8*, i8** %4, align 8, !dbg !1811
  %tobool2 = icmp ne i8* %5, null, !dbg !1811
  br i1 %tobool2, label %if.then3, label %if.end, !dbg !1812

if.then3:                                         ; preds = %if.then
  %6 = load i64*, i64** %outlen.addr, align 8, !dbg !1813
  store i64 1, i64* %6, align 8, !dbg !1815
  store i32 0, i32* %retval, align 4, !dbg !1816
  br label %return, !dbg !1816

if.end:                                           ; preds = %if.then
  %7 = load i64*, i64** %outlen.addr, align 8, !dbg !1817
  store i64 0, i64* %7, align 8, !dbg !1818
  store i32 27, i32* %retval, align 4, !dbg !1819
  br label %return, !dbg !1819

if.end4:                                          ; preds = %entry
  %8 = load %struct.Curl_easy*, %struct.Curl_easy** %data.addr, align 8, !dbg !1820
  %9 = load i8*, i8** %valuep.addr, align 8, !dbg !1821
  %10 = load i64, i64* %vlen, align 8, !dbg !1822
  %11 = load i8**, i8*** %outptr.addr, align 8, !dbg !1823
  %12 = load i64*, i64** %outlen.addr, align 8, !dbg !1824
  %call5 = call i32 @Curl_base64_encode(%struct.Curl_easy* %8, i8* %9, i64 %10, i8** %11, i64* %12), !dbg !1825
  store i32 %call5, i32* %retval, align 4, !dbg !1826
  br label %return, !dbg !1826

return:                                           ; preds = %if.end4, %if.end, %if.then3
  %13 = load i32, i32* %retval, align 4, !dbg !1827
  ret i32 %13, !dbg !1827
}

; Function Attrs: nounwind uwtable
define i32 @Curl_auth_create_external_message(%struct.Curl_easy* %data, i8* %user, i8** %outptr, i64* %outlen) #0 !dbg !1688 {
entry:
  %data.addr = alloca %struct.Curl_easy*, align 8
  ...
  %outlen.addr = alloca i64*, align 8
  store %struct.Curl_easy* %data, %struct.Curl_easy** %data.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.Curl_easy** %data.addr, metadata !1828, metadata !1693), !dbg !1829
  store i8* %user, i8** %user.addr, align 8
  call void @llvm.dbg.declare(metadata i8** %user.addr, metadata !1830, metadata !1693), !dbg !1831
  store i8** %outptr, i8*** %outptr.addr, align 8
  call void @llvm.dbg.declare(metadata i8*** %outptr.addr, metadata !1832, metadata !1693), !dbg !1833
  store i64* %outlen, i64** %outlen.addr, align 8
  call void @llvm.dbg.declare(metadata i64** %outlen.addr, metadata !1834, metadata !1693), !dbg !1835
  %0 = load %struct.Curl_easy*, %struct.Curl_easy** %data.addr, align 8, !dbg !1836
  %1 = load i8*, i8** %user.addr, align 8, !dbg !1837
  %2 = load i8**, i8*** %outptr.addr, align 8, !dbg !1838
  %3 = load i64*, i64** %outlen.addr, align 8, !dbg !1839
  %call = call i32 @Curl_auth_create_login_message(%struct.Curl_easy* %0, i8* %1, i8** %2, i64* %3), !dbg !1840
...
!1 = !DIFile(filename: "/data/download/cmake/cmake-master/Utilities/cmcurl/lib/vauth/cleartext.c", directory: "/data/download/cmake/cmake-master/Utilities/cmcurl/lib")
...
!1678 = !{!347}
!1679 = !{!1680, !1685, !1688}
!1680 = distinct !DISubprogram(name: "Curl_auth_create_plain_message", scope: !1, file: !1, line: 60, type: !1681, isLocal: false, isDefinition: true, scopeLine: 64, flags: DIFlagPrototyped, isOptimized: false, variables: !1684)
!1681 = !DISubroutineType(types: !1682)
!1682 = !{!289, !256, !851, !851, !1524, !1683}
!1683 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !347, size: 64, align: 64)
!1684 = !{}
!1685 = distinct !DISubprogram(name: "Curl_auth_create_login_message", scope: !1, file: !1, line: 121, type: !1686, isLocal: false, isDefinition: true, scopeLine: 124, flags: DIFlagPrototyped, isOptimized: false, variables: !1684)
!1686 = !DISubroutineType(types: !1687)
!1687 = !{!289, !256, !851, !1524, !1683}
!1688 = distinct !DISubprogram(name: "Curl_auth_create_external_message", scope: !1, file: !1, line: 159, type: !1686, isLocal: false, isDefinition: true, scopeLine: 162, flags: DIFlagPrototyped, isOptimized: false, variables: !1684)
!1689 = !{i32 2, !"Dwarf Version", i32 4}
!1690 = !{i32 2, !"Debug Info Version", i32 3}
!1691 = !{!"clang version 3.8.0 (tags/RELEASE_380/final)"}
!1692 = !DILocalVariable(name: "data", arg: 1, scope: !1680, file: !1, line: 60, type: !256)
!1693 = !DIExpression()
!1694 = !DILocation(line: 60, column: 59, scope: !1680)
!1695 = !DILocalVariable(name: "userp", arg: 2, scope: !1680, file: !1, line: 61, type: !851)
!1796 = !DILocalVariable(name: "outlen", arg: 4, scope: !1685, file: !1, line: 123, type: !1683)
!1797 = !DILocation(line: 123, column: 49, scope: !1685)
!1798 = !DILocalVariable(name: "vlen", scope: !1685, file: !1, line: 125, type: !347)
!1799 = !DILocation(line: 125, column: 10, scope: !1685)
!1800 = !DILocation(line: 125, column: 24, scope: !1685)
!1801 = !DILocation(line: 125, column: 17, scope: !1685)
!1802 = !DILocation(line: 127, column: 7, scope: !1803)
!1803 = distinct !DILexicalBlock(scope: !1685, file: !1, line: 127, column: 6)
!1804 = !DILocation(line: 127, column: 6, scope: !1685)
!1805 = !DILocation(line: 129, column: 15, scope: !1806)
!1806 = distinct !DILexicalBlock(scope: !1803, file: !1, line: 127, column: 13)
!1807 = !DILocation(line: 129, column: 6, scope: !1806)
!1808 = !DILocation(line: 129, column: 13, scope: !1806)
!1809 = !DILocation(line: 130, column: 9, scope: !1810)
!1810 = distinct !DILexicalBlock(scope: !1806, file: !1, line: 130, column: 8)
!1811 = !DILocation(line: 130, column: 8, scope: !1810)
!1812 = !DILocation(line: 130, column: 8, scope: !1806)
!1813 = !DILocation(line: 131, column: 8, scope: !1814)
!1814 = distinct !DILexicalBlock(scope: !1810, file: !1, line: 130, column: 17)
!1815 = !DILocation(line: 131, column: 15, scope: !1814)
!1816 = !DILocation(line: 132, column: 7, scope: !1814)
!1817 = !DILocation(line: 135, column: 6, scope: !1806)
!1818 = !DILocation(line: 135, column: 13, scope: !1806)
!1819 = !DILocation(line: 136, column: 5, scope: !1806)
!1820 = !DILocation(line: 140, column: 29, scope: !1685)
!1821 = !DILocation(line: 140, column: 35, scope: !1685)
!1822 = !DILocation(line: 140, column: 43, scope: !1685)
!1823 = !DILocation(line: 140, column: 49, scope: !1685)
!1824 = !DILocation(line: 140, column: 57, scope: !1685)
!1825 = !DILocation(line: 140, column: 10, scope: !1685)
!1826 = !DILocation(line: 140, column: 3, scope: !1685)
!1827 = !DILocation(line: 141, column: 1, scope: !1685)
!1828 = !DILocalVariable(name: "data", arg: 1, scope: !1688, file: !1, line: 159, type: !256)
!1829 = !DILocation(line: 159, column: 62, scope: !1688)
!1830 = !DILocalVariable(name: "user", arg: 2, scope: !1688, file: !1, line: 160, type: !851)
!1831 = !DILocation(line: 160, column: 56, scope: !1688)
!1832 = !DILocalVariable(name: "outptr", arg: 3, scope: !1688, file: !1, line: 160, type: !1524)
!1833 = !DILocation(line: 160, column: 69, scope: !1688)
!1834 = !DILocalVariable(name: "outlen", arg: 4, scope: !1688, file: !1, line: 161, type: !1683)
!1835 = !DILocation(line: 161, column: 52, scope: !1688)
!1836 = !DILocation(line: 164, column: 41, scope: !1688)
!1837 = !DILocation(line: 164, column: 47, scope: !1688)
!1838 = !DILocation(line: 164, column: 53, scope: !1688)
!1839 = !DILocation(line: 164, column: 61, scope: !1688)
!1840 = !DILocation(line: 164, column: 10, scope: !1688)
!1841 = !DILocation(line: 164, column: 3, scope: !1688)
