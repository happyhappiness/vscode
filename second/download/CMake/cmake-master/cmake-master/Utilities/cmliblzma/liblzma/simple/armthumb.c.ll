; ModuleID = '/data/download/cmake/cmake-master/Utilities/cmliblzma/liblzma/simple/armthumb.c'
...
define i32 @lzma_simple_armthumb_encoder_init(%struct.lzma_next_coder_s* %next, %struct.lzma_allocator* %allocator, %struct.lzma_filter_info_s* %filters) #0 !dbg !36 {
entry:
  ...
  %call = call i32 @armthumb_coder_init(%struct.lzma_next_coder_s* %0, %struct.lzma_allocator* %1, %struct.lzma_filter_info_s* %2, i1 zeroext true), !dbg !168
...
; Function Attrs: nounwind uwtable
define internal i32 @armthumb_coder_init(%struct.lzma_next_coder_s* %next, %struct.lzma_allocator* %allocator, %struct.lzma_filter_info_s* %filters, i1 zeroext %is_encoder) #0 !dbg !151 {
entry:
  %next.addr = alloca %struct.lzma_next_coder_s*, align 8
  %allocator.addr = alloca %struct.lzma_allocator*, align 8
  %filters.addr = alloca %struct.lzma_filter_info_s*, align 8
  ...
  %call = call i32 @lzma_simple_coder_init(%struct.lzma_next_coder_s* %0, %struct.lzma_allocator* %1, %struct.lzma_filter_info_s* %2, i64 (%struct.lzma_simple_s*, i32, i1, i8*, i64)* @armthumb_code, i64 0, i64 4, i32 2, i1 zeroext %tobool), !dbg !182
  ret i32 %call, !dbg !183
}

; Function Attrs: nounwind uwtable
define i32 @lzma_simple_armthumb_decoder_init(%struct.lzma_next_coder_s* %next, %struct.lzma_allocator* %allocator, %struct.lzma_filter_info_s* %filters) #0 !dbg !150 {
entry:
  %next.addr = alloca %struct.lzma_next_coder_s*, align 8
  %allocator.addr = alloca %struct.lzma_allocator*, align 8
  %filters.addr = alloca %struct.lzma_filter_info_s*, align 8
  ...
  %call = call i32 @armthumb_coder_init(%struct.lzma_next_coder_s* %0, %struct.lzma_allocator* %1, %struct.lzma_filter_info_s* %2, i1 zeroext false), !dbg !193
...
; Function Attrs: nounwind uwtable
define internal i64 @armthumb_code(%struct.lzma_simple_s* %simple, i32 %now_pos, i1 zeroext %is_encoder, i8* %buffer, i64 %size) #0 !dbg !154 {
entry:
...
for.body:                                         ; preds = %for.cond
  ...
  %and = and i32 %conv, 248, !dbg !222
  %cmp2 = icmp eq i32 %and, 240, !dbg !223
  br i1 %cmp2, label %land.lhs.true, label %if.end57, !dbg !224

land.lhs.true:                                    ; preds = %for.body
  %5 = load i64, i64* %i, align 8, !dbg !225
  %add4 = add i64 %5, 3, !dbg !227
  %6 = load i8*, i8** %buffer.addr, align 8, !dbg !228
  %arrayidx5 = getelementptr inbounds i8, i8* %6, i64 %add4, !dbg !228
  %7 = load i8, i8* %arrayidx5, align 1, !dbg !228
  %conv6 = zext i8 %7 to i32, !dbg !228
  %and7 = and i32 %conv6, 248, !dbg !229
  %cmp8 = icmp eq i32 %and7, 248, !dbg !230
  br i1 %cmp8, label %if.then, label %if.end57, !dbg !231

if.then:                                          ; preds = %land.lhs.true
  call void @llvm.dbg.declare(metadata i32* %dest, metadata !233, metadata !159), !dbg !235
  call void @llvm.dbg.declare(metadata i32* %src, metadata !236, metadata !159), !dbg !237
  %8 = load i64, i64* %i, align 8, !dbg !238
  %add10 = add i64 %8, 1, !dbg !239
  %9 = load i8*, i8** %buffer.addr, align 8, !dbg !240
  %arrayidx11 = getelementptr inbounds i8, i8* %9, i64 %add10, !dbg !240
  %10 = load i8, i8* %arrayidx11, align 1, !dbg !240
  %conv12 = zext i8 %10 to i32, !dbg !240
  %and13 = and i32 %conv12, 7, !dbg !241
  %shl = shl i32 %and13, 19, !dbg !242
  %11 = load i64, i64* %i, align 8, !dbg !243
  %add14 = add i64 %11, 0, !dbg !244
  %12 = load i8*, i8** %buffer.addr, align 8, !dbg !245
  %arrayidx15 = getelementptr inbounds i8, i8* %12, i64 %add14, !dbg !245
  %13 = load i8, i8* %arrayidx15, align 1, !dbg !245
  %conv16 = zext i8 %13 to i32, !dbg !245
  %shl17 = shl i32 %conv16, 11, !dbg !246
  %or = or i32 %shl, %shl17, !dbg !247
  %14 = load i64, i64* %i, align 8, !dbg !248
  %add18 = add i64 %14, 3, !dbg !249
  %15 = load i8*, i8** %buffer.addr, align 8, !dbg !250
  %arrayidx19 = getelementptr inbounds i8, i8* %15, i64 %add18, !dbg !250
  %16 = load i8, i8* %arrayidx19, align 1, !dbg !250
  %conv20 = zext i8 %16 to i32, !dbg !250
  %and21 = and i32 %conv20, 7, !dbg !251
  %shl22 = shl i32 %and21, 8, !dbg !252
  %or23 = or i32 %or, %shl22, !dbg !253
  %17 = load i64, i64* %i, align 8, !dbg !254
  %add24 = add i64 %17, 2, !dbg !255
  %18 = load i8*, i8** %buffer.addr, align 8, !dbg !256
  %arrayidx25 = getelementptr inbounds i8, i8* %18, i64 %add24, !dbg !256
  %19 = load i8, i8* %arrayidx25, align 1, !dbg !256
  %conv26 = zext i8 %19 to i32, !dbg !257
  %or27 = or i32 %or23, %conv26, !dbg !258
  store i32 %or27, i32* %src, align 4, !dbg !237
  %20 = load i32, i32* %src, align 4, !dbg !259
  %shl28 = shl i32 %20, 1, !dbg !259
  store i32 %shl28, i32* %src, align 4, !dbg !259
  %21 = load i8, i8* %is_encoder.addr, align 1, !dbg !260
  %tobool = trunc i8 %21 to i1, !dbg !260
  br i1 %tobool, label %if.then29, label %if.else, !dbg !262

if.then29:                                        ; preds = %if.then
  %22 = load i32, i32* %now_pos.addr, align 4, !dbg !263
  %23 = load i64, i64* %i, align 8, !dbg !264
  %conv30 = trunc i64 %23 to i32, !dbg !265
  %add31 = add i32 %22, %conv30, !dbg !266
  %add32 = add i32 %add31, 4, !dbg !267
  %24 = load i32, i32* %src, align 4, !dbg !268
  %add33 = add i32 %add32, %24, !dbg !269
  store i32 %add33, i32* %dest, align 4, !dbg !270
  br label %if.end, !dbg !271

if.else:                                          ; preds = %if.then
  %25 = load i32, i32* %src, align 4, !dbg !272
  %26 = load i32, i32* %now_pos.addr, align 4, !dbg !273
  %27 = load i64, i64* %i, align 8, !dbg !274
  %conv34 = trunc i64 %27 to i32, !dbg !275
  %add35 = add i32 %26, %conv34, !dbg !276
  %add36 = add i32 %add35, 4, !dbg !277
  %sub = sub i32 %25, %add36, !dbg !278
  store i32 %sub, i32* %dest, align 4, !dbg !279
  br label %if.end

if.end:                                           ; preds = %if.else, %if.then29
  %28 = load i32, i32* %dest, align 4, !dbg !280
  %shr = lshr i32 %28, 1, !dbg !280
  store i32 %shr, i32* %dest, align 4, !dbg !280
  %29 = load i32, i32* %dest, align 4, !dbg !281
  %shr37 = lshr i32 %29, 19, !dbg !282
  %and38 = and i32 %shr37, 7, !dbg !283
  %or39 = or i32 240, %and38, !dbg !284
  %conv40 = trunc i32 %or39 to i8, !dbg !285
  %30 = load i64, i64* %i, align 8, !dbg !286
  %add41 = add i64 %30, 1, !dbg !287
  %31 = load i8*, i8** %buffer.addr, align 8, !dbg !288
  %arrayidx42 = getelementptr inbounds i8, i8* %31, i64 %add41, !dbg !288
  store i8 %conv40, i8* %arrayidx42, align 1, !dbg !289
  %32 = load i32, i32* %dest, align 4, !dbg !290
  %shr43 = lshr i32 %32, 11, !dbg !291
  %conv44 = trunc i32 %shr43 to i8, !dbg !292
  %33 = load i64, i64* %i, align 8, !dbg !293
  %add45 = add i64 %33, 0, !dbg !294
  %34 = load i8*, i8** %buffer.addr, align 8, !dbg !295
  %arrayidx46 = getelementptr inbounds i8, i8* %34, i64 %add45, !dbg !295
  store i8 %conv44, i8* %arrayidx46, align 1, !dbg !296
  %35 = load i32, i32* %dest, align 4, !dbg !297
  %shr47 = lshr i32 %35, 8, !dbg !298
  %and48 = and i32 %shr47, 7, !dbg !299
  %or49 = or i32 248, %and48, !dbg !300
  %conv50 = trunc i32 %or49 to i8, !dbg !301
  %36 = load i64, i64* %i, align 8, !dbg !302
  %add51 = add i64 %36, 3, !dbg !303
  %37 = load i8*, i8** %buffer.addr, align 8, !dbg !304
  %arrayidx52 = getelementptr inbounds i8, i8* %37, i64 %add51, !dbg !304
  store i8 %conv50, i8* %arrayidx52, align 1, !dbg !305
  %38 = load i32, i32* %dest, align 4, !dbg !306
  %conv53 = trunc i32 %38 to i8, !dbg !307
  %39 = load i64, i64* %i, align 8, !dbg !308
  %add54 = add i64 %39, 2, !dbg !309
  %40 = load i8*, i8** %buffer.addr, align 8, !dbg !310
  %arrayidx55 = getelementptr inbounds i8, i8* %40, i64 %add54, !dbg !310
  store i8 %conv53, i8* %arrayidx55, align 1, !dbg !311
  %41 = load i64, i64* %i, align 8, !dbg !312
  %add56 = add i64 %41, 2, !dbg !312
  store i64 %add56, i64* %i, align 8, !dbg !312
  br label %if.end57, !dbg !313

if.end57:                                         ; preds = %if.end, %land.lhs.true, %for.body
  br label %for.inc, !dbg !314

for.inc:                                          ; preds = %if.end57
  %42 = load i64, i64* %i, align 8, !dbg !315
  %add58 = add i64 %42, 2, !dbg !315
  store i64 %add58, i64* %i, align 8, !dbg !315
  br label %for.cond, !dbg !317

for.end:                                          ; preds = %for.cond
  %43 = load i64, i64* %i, align 8, !dbg !318
  ret i64 %43, !dbg !319
}
...
!1 = !DIFile(filename: "/data/download/cmake/cmake-master/Utilities/cmliblzma/liblzma/simple/armthumb.c", directory: "/data/download/cmake/cmake-master/Utilities/cmliblzma")
!2 = !{!3, !18, !24}
...
!35 = !{!36, !150, !151, !154}
!36 = distinct !DISubprogram(name: "lzma_simple_armthumb_encoder_init", scope: !1, file: !1, line: 62, type: !37, isLocal: false, isDefinition: true, scopeLine: 64, flags: DIFlagPrototyped, isOptimized: false, variables: !149)
...
!149 = !{}
!150 = distinct !DISubprogram(name: "lzma_simple_armthumb_decoder_init", scope: !1, file: !1, line: 70, type: !37, isLocal: false, isDefinition: true, scopeLine: 72, flags: DIFlagPrototyped, isOptimized: false, variables: !149)
!151 = distinct !DISubprogram(name: "armthumb_coder_init", scope: !1, file: !1, line: 53, type: !152, isLocal: true, isDefinition: true, scopeLine: 55, flags: DIFlagPrototyped, isOptimized: false, variables: !149)
!152 = !DISubroutineType(types: !153)
!153 = !{!39, !40, !89, !139, !53}
!154 = distinct !DISubprogram(name: "armthumb_code", scope: !1, file: !1, line: 18, type: !57, isLocal: true, isDefinition: true, scopeLine: 21, flags: DIFlagPrototyped, isOptimized: false, variables: !149)
!155 = !{i32 2, !"Dwarf Version", i32 4}
!156 = !{i32 2, !"Debug Info Version", i32 3}
!157 = !{!"clang version 3.8.0 (tags/RELEASE_380/final)"}
!158 = !DILocalVariable(name: "next", arg: 1, scope: !36, file: !1, line: 62, type: !40)
!159 = !DIExpression()
!160 = !DILocation(line: 62, column: 52, scope: !36)
!161 = !DILocalVariable(name: "allocator", arg: 2, scope: !36, file: !1, line: 63, type: !89)
!162 = !DILocation(line: 63, column: 19, scope: !36)
!163 = !DILocalVariable(name: "filters", arg: 3, scope: !36, file: !1, line: 63, type: !139)
!164 = !DILocation(line: 63, column: 54, scope: !36)
!165 = !DILocation(line: 65, column: 29, scope: !36)
!166 = !DILocation(line: 65, column: 35, scope: !36)
!167 = !DILocation(line: 65, column: 46, scope: !36)
!168 = !DILocation(line: 65, column: 9, scope: !36)
!169 = !DILocation(line: 65, column: 2, scope: !36)
!170 = !DILocalVariable(name: "next", arg: 1, scope: !151, file: !1, line: 53, type: !40)
!171 = !DILocation(line: 53, column: 38, scope: !151)
!172 = !DILocalVariable(name: "allocator", arg: 2, scope: !151, file: !1, line: 53, type: !89)
!173 = !DILocation(line: 53, column: 60, scope: !151)
!174 = !DILocalVariable(name: "filters", arg: 3, scope: !151, file: !1, line: 54, type: !139)
!175 = !DILocation(line: 54, column: 27, scope: !151)
!176 = !DILocalVariable(name: "is_encoder", arg: 4, scope: !151, file: !1, line: 54, type: !53)
!177 = !DILocation(line: 54, column: 41, scope: !151)
!178 = !DILocation(line: 56, column: 32, scope: !151)
!179 = !DILocation(line: 56, column: 38, scope: !151)
!180 = !DILocation(line: 56, column: 49, scope: !151)
!181 = !DILocation(line: 57, column: 29, scope: !151)
!182 = !DILocation(line: 56, column: 9, scope: !151)
!183 = !DILocation(line: 56, column: 2, scope: !151)
!184 = !DILocalVariable(name: "next", arg: 1, scope: !150, file: !1, line: 70, type: !40)
!185 = !DILocation(line: 70, column: 52, scope: !150)
!186 = !DILocalVariable(name: "allocator", arg: 2, scope: !150, file: !1, line: 71, type: !89)
!187 = !DILocation(line: 71, column: 19, scope: !150)
!188 = !DILocalVariable(name: "filters", arg: 3, scope: !150, file: !1, line: 71, type: !139)
!189 = !DILocation(line: 71, column: 54, scope: !150)
!190 = !DILocation(line: 73, column: 29, scope: !150)
!191 = !DILocation(line: 73, column: 35, scope: !150)
!192 = !DILocation(line: 73, column: 46, scope: !150)
!193 = !DILocation(line: 73, column: 9, scope: !150)
!194 = !DILocation(line: 73, column: 2, scope: !150)
!195 = !DILocalVariable(name: "simple", arg: 1, scope: !154, file: !1, line: 18, type: !62)
!196 = !DILocation(line: 18, column: 28, scope: !154)
...
!217 = !DILocation(line: 24, column: 15, scope: !218)
...
!220 = !DILocation(line: 24, column: 17, scope: !218)
!221 = !DILocation(line: 24, column: 8, scope: !218)
!222 = !DILocation(line: 24, column: 22, scope: !218)
!223 = !DILocation(line: 24, column: 30, scope: !218)
!224 = !DILocation(line: 25, column: 5, scope: !218)
!225 = !DILocation(line: 25, column: 16, scope: !226)
!226 = !DILexicalBlockFile(scope: !218, file: !1, discriminator: 1)
!227 = !DILocation(line: 25, column: 18, scope: !226)
!228 = !DILocation(line: 25, column: 9, scope: !226)
!229 = !DILocation(line: 25, column: 23, scope: !226)
!230 = !DILocation(line: 25, column: 31, scope: !226)
!231 = !DILocation(line: 24, column: 7, scope: !232)
!232 = !DILexicalBlockFile(scope: !219, file: !1, discriminator: 1)
!233 = !DILocalVariable(name: "dest", scope: !234, file: !1, line: 26, type: !32)
!234 = distinct !DILexicalBlock(scope: !218, file: !1, line: 25, column: 40)
!235 = !DILocation(line: 26, column: 13, scope: !234)
!236 = !DILocalVariable(name: "src", scope: !234, file: !1, line: 27, type: !32)
!237 = !DILocation(line: 27, column: 13, scope: !234)
!238 = !DILocation(line: 27, column: 28, scope: !234)
!239 = !DILocation(line: 27, column: 30, scope: !234)
!240 = !DILocation(line: 27, column: 21, scope: !234)
!241 = !DILocation(line: 27, column: 35, scope: !234)
!242 = !DILocation(line: 27, column: 42, scope: !234)
!243 = !DILocation(line: 28, column: 16, scope: !234)
!244 = !DILocation(line: 28, column: 18, scope: !234)
!245 = !DILocation(line: 28, column: 9, scope: !234)
!246 = !DILocation(line: 28, column: 23, scope: !234)
!247 = !DILocation(line: 28, column: 6, scope: !234)
!248 = !DILocation(line: 29, column: 17, scope: !234)
!249 = !DILocation(line: 29, column: 19, scope: !234)
!250 = !DILocation(line: 29, column: 10, scope: !234)
!251 = !DILocation(line: 29, column: 24, scope: !234)
!252 = !DILocation(line: 29, column: 31, scope: !234)
!253 = !DILocation(line: 29, column: 6, scope: !234)
!254 = !DILocation(line: 30, column: 16, scope: !234)
!255 = !DILocation(line: 30, column: 18, scope: !234)
!256 = !DILocation(line: 30, column: 9, scope: !234)
!257 = !DILocation(line: 30, column: 8, scope: !234)
!258 = !DILocation(line: 30, column: 6, scope: !234)
!259 = !DILocation(line: 32, column: 8, scope: !234)
!260 = !DILocation(line: 34, column: 8, scope: !261)
!261 = distinct !DILexicalBlock(scope: !234, file: !1, line: 34, column: 8)
!262 = !DILocation(line: 34, column: 8, scope: !234)
!263 = !DILocation(line: 35, column: 12, scope: !261)
!264 = !DILocation(line: 35, column: 33, scope: !261)
!265 = !DILocation(line: 35, column: 22, scope: !261)
!266 = !DILocation(line: 35, column: 20, scope: !261)
!267 = !DILocation(line: 35, column: 36, scope: !261)
!268 = !DILocation(line: 35, column: 42, scope: !261)
!269 = !DILocation(line: 35, column: 40, scope: !261)
!270 = !DILocation(line: 35, column: 10, scope: !261)
!271 = !DILocation(line: 35, column: 5, scope: !261)
!272 = !DILocation(line: 37, column: 12, scope: !261)
!273 = !DILocation(line: 37, column: 19, scope: !261)
!274 = !DILocation(line: 37, column: 40, scope: !261)
!275 = !DILocation(line: 37, column: 29, scope: !261)
!276 = !DILocation(line: 37, column: 27, scope: !261)
!277 = !DILocation(line: 37, column: 43, scope: !261)
!278 = !DILocation(line: 37, column: 16, scope: !261)
!279 = !DILocation(line: 37, column: 10, scope: !261)
!280 = !DILocation(line: 39, column: 9, scope: !234)
!281 = !DILocation(line: 40, column: 29, scope: !234)
!282 = !DILocation(line: 40, column: 34, scope: !234)
!283 = !DILocation(line: 40, column: 41, scope: !234)
!284 = !DILocation(line: 40, column: 25, scope: !234)
!285 = !DILocation(line: 40, column: 20, scope: !234)
!286 = !DILocation(line: 40, column: 11, scope: !234)
!287 = !DILocation(line: 40, column: 13, scope: !234)
!288 = !DILocation(line: 40, column: 4, scope: !234)
!289 = !DILocation(line: 40, column: 18, scope: !234)
!290 = !DILocation(line: 41, column: 21, scope: !234)
!291 = !DILocation(line: 41, column: 26, scope: !234)
!292 = !DILocation(line: 41, column: 20, scope: !234)
!293 = !DILocation(line: 41, column: 11, scope: !234)
!294 = !DILocation(line: 41, column: 13, scope: !234)
!295 = !DILocation(line: 41, column: 4, scope: !234)
!296 = !DILocation(line: 41, column: 18, scope: !234)
!297 = !DILocation(line: 42, column: 29, scope: !234)
!298 = !DILocation(line: 42, column: 34, scope: !234)
!299 = !DILocation(line: 42, column: 40, scope: !234)
!300 = !DILocation(line: 42, column: 25, scope: !234)
!301 = !DILocation(line: 42, column: 20, scope: !234)
!302 = !DILocation(line: 42, column: 11, scope: !234)
!303 = !DILocation(line: 42, column: 13, scope: !234)
!304 = !DILocation(line: 42, column: 4, scope: !234)
!305 = !DILocation(line: 42, column: 18, scope: !234)
!306 = !DILocation(line: 43, column: 21, scope: !234)
!307 = !DILocation(line: 43, column: 20, scope: !234)
!308 = !DILocation(line: 43, column: 11, scope: !234)
!309 = !DILocation(line: 43, column: 13, scope: !234)
!310 = !DILocation(line: 43, column: 4, scope: !234)
!311 = !DILocation(line: 43, column: 18, scope: !234)
!312 = !DILocation(line: 44, column: 6, scope: !234)
!313 = !DILocation(line: 45, column: 3, scope: !234)
!314 = !DILocation(line: 46, column: 2, scope: !219)
!315 = !DILocation(line: 23, column: 31, scope: !316)
!316 = !DILexicalBlockFile(scope: !212, file: !1, discriminator: 2)
!317 = !DILocation(line: 23, column: 2, scope: !316)
!318 = !DILocation(line: 48, column: 9, scope: !154)
!319 = !DILocation(line: 48, column: 2, scope: !154)
