; ModuleID = '/data/download/cmake/cmake-master/Utilities/cmliblzma/liblzma/common/easy_decoder_memusage.c'
...
define i64 @lzma_easy_decoder_memusage(i32 %preset) #0 !dbg !20 {
entry:
...
if.end:                                           ; preds = %entry
  ...
  %call1 = call i64 @lzma_raw_decoder_memusage(%struct.lzma_filter* %arraydecay) #4, !dbg !96
...
declare i64 @lzma_raw_decoder_memusage(%struct.lzma_filter*) #3
...
!1 = !DIFile(filename: "/data/download/cmake/cmake-master/Utilities/cmliblzma/liblzma/common/easy_decoder_memusage.c", directory: "/data/download/cmake/cmake-master/Utilities/cmliblzma")
!2 = !{!3, !8, !15}
...
!19 = !{!20}
!20 = distinct !DISubprogram(name: "lzma_easy_decoder_memusage", scope: !1, file: !1, line: 17, type: !21, isLocal: false, isDefinition: true, scopeLine: 18, flags: DIFlagPrototyped, isOptimized: false, variables: !28)
