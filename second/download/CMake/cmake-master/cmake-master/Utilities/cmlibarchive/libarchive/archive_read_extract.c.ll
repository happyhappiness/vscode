; ModuleID = '/data/download/cmake/cmake-master/Utilities/cmlibarchive/libarchive/archive_read_extract.c'
...
define i32 @archive_read_extract(%struct.archive* %_a, %struct.archive_entry* %entry1, i32 %flags) #0 !dbg !292 {
entry:
  ...
  call void @llvm.dbg.declare(metadata %struct.archive_entry** %entry.addr, metadata !301, metadata !299), !dbg !302
  store i32 %flags, i32* %flags.addr, align 4
  call void @llvm.dbg.declare(metadata i32* %flags.addr, metadata !303, metadata !299), !dbg !304
  call void @llvm.dbg.declare(metadata %struct.archive_read_extract** %extract, metadata !305, metadata !299), !dbg !306
  call void @llvm.dbg.declare(metadata %struct.archive_read** %a, metadata !307, metadata !299), !dbg !308
  %0 = load %struct.archive*, %struct.archive** %_a.addr, align 8, !dbg !309
  %1 = bitcast %struct.archive* %0 to %struct.archive_read*, !dbg !310
  store %struct.archive_read* %1, %struct.archive_read** %a, align 8, !dbg !308
  %2 = load %struct.archive_read*, %struct.archive_read** %a, align 8, !dbg !311
  %call = call %struct.archive_read_extract* @__archive_read_get_extract(%struct.archive_read* %2), !dbg !312
  store %struct.archive_read_extract* %call, %struct.archive_read_extract** %extract, align 8, !dbg !313
  %3 = load %struct.archive_read_extract*, %struct.archive_read_extract** %extract, align 8, !dbg !314
  %cmp = icmp eq %struct.archive_read_extract* %3, null, !dbg !316
  br i1 %cmp, label %if.then, label %if.end, !dbg !317

if.then:                                          ; preds = %entry
  store i32 -30, i32* %retval, align 4, !dbg !318
  br label %return, !dbg !318

if.end:                                           ; preds = %entry
  %4 = load %struct.archive_read_extract*, %struct.archive_read_extract** %extract, align 8, !dbg !319
  %ad = getelementptr inbounds %struct.archive_read_extract, %struct.archive_read_extract* %4, i32 0, i32 0, !dbg !321
  %5 = load %struct.archive*, %struct.archive** %ad, align 8, !dbg !321
  %cmp2 = icmp eq %struct.archive* %5, null, !dbg !322
  br i1 %cmp2, label %if.then3, label %if.end12, !dbg !323

if.then3:                                         ; preds = %if.end
  %call4 = call %struct.archive* @archive_write_disk_new(), !dbg !324
  %6 = load %struct.archive_read_extract*, %struct.archive_read_extract** %extract, align 8, !dbg !326
  %ad5 = getelementptr inbounds %struct.archive_read_extract, %struct.archive_read_extract* %6, i32 0, i32 0, !dbg !327
  store %struct.archive* %call4, %struct.archive** %ad5, align 8, !dbg !328
  %7 = load %struct.archive_read_extract*, %struct.archive_read_extract** %extract, align 8, !dbg !329
  %ad6 = getelementptr inbounds %struct.archive_read_extract, %struct.archive_read_extract* %7, i32 0, i32 0, !dbg !331
  %8 = load %struct.archive*, %struct.archive** %ad6, align 8, !dbg !331
  %cmp7 = icmp eq %struct.archive* %8, null, !dbg !332
  br i1 %cmp7, label %if.then8, label %if.end9, !dbg !333

if.then8:                                         ; preds = %if.then3
  %9 = load %struct.archive_read*, %struct.archive_read** %a, align 8, !dbg !334
  %archive = getelementptr inbounds %struct.archive_read, %struct.archive_read* %9, i32 0, i32 0, !dbg !336
  call void (%struct.archive*, i32, i8*, ...) @archive_set_error(%struct.archive* %archive, i32 12, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str, i32 0, i32 0)), !dbg !337
  store i32 -30, i32* %retval, align 4, !dbg !338
  br label %return, !dbg !338

if.end9:                                          ; preds = %if.then3
  %10 = load %struct.archive_read_extract*, %struct.archive_read_extract** %extract, align 8, !dbg !339
  %ad10 = getelementptr inbounds %struct.archive_read_extract, %struct.archive_read_extract* %10, i32 0, i32 0, !dbg !340
  %11 = load %struct.archive*, %struct.archive** %ad10, align 8, !dbg !340
  %call11 = call i32 @archive_write_disk_set_standard_lookup(%struct.archive* %11), !dbg !341
  br label %if.end12, !dbg !342

if.end12:                                         ; preds = %if.end9, %if.end
  %12 = load %struct.archive_read_extract*, %struct.archive_read_extract** %extract, align 8, !dbg !343
  %ad13 = getelementptr inbounds %struct.archive_read_extract, %struct.archive_read_extract* %12, i32 0, i32 0, !dbg !344
  %13 = load %struct.archive*, %struct.archive** %ad13, align 8, !dbg !344
  %14 = load i32, i32* %flags.addr, align 4, !dbg !345
  %call14 = call i32 @archive_write_disk_set_options(%struct.archive* %13, i32 %14), !dbg !346
  %15 = load %struct.archive_read*, %struct.archive_read** %a, align 8, !dbg !347
  %archive15 = getelementptr inbounds %struct.archive_read, %struct.archive_read* %15, i32 0, i32 0, !dbg !348
  %16 = load %struct.archive_entry*, %struct.archive_entry** %entry.addr, align 8, !dbg !349
  %17 = load %struct.archive_read_extract*, %struct.archive_read_extract** %extract, align 8, !dbg !350
  %ad16 = getelementptr inbounds %struct.archive_read_extract, %struct.archive_read_extract* %17, i32 0, i32 0, !dbg !351
  %18 = load %struct.archive*, %struct.archive** %ad16, align 8, !dbg !351
  %call17 = call i32 @archive_read_extract2(%struct.archive* %archive15, %struct.archive_entry* %16, %struct.archive* %18), !dbg !352
  store i32 %call17, i32* %retval, align 4, !dbg !353
  br label %return, !dbg !353

return:                                           ; preds = %if.end12, %if.then8, %if.then
  %19 = load i32, i32* %retval, align 4, !dbg !354
  ret i32 %19, !dbg !354
}
...
declare %struct.archive_read_extract* @__archive_read_get_extract(%struct.archive_read*) #2

declare %struct.archive* @archive_write_disk_new() #2

declare void @archive_set_error(%struct.archive*, i32, i8*, ...) #2

declare i32 @archive_write_disk_set_standard_lookup(%struct.archive*) #2

declare i32 @archive_write_disk_set_options(%struct.archive*, i32) #2

declare i32 @archive_read_extract2(%struct.archive*, %struct.archive_entry*, %struct.archive*) #2
...
!1 = !DIFile(filename: "/data/download/cmake/cmake-master/Utilities/cmlibarchive/libarchive/archive_read_extract.c", directory: "/data/download/cmake/cmake-master/Utilities/cmlibarchive/libarchive")
!2 = !{}
!3 = !{!4, !122}
...
!291 = !{!292}
!292 = distinct !DISubprogram(name: "archive_read_extract", scope: !1, file: !1, line: 39, type: !293, isLocal: false, isDefinition: true, scopeLine: 40, flags: DIFlagPrototyped, isOptimized: false, variables: !2)
!293 = !DISubroutineType(types: !294)
!294 = !{!23, !24, !30, !23}
!295 = !{i32 2, !"Dwarf Version", i32 4}
!296 = !{i32 2, !"Debug Info Version", i32 3}
!297 = !{!"clang version 3.8.0 (tags/RELEASE_380/final)"}
!298 = !DILocalVariable(name: "_a", arg: 1, scope: !292, file: !1, line: 39, type: !24)
!299 = !DIExpression()
!300 = !DILocation(line: 39, column: 38, scope: !292)
!301 = !DILocalVariable(name: "entry", arg: 2, scope: !292, file: !1, line: 39, type: !30)
!302 = !DILocation(line: 39, column: 64, scope: !292)
!303 = !DILocalVariable(name: "flags", arg: 3, scope: !292, file: !1, line: 39, type: !23)
!304 = !DILocation(line: 39, column: 75, scope: !292)
!305 = !DILocalVariable(name: "extract", scope: !292, file: !1, line: 41, type: !263)
!306 = !DILocation(line: 41, column: 31, scope: !292)
!307 = !DILocalVariable(name: "a", scope: !292, file: !1, line: 42, type: !4)
!308 = !DILocation(line: 42, column: 24, scope: !292)
!309 = !DILocation(line: 42, column: 51, scope: !292)
!310 = !DILocation(line: 42, column: 28, scope: !292)
!311 = !DILocation(line: 44, column: 39, scope: !292)
!312 = !DILocation(line: 44, column: 12, scope: !292)
!313 = !DILocation(line: 44, column: 10, scope: !292)
!314 = !DILocation(line: 45, column: 6, scope: !315)
!315 = distinct !DILexicalBlock(scope: !292, file: !1, line: 45, column: 6)
!316 = !DILocation(line: 45, column: 14, scope: !315)
!317 = !DILocation(line: 45, column: 6, scope: !292)
!318 = !DILocation(line: 46, column: 3, scope: !315)
!319 = !DILocation(line: 49, column: 6, scope: !320)
!320 = distinct !DILexicalBlock(scope: !292, file: !1, line: 49, column: 6)
!321 = !DILocation(line: 49, column: 15, scope: !320)
!322 = !DILocation(line: 49, column: 18, scope: !320)
!323 = !DILocation(line: 49, column: 6, scope: !292)
!324 = !DILocation(line: 50, column: 17, scope: !325)
!325 = distinct !DILexicalBlock(scope: !320, file: !1, line: 49, column: 27)
!326 = !DILocation(line: 50, column: 3, scope: !325)
!327 = !DILocation(line: 50, column: 12, scope: !325)
!328 = !DILocation(line: 50, column: 15, scope: !325)
!329 = !DILocation(line: 51, column: 7, scope: !330)
!330 = distinct !DILexicalBlock(scope: !325, file: !1, line: 51, column: 7)
!331 = !DILocation(line: 51, column: 16, scope: !330)
!332 = !DILocation(line: 51, column: 19, scope: !330)
!333 = !DILocation(line: 51, column: 7, scope: !325)
!334 = !DILocation(line: 52, column: 23, scope: !335)
!335 = distinct !DILexicalBlock(scope: !330, file: !1, line: 51, column: 28)
!336 = !DILocation(line: 52, column: 26, scope: !335)
!337 = !DILocation(line: 52, column: 4, scope: !335)
!338 = !DILocation(line: 53, column: 4, scope: !335)
!339 = !DILocation(line: 55, column: 42, scope: !325)
!340 = !DILocation(line: 55, column: 51, scope: !325)
!341 = !DILocation(line: 55, column: 3, scope: !325)
!342 = !DILocation(line: 56, column: 2, scope: !325)
!343 = !DILocation(line: 58, column: 33, scope: !292)
!344 = !DILocation(line: 58, column: 42, scope: !292)
!345 = !DILocation(line: 58, column: 46, scope: !292)
!346 = !DILocation(line: 58, column: 2, scope: !292)
!347 = !DILocation(line: 59, column: 33, scope: !292)
!348 = !DILocation(line: 59, column: 36, scope: !292)
!349 = !DILocation(line: 59, column: 45, scope: !292)
!350 = !DILocation(line: 59, column: 52, scope: !292)
!351 = !DILocation(line: 59, column: 61, scope: !292)
!352 = !DILocation(line: 59, column: 10, scope: !292)
!353 = !DILocation(line: 59, column: 2, scope: !292)
!354 = !DILocation(line: 60, column: 1, scope: !292)
