; ModuleID = '/data/download/cmake/cmake-master/Utilities/cmlibarchive/libarchive/archive_read_support_filter_lrzip.c'
...
@.str.3 = private unnamed_addr constant [5 x i8] c"LRZI\00", align 1
@.str.4 = private unnamed_addr constant [12 x i8] c"lrzip -d -q\00", align 1

; Function Attrs: nounwind uwtable
define i32 @archive_read_support_filter_lrzip(%struct.archive* %_a) #0 !dbg !292 {
entry:
  ...
  call void @llvm.dbg.declare(metadata %struct.archive_read_filter_bidder** %reader, metadata !306, metadata !300), !dbg !307
...
do.end:                                           ; preds = %if.end
  ...
  %call1 = call i32 @__archive_read_get_bidder(%struct.archive_read* %4, %struct.archive_read_filter_bidder** %reader), !dbg !321
  %cmp2 = icmp ne i32 %call1, 0, !dbg !322
  br i1 %cmp2, label %if.then3, label %if.end4, !dbg !323

if.then3:                                         ; preds = %do.end
  store i32 -30, i32* %retval, align 4, !dbg !324
  br label %return, !dbg !324

if.end4:                                          ; preds = %do.end
  %5 = load %struct.archive_read_filter_bidder*, %struct.archive_read_filter_bidder** %reader, align 8, !dbg !325
  %data = getelementptr inbounds %struct.archive_read_filter_bidder, %struct.archive_read_filter_bidder* %5, i32 0, i32 0, !dbg !326
  store i8* null, i8** %data, align 8, !dbg !327
  %6 = load %struct.archive_read_filter_bidder*, %struct.archive_read_filter_bidder** %reader, align 8, !dbg !328
  %name = getelementptr inbounds %struct.archive_read_filter_bidder, %struct.archive_read_filter_bidder* %6, i32 0, i32 1, !dbg !329
  store i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i32 0, i32 0), i8** %name, align 8, !dbg !330
  %7 = load %struct.archive_read_filter_bidder*, %struct.archive_read_filter_bidder** %reader, align 8, !dbg !331
  %bid = getelementptr inbounds %struct.archive_read_filter_bidder, %struct.archive_read_filter_bidder* %7, i32 0, i32 2, !dbg !332
  store i32 (%struct.archive_read_filter_bidder*, %struct.archive_read_filter*)* @lrzip_bidder_bid, i32 (%struct.archive_read_filter_bidder*, %struct.archive_read_filter*)** %bid, align 8, !dbg !333
  %8 = load %struct.archive_read_filter_bidder*, %struct.archive_read_filter_bidder** %reader, align 8, !dbg !334
  %init = getelementptr inbounds %struct.archive_read_filter_bidder, %struct.archive_read_filter_bidder* %8, i32 0, i32 3, !dbg !335
  store i32 (%struct.archive_read_filter*)* @lrzip_bidder_init, i32 (%struct.archive_read_filter*)** %init, align 8, !dbg !336
  %9 = load %struct.archive_read_filter_bidder*, %struct.archive_read_filter_bidder** %reader, align 8, !dbg !337
  %options = getelementptr inbounds %struct.archive_read_filter_bidder, %struct.archive_read_filter_bidder* %9, i32 0, i32 4, !dbg !338
  store i32 (%struct.archive_read_filter_bidder*, i8*, i8*)* null, i32 (%struct.archive_read_filter_bidder*, i8*, i8*)** %options, align 8, !dbg !339
  %10 = load %struct.archive_read_filter_bidder*, %struct.archive_read_filter_bidder** %reader, align 8, !dbg !340
  %free = getelementptr inbounds %struct.archive_read_filter_bidder, %struct.archive_read_filter_bidder* %10, i32 0, i32 5, !dbg !341
  store i32 (%struct.archive_read_filter_bidder*)* @lrzip_reader_free, i32 (%struct.archive_read_filter_bidder*)** %free, align 8, !dbg !342
  %11 = load %struct.archive*, %struct.archive** %_a.addr, align 8, !dbg !343
  call void (%struct.archive*, i32, i8*, ...) @archive_set_error(%struct.archive* %11, i32 -1, i8* getelementptr inbounds ([53 x i8], [53 x i8]* @.str.2, i32 0, i32 0)), !dbg !344
...
; Function Attrs: nounwind uwtable
define internal i32 @lrzip_bidder_bid(%struct.archive_read_filter_bidder* %self, %struct.archive_read_filter* %filter) #0 !dbg !294 {
entry:
  %retval = alloca i32, align 4
  ...
  call void @llvm.dbg.declare(metadata %struct.archive_read_filter_bidder** %self.addr, metadata !347, metadata !300), !dbg !348
  store %struct.archive_read_filter* %filter, %struct.archive_read_filter** %filter.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.archive_read_filter** %filter.addr, metadata !349, metadata !300), !dbg !350
  call void @llvm.dbg.declare(metadata i8** %p, metadata !351, metadata !300), !dbg !355
  call void @llvm.dbg.declare(metadata i64* %avail, metadata !356, metadata !300), !dbg !357
  call void @llvm.dbg.declare(metadata i64* %len, metadata !358, metadata !300), !dbg !359
  call void @llvm.dbg.declare(metadata i32* %i, metadata !360, metadata !300), !dbg !361
  %0 = load %struct.archive_read_filter_bidder*, %struct.archive_read_filter_bidder** %self.addr, align 8, !dbg !362
  store i64 6, i64* %len, align 8, !dbg !363
  %1 = load %struct.archive_read_filter*, %struct.archive_read_filter** %filter.addr, align 8, !dbg !364
  %2 = load i64, i64* %len, align 8, !dbg !365
  %call = call i8* @__archive_read_filter_ahead(%struct.archive_read_filter* %1, i64 %2, i64* %avail), !dbg !366
  store i8* %call, i8** %p, align 8, !dbg !367
  %3 = load i8*, i8** %p, align 8, !dbg !368
  %cmp = icmp eq i8* %3, null, !dbg !370
  br i1 %cmp, label %if.then, label %lor.lhs.false, !dbg !371

lor.lhs.false:                                    ; preds = %entry
  %4 = load i64, i64* %avail, align 8, !dbg !372
  %cmp1 = icmp eq i64 %4, 0, !dbg !374
...
if.end:                                           ; preds = %lor.lhs.false
  %5 = load i8*, i8** %p, align 8, !dbg !377
  %call2 = call i32 @memcmp(i8* %5, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i32 0, i32 0), i64 4) #4, !dbg !379
  %tobool = icmp ne i32 %call2, 0, !dbg !379
  br i1 %tobool, label %if.then3, label %if.end4, !dbg !380
...
if.end4:                                          ; preds = %if.end
  ...
  %arrayidx = getelementptr inbounds i8, i8* %6, i64 4, !dbg !382
  %7 = load i8, i8* %arrayidx, align 1, !dbg !382
  %tobool5 = icmp ne i8 %7, 0, !dbg !382
  br i1 %tobool5, label %if.then6, label %if.end7, !dbg !384
...
if.end7:                                          ; preds = %if.end4
  %8 = load i8*, i8** %p, align 8, !dbg !386
  %arrayidx8 = getelementptr inbounds i8, i8* %8, i64 5, !dbg !386
  %9 = load i8, i8* %arrayidx8, align 1, !dbg !386
  %conv = zext i8 %9 to i32, !dbg !386
  store i32 %conv, i32* %i, align 4, !dbg !387
  %10 = load i32, i32* %i, align 4, !dbg !388
  %cmp9 = icmp slt i32 %10, 6, !dbg !390
  br i1 %cmp9, label %if.then14, label %lor.lhs.false11, !dbg !391

lor.lhs.false11:                                  ; preds = %if.end7
  %11 = load i32, i32* %i, align 4, !dbg !392
  %cmp12 = icmp sgt i32 %11, 10, !dbg !394
  br i1 %cmp12, label %if.then14, label %if.end15, !dbg !395
...
if.end15:                                         ; preds = %lor.lhs.false11
  ...
  %conv16 = trunc i64 %12 to i32, !dbg !398
  store i32 %conv16, i32* %retval, align 4, !dbg !399
  br label %return, !dbg !399

return:                                           ; preds = %if.end15, %if.then14, %if.then6, %if.then3, %if.then
  %13 = load i32, i32* %retval, align 4, !dbg !400
  ret i32 %13, !dbg !400
}

; Function Attrs: nounwind uwtable
define internal i32 @lrzip_bidder_init(%struct.archive_read_filter* %self) #0 !dbg !295 {
entry:
  ...
  call void @llvm.dbg.declare(metadata %struct.archive_read_filter** %self.addr, metadata !401, metadata !300), !dbg !402
  call void @llvm.dbg.declare(metadata i32* %r, metadata !403, metadata !300), !dbg !404
  %0 = load %struct.archive_read_filter*, %struct.archive_read_filter** %self.addr, align 8, !dbg !405
  %call = call i32 @__archive_read_program(%struct.archive_read_filter* %0, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.4, i32 0, i32 0)), !dbg !406
  store i32 %call, i32* %r, align 4, !dbg !407
  %1 = load %struct.archive_read_filter*, %struct.archive_read_filter** %self.addr, align 8, !dbg !408
  %code = getelementptr inbounds %struct.archive_read_filter, %struct.archive_read_filter* %1, i32 0, i32 12, !dbg !409
  store i32 10, i32* %code, align 8, !dbg !410
  %2 = load %struct.archive_read_filter*, %struct.archive_read_filter** %self.addr, align 8, !dbg !411
  %name = getelementptr inbounds %struct.archive_read_filter, %struct.archive_read_filter* %2, i32 0, i32 11, !dbg !412
  store i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i32 0, i32 0), i8** %name, align 8, !dbg !413
  %3 = load i32, i32* %r, align 4, !dbg !414
  ret i32 %3, !dbg !415
}

; Function Attrs: nounwind uwtable
define internal i32 @lrzip_reader_free(%struct.archive_read_filter_bidder* %self) #0 !dbg !293 {
entry:
  %self.addr = alloca %struct.archive_read_filter_bidder*, align 8
  store %struct.archive_read_filter_bidder* %self, %struct.archive_read_filter_bidder** %self.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.archive_read_filter_bidder** %self.addr, metadata !416, metadata !300), !dbg !417
  %0 = load %struct.archive_read_filter_bidder*, %struct.archive_read_filter_bidder** %self.addr, align 8, !dbg !418
  ret i32 0, !dbg !419
}
...
!1 = !DIFile(filename: "/data/download/cmake/cmake-master/Utilities/cmlibarchive/libarchive/archive_read_support_filter_lrzip.c", directory: "/data/download/cmake/cmake-master/Utilities/cmlibarchive/libarchive")
!2 = !{}
!3 = !{!4, !122, !23}
...
!291 = !{!292, !293, !294, !295}
!292 = distinct !DISubprogram(name: "archive_read_support_filter_lrzip", scope: !1, file: !1, line: 64, type: !21, isLocal: false, isDefinition: true, scopeLine: 65, flags: DIFlagPrototyped, isOptimized: false, variables: !2)
!293 = distinct !DISubprogram(name: "lrzip_reader_free", scope: !1, file: !1, line: 57, type: !218, isLocal: true, isDefinition: true, scopeLine: 58, flags: DIFlagPrototyped, isOptimized: false, variables: !2)
!294 = distinct !DISubprogram(name: "lrzip_bidder_bid", scope: !1, file: !1, line: 91, type: !166, isLocal: true, isDefinition: true, scopeLine: 93, flags: DIFlagPrototyped, isOptimized: false, variables: !2)
!295 = distinct !DISubprogram(name: "lrzip_bidder_init", scope: !1, file: !1, line: 121, type: !178, isLocal: true, isDefinition: true, scopeLine: 122, flags: DIFlagPrototyped, isOptimized: false, variables: !2)
!296 = !{i32 2, !"Dwarf Version", i32 4}
!297 = !{i32 2, !"Debug Info Version", i32 3}
!298 = !{!"clang version 3.8.0 (tags/RELEASE_380/final)"}
!299 = !DILocalVariable(name: "_a", arg: 1, scope: !292, file: !1, line: 64, type: !24)
!300 = !DIExpression()
!301 = !DILocation(line: 64, column: 51, scope: !292)
!302 = !DILocalVariable(name: "a", scope: !292, file: !1, line: 66, type: !4)
!303 = !DILocation(line: 66, column: 23, scope: !292)
!304 = !DILocation(line: 66, column: 50, scope: !292)
!305 = !DILocation(line: 66, column: 27, scope: !292)
!306 = !DILocalVariable(name: "reader", scope: !292, file: !1, line: 67, type: !168)
!307 = !DILocation(line: 67, column: 37, scope: !292)
!308 = !DILocation(line: 69, column: 2, scope: !292)
!309 = !DILocalVariable(name: "magic_test", scope: !310, file: !1, line: 69, type: !23)
!310 = distinct !DILexicalBlock(scope: !292, file: !1, line: 69, column: 2)
!311 = !DILocation(line: 69, column: 2, scope: !310)
!312 = !DILocation(line: 69, column: 2, scope: !313)
!313 = !DILexicalBlockFile(scope: !310, file: !1, discriminator: 1)
!314 = !DILocation(line: 69, column: 2, scope: !315)
!315 = !DILexicalBlockFile(scope: !316, file: !1, discriminator: 2)
!316 = distinct !DILexicalBlock(scope: !310, file: !1, line: 69, column: 2)
!317 = !DILocation(line: 69, column: 2, scope: !318)
!318 = !DILexicalBlockFile(scope: !310, file: !1, discriminator: 3)
!319 = !DILocation(line: 72, column: 32, scope: !320)
!320 = distinct !DILexicalBlock(scope: !292, file: !1, line: 72, column: 6)
!321 = !DILocation(line: 72, column: 6, scope: !320)
!322 = !DILocation(line: 72, column: 44, scope: !320)
!323 = !DILocation(line: 72, column: 6, scope: !292)
!324 = !DILocation(line: 73, column: 3, scope: !320)
!325 = !DILocation(line: 75, column: 2, scope: !292)
!326 = !DILocation(line: 75, column: 10, scope: !292)
!327 = !DILocation(line: 75, column: 15, scope: !292)
!328 = !DILocation(line: 76, column: 2, scope: !292)
!329 = !DILocation(line: 76, column: 10, scope: !292)
!330 = !DILocation(line: 76, column: 15, scope: !292)
!331 = !DILocation(line: 77, column: 2, scope: !292)
!332 = !DILocation(line: 77, column: 10, scope: !292)
!333 = !DILocation(line: 77, column: 14, scope: !292)
!334 = !DILocation(line: 78, column: 2, scope: !292)
!335 = !DILocation(line: 78, column: 10, scope: !292)
!336 = !DILocation(line: 78, column: 15, scope: !292)
!337 = !DILocation(line: 79, column: 2, scope: !292)
!338 = !DILocation(line: 79, column: 10, scope: !292)
!339 = !DILocation(line: 79, column: 18, scope: !292)
!340 = !DILocation(line: 80, column: 2, scope: !292)
!341 = !DILocation(line: 80, column: 10, scope: !292)
!342 = !DILocation(line: 80, column: 15, scope: !292)
!343 = !DILocation(line: 82, column: 20, scope: !292)
!344 = !DILocation(line: 82, column: 2, scope: !292)
!345 = !DILocation(line: 84, column: 2, scope: !292)
!346 = !DILocation(line: 85, column: 1, scope: !292)
!347 = !DILocalVariable(name: "self", arg: 1, scope: !294, file: !1, line: 91, type: !168)
!348 = !DILocation(line: 91, column: 53, scope: !294)
!349 = !DILocalVariable(name: "filter", arg: 2, scope: !294, file: !1, line: 92, type: !169)
!350 = !DILocation(line: 92, column: 33, scope: !294)
!351 = !DILocalVariable(name: "p", scope: !294, file: !1, line: 94, type: !352)
...
!355 = !DILocation(line: 94, column: 23, scope: !294)
!356 = !DILocalVariable(name: "avail", scope: !294, file: !1, line: 95, type: !38)
!357 = !DILocation(line: 95, column: 10, scope: !294)
!358 = !DILocalVariable(name: "len", scope: !294, file: !1, line: 95, type: !38)
!359 = !DILocation(line: 95, column: 17, scope: !294)
!360 = !DILocalVariable(name: "i", scope: !294, file: !1, line: 96, type: !23)
!361 = !DILocation(line: 96, column: 6, scope: !294)
!362 = !DILocation(line: 98, column: 8, scope: !294)
!363 = !DILocation(line: 101, column: 6, scope: !294)
!364 = !DILocation(line: 102, column: 34, scope: !294)
!365 = !DILocation(line: 102, column: 42, scope: !294)
!366 = !DILocation(line: 102, column: 6, scope: !294)
!367 = !DILocation(line: 102, column: 4, scope: !294)
!368 = !DILocation(line: 103, column: 6, scope: !369)
!369 = distinct !DILexicalBlock(scope: !294, file: !1, line: 103, column: 6)
!370 = !DILocation(line: 103, column: 8, scope: !369)
!371 = !DILocation(line: 103, column: 16, scope: !369)
!372 = !DILocation(line: 103, column: 19, scope: !373)
!373 = !DILexicalBlockFile(scope: !369, file: !1, discriminator: 1)
!374 = !DILocation(line: 103, column: 25, scope: !373)
!375 = !DILocation(line: 103, column: 6, scope: !373)
!376 = !DILocation(line: 104, column: 3, scope: !369)
!377 = !DILocation(line: 106, column: 13, scope: !378)
!378 = distinct !DILexicalBlock(scope: !294, file: !1, line: 106, column: 6)
!379 = !DILocation(line: 106, column: 6, scope: !378)
!380 = !DILocation(line: 106, column: 6, scope: !294)
!381 = !DILocation(line: 107, column: 3, scope: !378)
!382 = !DILocation(line: 110, column: 6, scope: !383)
!383 = distinct !DILexicalBlock(scope: !294, file: !1, line: 110, column: 6)
!384 = !DILocation(line: 110, column: 6, scope: !294)
!385 = !DILocation(line: 111, column: 3, scope: !383)
!386 = !DILocation(line: 113, column: 6, scope: !294)
!387 = !DILocation(line: 113, column: 4, scope: !294)
!388 = !DILocation(line: 114, column: 7, scope: !389)
!389 = distinct !DILexicalBlock(scope: !294, file: !1, line: 114, column: 6)
!390 = !DILocation(line: 114, column: 9, scope: !389)
!391 = !DILocation(line: 114, column: 14, scope: !389)
!392 = !DILocation(line: 114, column: 18, scope: !393)
!393 = !DILexicalBlockFile(scope: !389, file: !1, discriminator: 1)
!394 = !DILocation(line: 114, column: 20, scope: !393)
!395 = !DILocation(line: 114, column: 6, scope: !393)
!396 = !DILocation(line: 115, column: 3, scope: !389)
!397 = !DILocation(line: 117, column: 14, scope: !294)
!398 = !DILocation(line: 117, column: 9, scope: !294)
!399 = !DILocation(line: 117, column: 2, scope: !294)
!400 = !DILocation(line: 118, column: 1, scope: !294)
!401 = !DILocalVariable(name: "self", arg: 1, scope: !295, file: !1, line: 121, type: !169)
!402 = !DILocation(line: 121, column: 47, scope: !295)
!403 = !DILocalVariable(name: "r", scope: !295, file: !1, line: 123, type: !23)
!404 = !DILocation(line: 123, column: 6, scope: !295)
!405 = !DILocation(line: 125, column: 29, scope: !295)
!406 = !DILocation(line: 125, column: 6, scope: !295)
!407 = !DILocation(line: 125, column: 4, scope: !295)
!408 = !DILocation(line: 129, column: 2, scope: !295)
!409 = !DILocation(line: 129, column: 8, scope: !295)
!410 = !DILocation(line: 129, column: 13, scope: !295)
!411 = !DILocation(line: 130, column: 2, scope: !295)
!412 = !DILocation(line: 130, column: 8, scope: !295)
!413 = !DILocation(line: 130, column: 13, scope: !295)
!414 = !DILocation(line: 131, column: 10, scope: !295)
!415 = !DILocation(line: 131, column: 2, scope: !295)
!416 = !DILocalVariable(name: "self", arg: 1, scope: !293, file: !1, line: 57, type: !168)
!417 = !DILocation(line: 57, column: 54, scope: !293)
!418 = !DILocation(line: 59, column: 8, scope: !293)
!419 = !DILocation(line: 60, column: 2, scope: !293)
