; ModuleID = '/data/download/cmake/cmake-master/Utilities/cmlibarchive/libarchive/archive_read_support_filter_none.c'
...
define i32 @archive_read_support_compression_none(%struct.archive* %a) #0 !dbg !4 {
entry:
  ...
  %call = call i32 @archive_read_support_filter_none(%struct.archive* %0), !dbg !114
...
; Function Attrs: nounwind uwtable
define i32 @archive_read_support_filter_none(%struct.archive* %a) #0 !dbg !106 {
entry:
...
do.body:                                          ; preds = %entry
  ...
  %call = call i32 @__archive_check_magic(%struct.archive* %0, i32 14594245, i32 1, i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str, i32 0, i32 0)), !dbg !122
...
return:                                           ; preds = %do.end, %if.then
  %2 = load i32, i32* %retval, align 4, !dbg !130
  ret i32 %2, !dbg !130
}
...
!1 = !DIFile(filename: "/data/download/cmake/cmake-master/Utilities/cmlibarchive/libarchive/archive_read_support_filter_none.c", directory: "/data/download/cmake/cmake-master/Utilities/cmlibarchive/libarchive")
!2 = !{}
!3 = !{!4, !106}
!4 = distinct !DISubprogram(name: "archive_read_support_compression_none", scope: !1, file: !1, line: 35, type: !5, isLocal: false, isDefinition: true, scopeLine: 36, flags: DIFlagPrototyped, isOptimized: false, variables: !2)
...
!106 = distinct !DISubprogram(name: "archive_read_support_filter_none", scope: !1, file: !1, line: 46, type: !5, isLocal: false, isDefinition: true, scopeLine: 47, flags: DIFlagPrototyped, isOptimized: false, variables: !2)
...
!111 = !DIExpression()
!112 = !DILocation(line: 35, column: 55, scope: !4)
!113 = !DILocation(line: 37, column: 42, scope: !4)
!114 = !DILocation(line: 37, column: 9, scope: !4)
!115 = !DILocation(line: 37, column: 2, scope: !4)
!116 = !DILocalVariable(name: "a", arg: 1, scope: !106, file: !1, line: 46, type: !8)
!117 = !DILocation(line: 46, column: 50, scope: !106)
!118 = !DILocation(line: 48, column: 2, scope: !106)
!119 = !DILocalVariable(name: "magic_test", scope: !120, file: !1, line: 48, type: !7)
!120 = distinct !DILexicalBlock(scope: !106, file: !1, line: 48, column: 2)
!121 = !DILocation(line: 48, column: 2, scope: !120)
!122 = !DILocation(line: 48, column: 2, scope: !123)
!123 = !DILexicalBlockFile(scope: !120, file: !1, discriminator: 1)
!124 = !DILocation(line: 48, column: 2, scope: !125)
!125 = !DILexicalBlockFile(scope: !126, file: !1, discriminator: 2)
!126 = distinct !DILexicalBlock(scope: !120, file: !1, line: 48, column: 2)
!127 = !DILocation(line: 48, column: 2, scope: !128)
!128 = !DILexicalBlockFile(scope: !120, file: !1, discriminator: 3)
!129 = !DILocation(line: 51, column: 2, scope: !106)
!130 = !DILocation(line: 52, column: 1, scope: !106)
