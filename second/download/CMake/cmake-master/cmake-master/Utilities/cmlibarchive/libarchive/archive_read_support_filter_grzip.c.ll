; ModuleID = '/data/download/cmake/cmake-master/Utilities/cmlibarchive/libarchive/archive_read_support_filter_grzip.c'
...
@.str.2 = private unnamed_addr constant [9 x i8] c"grzip -d\00", align 1
@.str.3 = private unnamed_addr constant [6 x i8] c"grzip\00", align 1

; Function Attrs: nounwind uwtable
define i32 @archive_read_support_filter_grzip(%struct.archive* %_a) #0 !dbg !292 {
entry:
  ...
  call void @llvm.dbg.declare(metadata %struct.archive** %_a.addr, metadata !306, metadata !307), !dbg !308
  call void @llvm.dbg.declare(metadata %struct.archive_read** %a, metadata !309, metadata !307), !dbg !310
  %0 = load %struct.archive*, %struct.archive** %_a.addr, align 8, !dbg !311
  %1 = bitcast %struct.archive* %0 to %struct.archive_read*, !dbg !312
  store %struct.archive_read* %1, %struct.archive_read** %a, align 8, !dbg !310
  call void @llvm.dbg.declare(metadata %struct.archive_read_filter_bidder** %reader, metadata !313, metadata !307), !dbg !314
  br label %do.body, !dbg !315

do.body:                                          ; preds = %entry
  call void @llvm.dbg.declare(metadata i32* %magic_test, metadata !316, metadata !307), !dbg !318
  %2 = load %struct.archive*, %struct.archive** %_a.addr, align 8, !dbg !319
  %call = call i32 @__archive_check_magic(%struct.archive* %2, i32 14594245, i32 1, i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i32 0, i32 0)), !dbg !319
  store i32 %call, i32* %magic_test, align 4, !dbg !319
  %3 = load i32, i32* %magic_test, align 4, !dbg !319
  %cmp = icmp eq i32 %3, -30, !dbg !319
  br i1 %cmp, label %if.then, label %if.end, !dbg !319

if.then:                                          ; preds = %do.body
  store i32 -30, i32* %retval, align 4, !dbg !321
...
do.end:                                           ; preds = %if.end
  %4 = load %struct.archive_read*, %struct.archive_read** %a, align 8, !dbg !326
  %call1 = call i32 @__archive_read_get_bidder(%struct.archive_read* %4, %struct.archive_read_filter_bidder** %reader), !dbg !328
  %cmp2 = icmp ne i32 %call1, 0, !dbg !329
  br i1 %cmp2, label %if.then3, label %if.end4, !dbg !330

if.then3:                                         ; preds = %do.end
  store i32 -30, i32* %retval, align 4, !dbg !331
  br label %return, !dbg !331

if.end4:                                          ; preds = %do.end
  %5 = load %struct.archive_read_filter_bidder*, %struct.archive_read_filter_bidder** %reader, align 8, !dbg !332
  %data = getelementptr inbounds %struct.archive_read_filter_bidder, %struct.archive_read_filter_bidder* %5, i32 0, i32 0, !dbg !333
  store i8* null, i8** %data, align 8, !dbg !334
  %6 = load %struct.archive_read_filter_bidder*, %struct.archive_read_filter_bidder** %reader, align 8, !dbg !335
  %bid = getelementptr inbounds %struct.archive_read_filter_bidder, %struct.archive_read_filter_bidder* %6, i32 0, i32 2, !dbg !336
  store i32 (%struct.archive_read_filter_bidder*, %struct.archive_read_filter*)* @grzip_bidder_bid, i32 (%struct.archive_read_filter_bidder*, %struct.archive_read_filter*)** %bid, align 8, !dbg !337
  %7 = load %struct.archive_read_filter_bidder*, %struct.archive_read_filter_bidder** %reader, align 8, !dbg !338
  %init = getelementptr inbounds %struct.archive_read_filter_bidder, %struct.archive_read_filter_bidder* %7, i32 0, i32 3, !dbg !339
  store i32 (%struct.archive_read_filter*)* @grzip_bidder_init, i32 (%struct.archive_read_filter*)** %init, align 8, !dbg !340
  %8 = load %struct.archive_read_filter_bidder*, %struct.archive_read_filter_bidder** %reader, align 8, !dbg !341
  %options = getelementptr inbounds %struct.archive_read_filter_bidder, %struct.archive_read_filter_bidder* %8, i32 0, i32 4, !dbg !342
  store i32 (%struct.archive_read_filter_bidder*, i8*, i8*)* null, i32 (%struct.archive_read_filter_bidder*, i8*, i8*)** %options, align 8, !dbg !343
  %9 = load %struct.archive_read_filter_bidder*, %struct.archive_read_filter_bidder** %reader, align 8, !dbg !344
  %free = getelementptr inbounds %struct.archive_read_filter_bidder, %struct.archive_read_filter_bidder* %9, i32 0, i32 5, !dbg !345
  store i32 (%struct.archive_read_filter_bidder*)* @grzip_reader_free, i32 (%struct.archive_read_filter_bidder*)** %free, align 8, !dbg !346
  %10 = load %struct.archive*, %struct.archive** %_a.addr, align 8, !dbg !347
  call void (%struct.archive*, i32, i8*, ...) @archive_set_error(%struct.archive* %10, i32 -1, i8* getelementptr inbounds ([53 x i8], [53 x i8]* @.str.1, i32 0, i32 0)), !dbg !348
  store i32 -20, i32* %retval, align 4, !dbg !349
  br label %return, !dbg !349

return:                                           ; preds = %if.end4, %if.then3, %if.then
  %11 = load i32, i32* %retval, align 4, !dbg !350
  ret i32 %11, !dbg !350
}
...
; Function Attrs: nounwind uwtable
define internal i32 @grzip_bidder_bid(%struct.archive_read_filter_bidder* %self, %struct.archive_read_filter* %filter) #0 !dbg !294 {
entry:
  %retval = alloca i32, align 4
  ...
  call void @llvm.dbg.declare(metadata %struct.archive_read_filter_bidder** %self.addr, metadata !351, metadata !307), !dbg !352
  store %struct.archive_read_filter* %filter, %struct.archive_read_filter** %filter.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.archive_read_filter** %filter.addr, metadata !353, metadata !307), !dbg !354
  call void @llvm.dbg.declare(metadata i8** %p, metadata !355, metadata !307), !dbg !357
  call void @llvm.dbg.declare(metadata i64* %avail, metadata !358, metadata !307), !dbg !359
  %0 = load %struct.archive_read_filter_bidder*, %struct.archive_read_filter_bidder** %self.addr, align 8, !dbg !360
  %1 = load %struct.archive_read_filter*, %struct.archive_read_filter** %filter.addr, align 8, !dbg !361
  %call = call i8* @__archive_read_filter_ahead(%struct.archive_read_filter* %1, i64 12, i64* %avail), !dbg !362
  store i8* %call, i8** %p, align 8, !dbg !363
  %2 = load i8*, i8** %p, align 8, !dbg !364
  %cmp = icmp eq i8* %2, null, !dbg !366
  br i1 %cmp, label %if.then, label %lor.lhs.false, !dbg !367

lor.lhs.false:                                    ; preds = %entry
  %3 = load i64, i64* %avail, align 8, !dbg !368
  %cmp1 = icmp eq i64 %3, 0, !dbg !370
...
if.end:                                           ; preds = %lor.lhs.false
  %4 = load i8*, i8** %p, align 8, !dbg !373
  %call2 = call i32 @memcmp(i8* %4, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @grzip_magic, i32 0, i32 0), i64 12) #4, !dbg !375
  %tobool = icmp ne i32 %call2, 0, !dbg !375
  br i1 %tobool, label %if.then3, label %if.end4, !dbg !376
...
if.end4:                                          ; preds = %if.end
  store i32 96, i32* %retval, align 4, !dbg !378
  br label %return, !dbg !378

return:                                           ; preds = %if.end4, %if.then3, %if.then
  %5 = load i32, i32* %retval, align 4, !dbg !379
  ret i32 %5, !dbg !379
}

; Function Attrs: nounwind uwtable
define internal i32 @grzip_bidder_init(%struct.archive_read_filter* %self) #0 !dbg !295 {
entry:
  ...
  call void @llvm.dbg.declare(metadata %struct.archive_read_filter** %self.addr, metadata !380, metadata !307), !dbg !381
  call void @llvm.dbg.declare(metadata i32* %r, metadata !382, metadata !307), !dbg !383
  %0 = load %struct.archive_read_filter*, %struct.archive_read_filter** %self.addr, align 8, !dbg !384
  %call = call i32 @__archive_read_program(%struct.archive_read_filter* %0, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.2, i32 0, i32 0)), !dbg !385
  store i32 %call, i32* %r, align 4, !dbg !386
  %1 = load %struct.archive_read_filter*, %struct.archive_read_filter** %self.addr, align 8, !dbg !387
  %code = getelementptr inbounds %struct.archive_read_filter, %struct.archive_read_filter* %1, i32 0, i32 12, !dbg !388
  store i32 12, i32* %code, align 8, !dbg !389
  %2 = load %struct.archive_read_filter*, %struct.archive_read_filter** %self.addr, align 8, !dbg !390
  %name = getelementptr inbounds %struct.archive_read_filter, %struct.archive_read_filter* %2, i32 0, i32 11, !dbg !391
  store i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.3, i32 0, i32 0), i8** %name, align 8, !dbg !392
  %3 = load i32, i32* %r, align 4, !dbg !393
  ret i32 %3, !dbg !394
}

; Function Attrs: nounwind uwtable
define internal i32 @grzip_reader_free(%struct.archive_read_filter_bidder* %self) #0 !dbg !293 {
entry:
  %self.addr = alloca %struct.archive_read_filter_bidder*, align 8
  store %struct.archive_read_filter_bidder* %self, %struct.archive_read_filter_bidder** %self.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.archive_read_filter_bidder** %self.addr, metadata !395, metadata !307), !dbg !396
  %0 = load %struct.archive_read_filter_bidder*, %struct.archive_read_filter_bidder** %self.addr, align 8, !dbg !397
  ret i32 0, !dbg !398
}
...
!0 = distinct !DICompileUnit(language: DW_LANG_C99, file: !1, producer: "clang version 3.8.0 (tags/RELEASE_380/final)", isOptimized: false, runtimeVersion: 0, emissionKind: 1, enums: !2, retainedTypes: !3, subprograms: !291, globals: !296)
!1 = !DIFile(filename: "/data/download/cmake/cmake-master/Utilities/cmlibarchive/libarchive/archive_read_support_filter_grzip.c", directory: "/data/download/cmake/cmake-master/Utilities/cmlibarchive/libarchive")
!2 = !{}
!3 = !{!4, !122}
...
!291 = !{!292, !293, !294, !295}
!292 = distinct !DISubprogram(name: "archive_read_support_filter_grzip", scope: !1, file: !1, line: 65, type: !21, isLocal: false, isDefinition: true, scopeLine: 66, flags: DIFlagPrototyped, isOptimized: false, variables: !2)
!293 = distinct !DISubprogram(name: "grzip_reader_free", scope: !1, file: !1, line: 58, type: !218, isLocal: true, isDefinition: true, scopeLine: 59, flags: DIFlagPrototyped, isOptimized: false, variables: !2)
!294 = distinct !DISubprogram(name: "grzip_bidder_bid", scope: !1, file: !1, line: 91, type: !166, isLocal: true, isDefinition: true, scopeLine: 93, flags: DIFlagPrototyped, isOptimized: false, variables: !2)
!295 = distinct !DISubprogram(name: "grzip_bidder_init", scope: !1, file: !1, line: 110, type: !178, isLocal: true, isDefinition: true, scopeLine: 111, flags: DIFlagPrototyped, isOptimized: false, variables: !2)
!296 = !{!297}
!297 = !DIGlobalVariable(name: "grzip_magic", scope: !0, file: !1, line: 48, type: !298, isLocal: true, isDefinition: true, variable: [12 x i8]* @grzip_magic)
!298 = !DICompositeType(tag: DW_TAG_array_type, baseType: !299, size: 96, align: 8, elements: !301)
!299 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !300)
!300 = !DIBasicType(name: "unsigned char", size: 8, align: 8, encoding: DW_ATE_unsigned_char)
!301 = !{!302}
...
!306 = !DILocalVariable(name: "_a", arg: 1, scope: !292, file: !1, line: 65, type: !24)
!307 = !DIExpression()
!308 = !DILocation(line: 65, column: 51, scope: !292)
!309 = !DILocalVariable(name: "a", scope: !292, file: !1, line: 67, type: !4)
!310 = !DILocation(line: 67, column: 23, scope: !292)
!311 = !DILocation(line: 67, column: 50, scope: !292)
!312 = !DILocation(line: 67, column: 27, scope: !292)
!313 = !DILocalVariable(name: "reader", scope: !292, file: !1, line: 68, type: !168)
!314 = !DILocation(line: 68, column: 37, scope: !292)
!315 = !DILocation(line: 70, column: 2, scope: !292)
!316 = !DILocalVariable(name: "magic_test", scope: !317, file: !1, line: 70, type: !23)
!317 = distinct !DILexicalBlock(scope: !292, file: !1, line: 70, column: 2)
!318 = !DILocation(line: 70, column: 2, scope: !317)
!319 = !DILocation(line: 70, column: 2, scope: !320)
!320 = !DILexicalBlockFile(scope: !317, file: !1, discriminator: 1)
!321 = !DILocation(line: 70, column: 2, scope: !322)
!322 = !DILexicalBlockFile(scope: !323, file: !1, discriminator: 2)
!323 = distinct !DILexicalBlock(scope: !317, file: !1, line: 70, column: 2)
!324 = !DILocation(line: 70, column: 2, scope: !325)
!325 = !DILexicalBlockFile(scope: !317, file: !1, discriminator: 3)
!326 = !DILocation(line: 73, column: 32, scope: !327)
!327 = distinct !DILexicalBlock(scope: !292, file: !1, line: 73, column: 6)
!328 = !DILocation(line: 73, column: 6, scope: !327)
!329 = !DILocation(line: 73, column: 44, scope: !327)
!330 = !DILocation(line: 73, column: 6, scope: !292)
!331 = !DILocation(line: 74, column: 3, scope: !327)
!332 = !DILocation(line: 76, column: 2, scope: !292)
!333 = !DILocation(line: 76, column: 10, scope: !292)
!334 = !DILocation(line: 76, column: 15, scope: !292)
!335 = !DILocation(line: 77, column: 2, scope: !292)
!336 = !DILocation(line: 77, column: 10, scope: !292)
!337 = !DILocation(line: 77, column: 14, scope: !292)
!338 = !DILocation(line: 78, column: 2, scope: !292)
!339 = !DILocation(line: 78, column: 10, scope: !292)
!340 = !DILocation(line: 78, column: 15, scope: !292)
!341 = !DILocation(line: 79, column: 2, scope: !292)
!342 = !DILocation(line: 79, column: 10, scope: !292)
!343 = !DILocation(line: 79, column: 18, scope: !292)
!344 = !DILocation(line: 80, column: 2, scope: !292)
!345 = !DILocation(line: 80, column: 10, scope: !292)
!346 = !DILocation(line: 80, column: 15, scope: !292)
!347 = !DILocation(line: 82, column: 20, scope: !292)
!348 = !DILocation(line: 82, column: 2, scope: !292)
!349 = !DILocation(line: 84, column: 2, scope: !292)
!350 = !DILocation(line: 85, column: 1, scope: !292)
!351 = !DILocalVariable(name: "self", arg: 1, scope: !294, file: !1, line: 91, type: !168)
!352 = !DILocation(line: 91, column: 53, scope: !294)
!353 = !DILocalVariable(name: "filter", arg: 2, scope: !294, file: !1, line: 92, type: !169)
!354 = !DILocation(line: 92, column: 33, scope: !294)
!355 = !DILocalVariable(name: "p", scope: !294, file: !1, line: 94, type: !356)
!356 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !299, size: 64, align: 64)
!357 = !DILocation(line: 94, column: 23, scope: !294)
!358 = !DILocalVariable(name: "avail", scope: !294, file: !1, line: 95, type: !38)
!359 = !DILocation(line: 95, column: 10, scope: !294)
!360 = !DILocation(line: 97, column: 8, scope: !294)
!361 = !DILocation(line: 99, column: 34, scope: !294)
!362 = !DILocation(line: 99, column: 6, scope: !294)
!363 = !DILocation(line: 99, column: 4, scope: !294)
!364 = !DILocation(line: 100, column: 6, scope: !365)
!365 = distinct !DILexicalBlock(scope: !294, file: !1, line: 100, column: 6)
!366 = !DILocation(line: 100, column: 8, scope: !365)
!367 = !DILocation(line: 100, column: 16, scope: !365)
!368 = !DILocation(line: 100, column: 19, scope: !369)
!369 = !DILexicalBlockFile(scope: !365, file: !1, discriminator: 1)
!370 = !DILocation(line: 100, column: 25, scope: !369)
!371 = !DILocation(line: 100, column: 6, scope: !369)
!372 = !DILocation(line: 101, column: 3, scope: !365)
!373 = !DILocation(line: 103, column: 13, scope: !374)
!374 = distinct !DILexicalBlock(scope: !294, file: !1, line: 103, column: 6)
!375 = !DILocation(line: 103, column: 6, scope: !374)
!376 = !DILocation(line: 103, column: 6, scope: !294)
!377 = !DILocation(line: 104, column: 3, scope: !374)
!378 = !DILocation(line: 106, column: 2, scope: !294)
!379 = !DILocation(line: 107, column: 1, scope: !294)
!380 = !DILocalVariable(name: "self", arg: 1, scope: !295, file: !1, line: 110, type: !169)
!381 = !DILocation(line: 110, column: 47, scope: !295)
!382 = !DILocalVariable(name: "r", scope: !295, file: !1, line: 112, type: !23)
!383 = !DILocation(line: 112, column: 6, scope: !295)
!384 = !DILocation(line: 114, column: 29, scope: !295)
!385 = !DILocation(line: 114, column: 6, scope: !295)
!386 = !DILocation(line: 114, column: 4, scope: !295)
!387 = !DILocation(line: 118, column: 2, scope: !295)
!388 = !DILocation(line: 118, column: 8, scope: !295)
!389 = !DILocation(line: 118, column: 13, scope: !295)
!390 = !DILocation(line: 119, column: 2, scope: !295)
!391 = !DILocation(line: 119, column: 8, scope: !295)
!392 = !DILocation(line: 119, column: 13, scope: !295)
!393 = !DILocation(line: 120, column: 10, scope: !295)
!394 = !DILocation(line: 120, column: 2, scope: !295)
!395 = !DILocalVariable(name: "self", arg: 1, scope: !293, file: !1, line: 58, type: !168)
!396 = !DILocation(line: 58, column: 54, scope: !293)
!397 = !DILocation(line: 60, column: 8, scope: !293)
!398 = !DILocation(line: 61, column: 2, scope: !293)
