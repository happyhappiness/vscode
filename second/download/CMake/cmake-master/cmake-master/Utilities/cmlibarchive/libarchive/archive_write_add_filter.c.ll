; ModuleID = '/data/download/cmake/cmake-master/Utilities/cmlibarchive/libarchive/archive_write_add_filter.c'
...
@codes = internal global [13 x %struct.anon] [%struct.anon { i32 0, i32 (%struct.archive*)* @archive_write_add_filter_none }, %struct.anon { i32 1, i32 (%struct.archive*)* @archive_write_add_filter_gzip }, %struct.anon { i32 2, i32 (%struct.archive*)* @archive_write_add_filter_bzip2 }, %struct.anon { i32 3, i32 (%struct.archive*)* @archive_write_add_filter_compress }, %struct.anon { i32 12, i32 (%struct.archive*)* @archive_write_add_filter_grzip }, %struct.anon { i32 10, i32 (%struct.archive*)* @archive_write_add_filter_lrzip }, %struct.anon { i32 13, i32 (%struct.archive*)* @archive_write_add_filter_lz4 }, %struct.anon { i32 9, i32 (%struct.archive*)* @archive_write_add_filter_lzip }, %struct.anon { i32 5, i32 (%struct.archive*)* @archive_write_add_filter_lzma }, %struct.anon { i32 11, i32 (%struct.archive*)* @archive_write_add_filter_lzip }, %struct.anon { i32 7, i32 (%struct.archive*)* @archive_write_add_filter_uuencode }, %struct.anon { i32 6, i32 (%struct.archive*)* @archive_write_add_filter_xz }, %struct.anon { i32 -1, i32 (%struct.archive*)* null }], align 16
@.str = private unnamed_addr constant [15 x i8] c"No such filter\00", align 1

; Function Attrs: nounwind uwtable
define i32 @archive_write_add_filter(%struct.archive* %a, i32 %code) #0 !dbg !4 {
entry:
...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  %arrayidx = getelementptr inbounds [13 x %struct.anon], [13 x %struct.anon]* @codes, i64 0, i64 %idxprom, !dbg !131
  %code1 = getelementptr inbounds %struct.anon, %struct.anon* %arrayidx, i32 0, i32 0, !dbg !132
  %1 = load i32, i32* %code1, align 16, !dbg !132
  %cmp = icmp ne i32 %1, -1, !dbg !133
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx3 = getelementptr inbounds [13 x %struct.anon], [13 x %struct.anon]* @codes, i64 0, i64 %idxprom2, !dbg !139
...
if.then:                                          ; preds = %for.body
  ...
  %arrayidx7 = getelementptr inbounds [13 x %struct.anon], [13 x %struct.anon]* @codes, i64 0, i64 %idxprom6, !dbg !144
...
declare i32 @archive_write_add_filter_compress(%struct.archive*) #2

declare i32 @archive_write_add_filter_grzip(%struct.archive*) #2

declare i32 @archive_write_add_filter_lrzip(%struct.archive*) #2

declare i32 @archive_write_add_filter_lz4(%struct.archive*) #2

declare i32 @archive_write_add_filter_lzip(%struct.archive*) #2

declare i32 @archive_write_add_filter_lzma(%struct.archive*) #2

declare i32 @archive_write_add_filter_uuencode(%struct.archive*) #2
...
!1 = !DIFile(filename: "/data/download/cmake/cmake-master/Utilities/cmlibarchive/libarchive/archive_write_add_filter.c", directory: "/data/download/cmake/cmake-master/Utilities/cmlibarchive/libarchive")
!2 = !{}
!3 = !{!4}
!4 = distinct !DISubprogram(name: "archive_write_add_filter", scope: !1, file: !1, line: 60, type: !5, isLocal: false, isDefinition: true, scopeLine: 61, flags: DIFlagPrototyped, isOptimized: false, variables: !2)
...
!106 = !{!107}
!107 = !DIGlobalVariable(name: "codes", scope: !0, file: !1, line: 42, type: !108, isLocal: true, isDefinition: true, variable: [13 x %struct.anon]* @codes)
!108 = !DICompositeType(tag: DW_TAG_array_type, baseType: !109, size: 1664, align: 64, elements: !113)
...
!118 = !DILocalVariable(name: "a", arg: 1, scope: !4, file: !1, line: 60, type: !8)
!119 = !DIExpression()
!120 = !DILocation(line: 60, column: 42, scope: !4)
!121 = !DILocalVariable(name: "code", arg: 2, scope: !4, file: !1, line: 60, type: !7)
!122 = !DILocation(line: 60, column: 49, scope: !4)
!123 = !DILocalVariable(name: "i", scope: !4, file: !1, line: 62, type: !7)
!124 = !DILocation(line: 62, column: 6, scope: !4)
!125 = !DILocation(line: 64, column: 9, scope: !126)
!126 = distinct !DILexicalBlock(scope: !4, file: !1, line: 64, column: 2)
!127 = !DILocation(line: 64, column: 7, scope: !126)
!128 = !DILocation(line: 64, column: 20, scope: !129)
!129 = !DILexicalBlockFile(scope: !130, file: !1, discriminator: 1)
!130 = distinct !DILexicalBlock(scope: !126, file: !1, line: 64, column: 2)
!131 = !DILocation(line: 64, column: 14, scope: !129)
!132 = !DILocation(line: 64, column: 23, scope: !129)
!133 = !DILocation(line: 64, column: 28, scope: !129)
!134 = !DILocation(line: 64, column: 2, scope: !129)
!135 = !DILocation(line: 65, column: 7, scope: !136)
!136 = distinct !DILexicalBlock(scope: !137, file: !1, line: 65, column: 7)
!137 = distinct !DILexicalBlock(scope: !130, file: !1, line: 64, column: 40)
!138 = !DILocation(line: 65, column: 21, scope: !136)
!139 = !DILocation(line: 65, column: 15, scope: !136)
!140 = !DILocation(line: 65, column: 24, scope: !136)
!141 = !DILocation(line: 65, column: 12, scope: !136)
!142 = !DILocation(line: 65, column: 7, scope: !137)
!143 = !DILocation(line: 66, column: 19, scope: !136)
!144 = !DILocation(line: 66, column: 13, scope: !136)
!145 = !DILocation(line: 66, column: 22, scope: !136)
!146 = !DILocation(line: 66, column: 30, scope: !136)
!147 = !DILocation(line: 66, column: 12, scope: !136)
!148 = !DILocation(line: 66, column: 4, scope: !136)
!149 = !DILocation(line: 67, column: 2, scope: !137)
!150 = !DILocation(line: 64, column: 36, scope: !151)
!151 = !DILexicalBlockFile(scope: !130, file: !1, discriminator: 2)
!152 = !DILocation(line: 64, column: 2, scope: !151)
!153 = !DILocation(line: 69, column: 20, scope: !4)
!154 = !DILocation(line: 69, column: 2, scope: !4)
!155 = !DILocation(line: 70, column: 2, scope: !4)
!156 = !DILocation(line: 71, column: 1, scope: !4)
