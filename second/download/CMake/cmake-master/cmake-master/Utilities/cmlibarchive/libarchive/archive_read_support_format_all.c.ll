; ModuleID = '/data/download/cmake/cmake-master/Utilities/cmlibarchive/libarchive/archive_read_support_format_all.c'
...
define i32 @archive_read_support_format_all(%struct.archive* %a) #0 !dbg !4 {
entry:
...
do.body:                                          ; preds = %entry
  call void @llvm.dbg.declare(metadata i32* %magic_test, metadata !113, metadata !110), !dbg !115
  %0 = load %struct.archive*, %struct.archive** %a.addr, align 8, !dbg !116
  %call = call i32 @__archive_check_magic(%struct.archive* %0, i32 14594245, i32 1, i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str, i32 0, i32 0)), !dbg !116
  store i32 %call, i32* %magic_test, align 4, !dbg !116
  %1 = load i32, i32* %magic_test, align 4, !dbg !116
  %cmp = icmp eq i32 %1, -30, !dbg !116
  br i1 %cmp, label %if.then, label %if.end, !dbg !116

if.then:                                          ; preds = %do.body
  store i32 -30, i32* %retval, align 4, !dbg !118
...
do.end:                                           ; preds = %if.end
  %2 = load %struct.archive*, %struct.archive** %a.addr, align 8, !dbg !123
  %call1 = call i32 @archive_read_support_format_ar(%struct.archive* %2), !dbg !124
  %3 = load %struct.archive*, %struct.archive** %a.addr, align 8, !dbg !125
  %call2 = call i32 @archive_read_support_format_cpio(%struct.archive* %3), !dbg !126
  %4 = load %struct.archive*, %struct.archive** %a.addr, align 8, !dbg !127
  %call3 = call i32 @archive_read_support_format_empty(%struct.archive* %4), !dbg !128
  %5 = load %struct.archive*, %struct.archive** %a.addr, align 8, !dbg !129
  %call4 = call i32 @archive_read_support_format_lha(%struct.archive* %5), !dbg !130
  %6 = load %struct.archive*, %struct.archive** %a.addr, align 8, !dbg !131
  %call5 = call i32 @archive_read_support_format_mtree(%struct.archive* %6), !dbg !132
  %7 = load %struct.archive*, %struct.archive** %a.addr, align 8, !dbg !133
  %call6 = call i32 @archive_read_support_format_tar(%struct.archive* %7), !dbg !134
  %8 = load %struct.archive*, %struct.archive** %a.addr, align 8, !dbg !135
  %call7 = call i32 @archive_read_support_format_xar(%struct.archive* %8), !dbg !136
  %9 = load %struct.archive*, %struct.archive** %a.addr, align 8, !dbg !137
  %call8 = call i32 @archive_read_support_format_warc(%struct.archive* %9), !dbg !138
  %10 = load %struct.archive*, %struct.archive** %a.addr, align 8, !dbg !139
  %call9 = call i32 @archive_read_support_format_7zip(%struct.archive* %10), !dbg !140
  %11 = load %struct.archive*, %struct.archive** %a.addr, align 8, !dbg !141
  %call10 = call i32 @archive_read_support_format_cab(%struct.archive* %11), !dbg !142
  %12 = load %struct.archive*, %struct.archive** %a.addr, align 8, !dbg !143
  %call11 = call i32 @archive_read_support_format_rar(%struct.archive* %12), !dbg !144
  %13 = load %struct.archive*, %struct.archive** %a.addr, align 8, !dbg !145
  %call12 = call i32 @archive_read_support_format_iso9660(%struct.archive* %13), !dbg !146
  %14 = load %struct.archive*, %struct.archive** %a.addr, align 8, !dbg !147
  %call13 = call i32 @archive_read_support_format_zip(%struct.archive* %14), !dbg !148
  %15 = load %struct.archive*, %struct.archive** %a.addr, align 8, !dbg !149
  call void @archive_clear_error(%struct.archive* %15), !dbg !150
  store i32 0, i32* %retval, align 4, !dbg !151
  br label %return, !dbg !151

return:                                           ; preds = %do.end, %if.then
  %16 = load i32, i32* %retval, align 4, !dbg !152
  ret i32 %16, !dbg !152
}
...
declare i32 @archive_read_support_format_empty(%struct.archive*) #2
...
declare i32 @archive_read_support_format_warc(%struct.archive*) #2
...
!1 = !DIFile(filename: "/data/download/cmake/cmake-master/Utilities/cmlibarchive/libarchive/archive_read_support_format_all.c", directory: "/data/download/cmake/cmake-master/Utilities/cmlibarchive/libarchive")
!2 = !{}
!3 = !{!4}
!4 = distinct !DISubprogram(name: "archive_read_support_format_all", scope: !1, file: !1, line: 33, type: !5, isLocal: false, isDefinition: true, scopeLine: 34, flags: DIFlagPrototyped, isOptimized: false, variables: !2)
...
!110 = !DIExpression()
!111 = !DILocation(line: 33, column: 49, scope: !4)
!112 = !DILocation(line: 35, column: 2, scope: !4)
!113 = !DILocalVariable(name: "magic_test", scope: !114, file: !1, line: 35, type: !7)
!114 = distinct !DILexicalBlock(scope: !4, file: !1, line: 35, column: 2)
!115 = !DILocation(line: 35, column: 2, scope: !114)
!116 = !DILocation(line: 35, column: 2, scope: !117)
!117 = !DILexicalBlockFile(scope: !114, file: !1, discriminator: 1)
!118 = !DILocation(line: 35, column: 2, scope: !119)
!119 = !DILexicalBlockFile(scope: !120, file: !1, discriminator: 2)
!120 = distinct !DILexicalBlock(scope: !114, file: !1, line: 35, column: 2)
!121 = !DILocation(line: 35, column: 2, scope: !122)
!122 = !DILexicalBlockFile(scope: !114, file: !1, discriminator: 3)
!123 = !DILocation(line: 57, column: 33, scope: !4)
!124 = !DILocation(line: 57, column: 2, scope: !4)
!125 = !DILocation(line: 58, column: 35, scope: !4)
!126 = !DILocation(line: 58, column: 2, scope: !4)
!127 = !DILocation(line: 59, column: 36, scope: !4)
!128 = !DILocation(line: 59, column: 2, scope: !4)
!129 = !DILocation(line: 60, column: 34, scope: !4)
!130 = !DILocation(line: 60, column: 2, scope: !4)
!131 = !DILocation(line: 61, column: 36, scope: !4)
!132 = !DILocation(line: 61, column: 2, scope: !4)
!133 = !DILocation(line: 62, column: 34, scope: !4)
!134 = !DILocation(line: 62, column: 2, scope: !4)
!135 = !DILocation(line: 63, column: 34, scope: !4)
!136 = !DILocation(line: 63, column: 2, scope: !4)
!137 = !DILocation(line: 64, column: 35, scope: !4)
!138 = !DILocation(line: 64, column: 2, scope: !4)
!139 = !DILocation(line: 72, column: 35, scope: !4)
!140 = !DILocation(line: 72, column: 2, scope: !4)
!141 = !DILocation(line: 73, column: 34, scope: !4)
!142 = !DILocation(line: 73, column: 2, scope: !4)
!143 = !DILocation(line: 74, column: 34, scope: !4)
!144 = !DILocation(line: 74, column: 2, scope: !4)
!145 = !DILocation(line: 75, column: 38, scope: !4)
!146 = !DILocation(line: 75, column: 2, scope: !4)
!147 = !DILocation(line: 78, column: 34, scope: !4)
!148 = !DILocation(line: 78, column: 2, scope: !4)
!149 = !DILocation(line: 86, column: 22, scope: !4)
!150 = !DILocation(line: 86, column: 2, scope: !4)
!151 = !DILocation(line: 87, column: 2, scope: !4)
!152 = !DILocation(line: 88, column: 1, scope: !4)
