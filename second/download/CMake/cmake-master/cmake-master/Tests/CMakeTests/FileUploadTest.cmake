file(REMOVE_RECURSE "/data/download/cmake/cmake-master/Tests/CMakeTests/uploads")

if(EXISTS "/data/download/cmake/cmake-master/Tests/CMakeTests/uploads/file1.png")
  message(FATAL_ERROR "error: file1.png exists - should have been deleted")
endif()
if(EXISTS "/data/download/cmake/cmake-master/Tests/CMakeTests/uploads/file2.png")
  message(FATAL_ERROR "error: file2.png exists - should have been deleted")
endif()

file(MAKE_DIRECTORY "/data/download/cmake/cmake-master/Tests/CMakeTests/uploads")

set(filename "/data/download/cmake/cmake-master/Tests/CMakeTests/FileDownloadInput.png")
if(NOT "/data/download/cmake/cmake-master/Tests/CMakeTests" MATCHES "^/")
  set(slash /)
endif()
set(urlbase "file://${slash}/data/download/cmake/cmake-master/Tests/CMakeTests/uploads")
...
execute_process(COMMAND ${CMAKE_COMMAND} -E md5sum
  "/data/download/cmake/cmake-master/Tests/CMakeTests/uploads/file1.png"
...
execute_process(COMMAND ${CMAKE_COMMAND} -E md5sum
  "/data/download/cmake/cmake-master/Tests/CMakeTests/uploads/file2.png"
